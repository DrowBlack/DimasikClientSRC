                    ...
                    block9: {
                        ...
                        block7: {
                            ...
                            block8: {
                                block6: {
                                    iy = y + row;
                                    if (iy < 0 || iy >= height) break block6;
                                    ioffset = iy * width;
                                    break block7;
                                }
                                if (edgeAction != CLAMP_EDGES) break block8;
                                ioffset = y * width;
                                break block7;
                            }
                            if (edgeAction != WRAP_EDGES) break block9;
                            ...
                            block10: {
                                ...
                                block11: {
                                    block12: {
                                        ...
                                        ix = x + col;
                                        if (ix >= 0 && ix < width) break block11;
                                        if (edgeAction != CLAMP_EDGES) break block12;
                                        ix = x;
                                        break block11;
                                    }
                                    if (edgeAction != WRAP_EDGES) break block10;
                                    ix = (x + width) % width;
                                }
