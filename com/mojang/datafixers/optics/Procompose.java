...
implements App2<Mu<F, G>, A, B> {
    ...
    implements Profunctor<Mu<F, G>, Profunctor.Mu> {
        ...
        @Override
        public <A, B, C, D> FunctionType<App2<Mu<F, G>, A, B>, App2<Mu<F, G>, C, D>> dimap(Function<C, A> g, Function<B, D> h) {
            return cmp -> this.cap(Procompose.unbox(cmp), g, h);
        }

        private <A, B, C, D, E> App2<Mu<F, G>, C, D> cap(Procompose<F, G, A, B, E> cmp, Function<C, A> g, Function<B, D> h) {
            return new Procompose(() -> this.p1.dimap(g, Function.identity()).apply(cmp.first.get()), this.p2.dimap(Function.identity(), h).apply(cmp.second));
        }
    }
