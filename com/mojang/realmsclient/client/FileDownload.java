...
public class FileDownload {
        ...
        if (this.field_224851_i == null) {
            this.field_224851_i = new Thread(() -> {
                ...
                try {
                    ...
                    closeablehttpclient = HttpClientBuilder.create().setDefaultRequestConfig(this.field_224852_j).build();
                    CloseableHttpResponse httpresponse = ((CloseableHttpClient)closeablehttpclient).execute(this.field_224850_h);
                    p_237688_3_.field_225140_b = Long.parseLong(httpresponse.getFirstHeader("Content-Length").getValue());
                    if (httpresponse.getStatusLine().getStatusCode() == 200) {
                        FileOutputStream outputstream = new FileOutputStream(this.field_224848_f);
                        ProgressListener filedownload$progresslistener = new ProgressListener(p_237688_2_.trim(), this.field_224848_f, p_237688_4_, p_237688_3_);
                        ...
                        IOUtils.copy(httpresponse.getEntity().getContent(), (OutputStream)filedownload$downloadcountingoutputstream);
                        return;
                    }
                    ...
                    block40: {
                        block41: {
                            ...
                            if (p_237688_1_.field_230644_b_.isEmpty() || p_237688_1_.field_230645_c_.isEmpty()) break block41;
                            try {
                                this.field_224848_f = File.createTempFile("resources", ".tar.gz");
                                this.field_224850_h = new HttpGet(p_237688_1_.field_230644_b_);
                                httpresponse1 = ((CloseableHttpClient)closeablehttpclient).execute(this.field_224850_h);
                            ...
                            FileOutputStream outputstream1 = new FileOutputStream(this.field_224848_f);
                            ResourcePackProgressListener filedownload$resourcepackprogresslistener = new ResourcePackProgressListener(this.field_224848_f, p_237688_3_, p_237688_1_);
                            ...
                            IOUtils.copy(httpresponse1.getEntity().getContent(), (OutputStream)filedownload$downloadcountingoutputstream1);
                            break block40;
                            finally {
                                this.field_224850_h.releaseConnection();
                                if (this.field_224848_f != null) {
    ...
    private void func_237690_a_(String p_237690_1_, File p_237690_2_, SaveFormat p_237690_3_) throws IOException {
        ...
        p_237690_1_ = FileDownload.func_224828_b(p_237690_1_);
        try {
            Object object = p_237690_3_.getSaveList().iterator();
            while (object.hasNext()) {
                WorldSummary worldsummary = (WorldSummary)object.next();
                if (!worldsummary.getFileName().toLowerCase(Locale.ROOT).startsWith(p_237690_1_.toLowerCase(Locale.ROOT))) continue;
        ...
        if (p_237690_3_.isNewLevelIdAcceptable(p_237690_1_) && i <= 1) {
            ...
            if (!p_237690_3_.isNewLevelIdAcceptable((String)s)) {
                boolean flag = false;
                while (!flag) {
                    if (!p_237690_3_.isNewLevelIdAcceptable((String)(s = p_237690_1_ + (String)(++i == 1 ? "" : "-" + i)))) continue;
                    flag = true;
                }
            }
        }
        ...
        try {
            ...
            try (SaveFormat.LevelSave saveformat$levelsave = p_237690_3_.getLevelSave((String)s);){
                saveformat$levelsave.updateSaveName(((String)s).trim());
                Path path = saveformat$levelsave.resolveFilePath(FolderName.LEVEL_DAT);
                FileDownload.func_237689_a_(path.toFile());
            }
            catch (IOException ioexception) {
                LOGGER.error("Failed to rename unpacked realms level {}", s, (Object)ioexception);
            }
            this.field_224849_g = new File(file1, (String)s + File.separator + "resources.zip");
        }
    }
    ...
    implements ActionListener {
        ...
        public void actionPerformed(ActionEvent p_actionPerformed_1_) {
            this.field_224816_e.field_225139_a = ((DownloadCountingOutputStream)p_actionPerformed_1_.getSource()).getByteCount();
    ...
    implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent p_actionPerformed_1_) {
            this.field_224820_c.field_225139_a = ((DownloadCountingOutputStream)p_actionPerformed_1_.getSource()).getByteCount();
            if (this.field_224820_c.field_225139_a >= this.field_224820_c.field_225140_b && !FileDownload.this.field_224844_b) {
                try {
                    ...
                    if (s.equals(this.field_224821_d.field_230645_c_)) {
                        ...
                        LOGGER.error("Resourcepack had wrong hash (expected " + this.field_224821_d.field_230645_c_ + ", found " + s + "). Deleting it.");
