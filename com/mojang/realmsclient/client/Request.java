...
public abstract class Request<T extends Request<T>> {
    ...
    public Request(String p_i51788_1_, int p_i51788_2_, int p_i51788_3_) {
        try {
            ...
            this.field_224968_a = proxy != null ? (HttpURLConnection)new URL(p_i51788_1_).openConnection(proxy) : (HttpURLConnection)new URL(p_i51788_1_).openConnection();
    ...
    public void func_224962_a(String p_224962_1_, String p_224962_2_) {
        Request.func_224967_a(this.field_224968_a, p_224962_1_, p_224962_2_);
    }
    ...
    public String func_224963_c() {
        try {
            this.func_224955_d();
            String s = null;
            s = this.func_224958_b() >= 400 ? this.func_224954_a(this.field_224968_a.getErrorStream()) : this.func_224954_a(this.field_224968_a.getInputStream());
            this.func_224950_f();
            return s;
        }
        catch (IOException ioexception) {
