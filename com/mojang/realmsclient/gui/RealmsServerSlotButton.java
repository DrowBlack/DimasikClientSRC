...
implements IScreen {
    ...
    public void tick() {
        ...
        if (realmsserver != null) {
            ...
            boolean bl = flag2 = this.field_223776_d == 4;
            if (flag2) {
            ...
            Action realmsserverslotbutton$action = RealmsServerSlotButton.func_237720_a_(realmsserver, flag, flag2);
            Pair<ITextComponent, ITextComponent> pair = this.func_237719_a_(realmsserver, s, flag1, flag2, realmsserverslotbutton$action);
            this.field_223778_f = new ServerData(flag, s, i, s1, flag1, flag2, realmsserverslotbutton$action, pair.getFirst());
            this.setMessage(pair.getSecond());
        }
    }

    private static Action func_237720_a_(RealmsServer p_237720_0_, boolean p_237720_1_, boolean p_237720_2_) {
        if (p_237720_1_) {
    ...
    private Pair<ITextComponent, ITextComponent> func_237719_a_(RealmsServer p_237719_1_, String p_237719_2_, boolean p_237719_3_, boolean p_237719_4_, Action p_237719_5_) {
        if (p_237719_5_ == Action.NOTHING) {
            return Pair.of(null, new StringTextComponent(p_237719_2_));
        }
        ITextComponent itextcomponent = p_237719_4_ ? (p_237719_3_ ? StringTextComponent.EMPTY : new StringTextComponent(" ").appendString(p_237719_2_).appendString(" ").appendString(p_237719_1_.field_230596_o_)) : new StringTextComponent(" ").appendString(p_237719_2_);
        ITextComponent itextcomponent1 = p_237719_5_ == Action.JOIN ? field_243091_v : (p_237719_4_ ? field_243092_w : field_243093_x);
        IFormattableTextComponent itextcomponent2 = itextcomponent1.deepCopy().append(itextcomponent);
    ...
    private void func_237718_a_(MatrixStack p_237718_1_, int p_237718_2_, int p_237718_3_, int p_237718_4_, int p_237718_5_, boolean p_237718_6_, String p_237718_7_, int p_237718_8_, long p_237718_9_, @Nullable String p_237718_11_, boolean p_237718_12_, boolean p_237718_13_, Action p_237718_14_, @Nullable ITextComponent p_237718_15_) {
        ...
        RealmsServerSlotButton.blit(p_237718_1_, p_237718_2_ + 3, p_237718_3_ + 3, 0.0f, 0.0f, 74, 74, 74, 74);
        texturemanager.bindTexture(field_237712_a_);
        boolean bl = flag1 = flag && p_237718_14_ != Action.NOTHING;
        if (flag1) {
        ...
        RealmsServerSlotButton.blit(p_237718_1_, p_237718_2_, p_237718_3_, 0.0f, 0.0f, 80, 80, 80, 80);
        RealmsServerSlotButton.drawCenteredString(p_237718_1_, minecraft.fontRenderer, p_237718_7_, p_237718_2_ + 40, p_237718_3_ + 66, 0xFFFFFF);
    }
    ...
    public static class ServerData {
        ...
        ServerData(boolean p_i232196_1_, String p_i232196_2_, long p_i232196_3_, @Nullable String p_i232196_5_, boolean p_i232196_6_, boolean p_i232196_7_, Action p_i232196_8_, @Nullable ITextComponent p_i232196_9_) {
