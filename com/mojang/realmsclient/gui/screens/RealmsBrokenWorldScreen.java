...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.field_224079_i - 80 + 8, RealmsBrokenWorldScreen.func_239562_k_(13) - 5, 70, 20, DialogTexts.GUI_BACK, p_237776_1_ -> this.func_224060_e()));
    ...
    private void func_224058_a() {
        for (Map.Entry<Integer, RealmsWorldOptions> entry : this.field_224074_d.field_230590_i_.entrySet()) {
            ...
            Button button = flag ? new Button(this.func_224065_a(i), RealmsBrokenWorldScreen.func_239562_k_(8), 80, 20, new TranslationTextComponent("mco.brokenworld.play"), p_237780_2_ -> {
                if (this.field_224074_d.field_230590_i_.get((Object)Integer.valueOf((int)i)).field_230627_n_) {
                    RealmsResetWorldScreen realmsresetworldscreen = new RealmsResetWorldScreen(this, this.field_224074_d, new TranslationTextComponent("mco.configure.world.switch.slot"), new TranslationTextComponent("mco.configure.world.switch.slot.subtitle"), 0xA0A0A0, DialogTexts.GUI_CANCEL, this::func_237772_a_, () -> {
            ...
            }) : new Button(this.func_224065_a(i), RealmsBrokenWorldScreen.func_239562_k_(8), 80, 20, new TranslationTextComponent("mco.brokenworld.download"), p_237777_2_ -> {
            ...
            this.addButton(new Button(this.func_224065_a(i), RealmsBrokenWorldScreen.func_239562_k_(10), 80, 20, new TranslationTextComponent("mco.brokenworld.reset"), p_237773_2_ -> {
        ...
        if (this.field_224074_d != null) {
            for (Map.Entry<Integer, RealmsWorldOptions> entry : this.field_224074_d.field_230590_i_.entrySet()) {
                if (entry.getValue().field_230625_l_ != null && entry.getValue().field_230624_k_ != -1L) {
                    this.func_237775_a_(matrixStack, this.func_224065_a(entry.getKey()), RealmsBrokenWorldScreen.func_239562_k_(1) + 5, mouseX, mouseY, this.field_224074_d.field_230595_n_ == entry.getKey() && !this.func_224069_f(), entry.getValue().func_230787_a_(entry.getKey()), entry.getKey(), entry.getValue().field_230624_k_, entry.getValue().field_230625_l_, entry.getValue().field_230627_n_);
                    continue;
                }
                this.func_237775_a_(matrixStack, this.func_224065_a(entry.getKey()), RealmsBrokenWorldScreen.func_239562_k_(1) + 5, mouseX, mouseY, this.field_224074_d.field_230595_n_ == entry.getKey() && !this.func_224069_f(), entry.getValue().func_230787_a_(entry.getKey()), entry.getKey(), -1L, null, entry.getValue().field_230627_n_);
            }
        }
    }
    ...
    public void func_237772_a_() {
        new Thread(() -> {
            ...
            if (this.field_224074_d.field_230586_e_ == RealmsServer.Status.CLOSED) {
                this.minecraft.execute(() -> this.minecraft.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(this, new OpeningWorldRealmsAction(this.field_224074_d, this, this.field_224073_c, true))));
            } else {
                try {
                    ...
                    field_224071_a.error("Couldn't get own world");
                    this.minecraft.execute(() -> this.minecraft.displayGuiScreen(this.field_224072_b));
                }
            }
        }).start();
    }
    ...
    private void func_237775_a_(MatrixStack p_237775_1_, int p_237775_2_, int p_237775_3_, int p_237775_4_, int p_237775_5_, boolean p_237775_6_, String p_237775_7_, int p_237775_8_, long p_237775_9_, String p_237775_11_, boolean p_237775_12_) {
        ...
        RealmsBrokenWorldScreen.drawCenteredString(p_237775_1_, this.font, p_237775_7_, p_237775_2_ + 40, p_237775_3_ + 66, 0xFFFFFF);
    }
}
