...
extends RealmsScreen {
    ...
    @Override
    public void init() {
        this.addButton(new Button(this.width / 2 - 100, RealmsClientOutdatedScreen.func_239562_k_(12), 200, 20, DialogTexts.GUI_BACK, p_237786_1_ -> this.minecraft.displayGuiScreen(this.field_224129_a)));
    }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        for (int i = 0; i < aitextcomponent.length; ++i) {
            RealmsClientOutdatedScreen.drawCenteredString(matrixStack, this.font, aitextcomponent[i], this.width / 2, RealmsClientOutdatedScreen.func_239562_k_(5) + i * 12, 0xFFFFFF);
        }
