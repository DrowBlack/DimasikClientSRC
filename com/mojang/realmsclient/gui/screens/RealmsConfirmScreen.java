...
extends RealmsScreen {
    ...
    @Override
    public void init() {
        this.addButton(new Button(this.width / 2 - 105, RealmsConfirmScreen.func_239562_k_(9), 100, 20, DialogTexts.GUI_YES, p_237826_1_ -> this.field_237824_a_.accept(true)));
        this.addButton(new Button(this.width / 2 + 5, RealmsConfirmScreen.func_239562_k_(9), 100, 20, DialogTexts.GUI_NO, p_237825_1_ -> this.field_237824_a_.accept(false)));
    }
