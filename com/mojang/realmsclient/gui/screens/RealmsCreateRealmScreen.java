...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.field_224139_e = this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 17, 97, 20, new TranslationTextComponent("mco.create.world"), p_237828_1_ -> this.func_224132_a()));
        this.addButton(new Button(this.width / 2 + 5, this.height / 4 + 120 + 17, 95, 20, DialogTexts.GUI_CANCEL, p_237827_1_ -> this.minecraft.displayGuiScreen(this.field_224136_b)));
    ...
    private void func_224132_a() {
        if (this.func_224133_b()) {
            RealmsResetWorldScreen realmsresetworldscreen = new RealmsResetWorldScreen(this.field_224136_b, this.field_224135_a, new TranslationTextComponent("mco.selectServer.create"), new TranslationTextComponent("mco.create.world.subtitle"), 0xA0A0A0, new TranslationTextComponent("mco.create.world.skip"), () -> this.minecraft.displayGuiScreen(this.field_224136_b.func_223942_f()), () -> this.minecraft.displayGuiScreen(this.field_224136_b.func_223942_f()));
