...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, this.height - 52, 200, 20, new StringTextComponent("Ok"), p_237840_1_ -> this.minecraft.displayGuiScreen(this.field_224228_a)));
    }
