...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, RealmsInviteScreen.func_239562_k_(10), 200, 20, new TranslationTextComponent("mco.configure.world.buttons.invite"), p_237844_1_ -> this.func_224211_a()));
        this.addButton(new Button(this.width / 2 - 100, RealmsInviteScreen.func_239562_k_(12), 200, 20, DialogTexts.GUI_CANCEL, p_237843_1_ -> this.minecraft.displayGuiScreen(this.field_224217_e)));
    }
