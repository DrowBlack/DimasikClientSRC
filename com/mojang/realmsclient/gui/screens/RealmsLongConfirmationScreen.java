...
extends RealmsScreen {
    ...
    public RealmsLongConfirmationScreen(BooleanConsumer p_i232208_1_, Type p_i232208_2_, ITextComponent p_i232208_3_, ITextComponent p_i232208_4_, boolean p_i232208_5_) {
    ...
    public void init() {
        ...
        if (this.field_224258_i) {
            this.addButton(new Button(this.width / 2 - 105, RealmsLongConfirmationScreen.func_239562_k_(8), 100, 20, DialogTexts.GUI_YES, p_237848_1_ -> this.field_237845_a_.accept(true)));
            this.addButton(new Button(this.width / 2 + 5, RealmsLongConfirmationScreen.func_239562_k_(8), 100, 20, DialogTexts.GUI_NO, p_237847_1_ -> this.field_237845_a_.accept(false)));
        } else {
            this.addButton(new Button(this.width / 2 - 50, RealmsLongConfirmationScreen.func_239562_k_(8), 100, 20, new TranslationTextComponent("mco.gui.ok"), p_237846_1_ -> this.field_237845_a_.accept(true)));
        }
    }
