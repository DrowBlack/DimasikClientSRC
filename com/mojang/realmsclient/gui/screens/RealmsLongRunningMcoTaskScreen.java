...
implements IErrorConsumer {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 2 - 106, RealmsLongRunningMcoTaskScreen.func_239562_k_(12), 212, 20, DialogTexts.GUI_CANCEL, p_237852_1_ -> this.func_224236_c()));
    }
    ...
    public void func_230434_a_(ITextComponent p_230434_1_) {
        ...
        this.func_237850_a_();
        this.addButton(new Button(this.width / 2 - 106, this.height / 4 + 120 + 12, 200, 20, DialogTexts.GUI_BACK, p_237851_1_ -> this.func_224236_c()));
    }
