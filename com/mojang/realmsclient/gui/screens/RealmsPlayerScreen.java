...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.field_224307_h, RealmsPlayerScreen.func_239562_k_(1), this.field_224306_g + 10, 20, new TranslationTextComponent("mco.configure.world.buttons.invite"), p_237924_1_ -> this.minecraft.displayGuiScreen(new RealmsInviteScreen(this.field_224302_c, this, this.field_224303_d))));
        this.field_224308_i = this.addButton(new Button(this.field_224307_h, RealmsPlayerScreen.func_239562_k_(7), this.field_224306_g + 10, 20, new TranslationTextComponent("mco.configure.world.invites.remove.tooltip"), p_237918_1_ -> this.func_224274_d(this.field_224312_m)));
        this.field_224309_j = this.addButton(new Button(this.field_224307_h, RealmsPlayerScreen.func_239562_k_(9), this.field_224306_g + 10, 20, new TranslationTextComponent("mco.configure.world.invites.ops.tooltip"), p_237912_1_ -> {
        ...
        this.addButton(new Button(this.field_224307_h + this.field_224306_g / 2 + 2, RealmsPlayerScreen.func_239562_k_(12), this.field_224306_g / 2 + 10 - 2, 20, DialogTexts.GUI_BACK, p_237907_1_ -> this.func_224298_b()));
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        int i = RealmsPlayerScreen.func_239562_k_(12) + 20;
    ...
    protected void func_237903_a_(MatrixStack p_237903_1_, @Nullable ITextComponent p_237903_2_, int p_237903_3_, int p_237903_4_) {
        if (p_237903_2_ != null) {
            ...
            this.font.func_243246_a(p_237903_1_, p_237903_2_, i, j, 0xFFFFFF);
        }
    }

    private void func_237914_c_(MatrixStack p_237914_1_, int p_237914_2_, int p_237914_3_, int p_237914_4_, int p_237914_5_) {
        boolean flag = p_237914_4_ >= p_237914_2_ && p_237914_4_ <= p_237914_2_ + 9 && p_237914_5_ >= p_237914_3_ && p_237914_5_ <= p_237914_3_ + 9 && p_237914_5_ < RealmsPlayerScreen.func_239562_k_(12) + 20 && p_237914_5_ > RealmsPlayerScreen.func_239562_k_(1);
    ...
    private void func_237921_d_(MatrixStack p_237921_1_, int p_237921_2_, int p_237921_3_, int p_237921_4_, int p_237921_5_) {
        boolean flag = p_237921_4_ >= p_237921_2_ && p_237921_4_ <= p_237921_2_ + 9 && p_237921_5_ >= p_237921_3_ && p_237921_5_ <= p_237921_3_ + 9 && p_237921_5_ < RealmsPlayerScreen.func_239562_k_(12) + 20 && p_237921_5_ > RealmsPlayerScreen.func_239562_k_(1);
    ...
    private void func_237925_e_(MatrixStack p_237925_1_, int p_237925_2_, int p_237925_3_, int p_237925_4_, int p_237925_5_) {
        boolean flag = p_237925_4_ >= p_237925_2_ && p_237925_4_ <= p_237925_2_ + 9 && p_237925_5_ >= p_237925_3_ && p_237925_5_ <= p_237925_3_ + 9 && p_237925_5_ < RealmsPlayerScreen.func_239562_k_(12) + 20 && p_237925_5_ > RealmsPlayerScreen.func_239562_k_(1);
    ...
    extends RealmsObjectSelectionList<InvitedEntry> {
        ...
        public void func_223870_a(PlayerInfo p_223870_1_) {
            ...
            this.addEntry(realmsPlayerScreen.new InvitedEntry(p_223870_1_));
        }
        ...
        public void func_231401_a_(int p_231401_1_, int p_231401_2_, double p_231401_3_, double p_231401_5_, int p_231401_7_) {
            if (p_231401_2_ >= 0 && p_231401_2_ <= RealmsPlayerScreen.this.field_224303_d.field_230589_h_.size() && RealmsPlayerScreen.this.field_243137_J != GuestAction.NONE) {
                ...
                } else if (RealmsPlayerScreen.this.field_243137_J == GuestAction.REMOVE) {
        ...
        @Override
        public void setSelected(@Nullable InvitedEntry entry) {
    ...
    extends ExtendedList.AbstractListEntry<InvitedEntry> {
        ...
        private void func_237932_a_(MatrixStack p_237932_1_, PlayerInfo p_237932_2_, int p_237932_3_, int p_237932_4_, int p_237932_5_, int p_237932_6_) {
            int i = !p_237932_2_.func_230765_d_() ? 0xA0A0A0 : (p_237932_2_.func_230766_e_() ? 0x7FFF7F : 0xFFFFFF);
            RealmsPlayerScreen.this.font.drawString(p_237932_1_, p_237932_2_.func_230757_a_(), RealmsPlayerScreen.this.field_224305_f + 3 + 12, p_237932_4_ + 1, i);
