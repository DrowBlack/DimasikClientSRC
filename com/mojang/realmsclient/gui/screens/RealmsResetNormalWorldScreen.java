...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 2 - 102, RealmsResetNormalWorldScreen.func_239562_k_(4), 205, 20, this.func_237937_g_(), p_237936_1_ -> {
            this.field_224358_f = (this.field_224358_f + 1) % field_243145_b.length;
            p_237936_1_.setMessage(this.func_237937_g_());
        }));
        this.addButton(new Button(this.width / 2 - 102, RealmsResetNormalWorldScreen.func_239562_k_(6) - 2, 205, 20, this.func_237938_j_(), p_237935_1_ -> {
            this.field_224357_e = this.field_224357_e == false;
            p_237935_1_.setMessage(this.func_237938_j_());
        }));
        this.addButton(new Button(this.width / 2 - 102, RealmsResetNormalWorldScreen.func_239562_k_(12), 97, 20, this.field_224365_m, p_237934_1_ -> this.field_224354_b.func_224438_a(new RealmsResetWorldScreen.ResetWorldInfo(this.field_224356_d.getText(), this.field_224358_f, this.field_224357_e))));
        this.addButton(new Button(this.width / 2 + 8, RealmsResetNormalWorldScreen.func_239562_k_(12), 97, 20, DialogTexts.GUI_BACK, p_237933_1_ -> this.minecraft.displayGuiScreen(this.field_224354_b)));
        this.func_231411_u_();
    }
