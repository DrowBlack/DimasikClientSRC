...
extends NotifableRealmsScreen {
    ...
    @Override
    public void init() {
        this.addButton(new Button(this.width / 2 - 40, RealmsResetWorldScreen.func_239562_k_(14) - 10, 80, 20, this.field_224464_j, p_237959_1_ -> this.minecraft.displayGuiScreen(this.field_224457_c)));
        ...
        this.addButton(new TexturedButton(this.func_224434_c(1), RealmsResetWorldScreen.func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.generate"), field_237939_A_, p_237958_1_ -> this.minecraft.displayGuiScreen(new RealmsResetNormalWorldScreen(this, this.field_224462_h))));
        this.addButton(new TexturedButton(this.func_224434_c(2), RealmsResetWorldScreen.func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.upload"), field_237945_x_, p_237957_1_ -> {
            RealmsSelectFileToUploadScreen screen = new RealmsSelectFileToUploadScreen(this.field_224458_d.field_230582_a_, this.field_224455_a != -1 ? this.field_224455_a : this.field_224458_d.field_230595_n_, this, this.field_237943_M_);
            this.minecraft.displayGuiScreen(screen);
        }));
        this.addButton(new TexturedButton(this.func_224434_c(3), RealmsResetWorldScreen.func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.template"), field_237947_z_, p_237956_1_ -> {
        ...
        this.addButton(new TexturedButton(this.func_224434_c(1), RealmsResetWorldScreen.func_239562_k_(6) + 20, new TranslationTextComponent("mco.reset.world.adventure"), field_237946_y_, p_237955_1_ -> {
        ...
        this.addButton(new TexturedButton(this.func_224434_c(2), RealmsResetWorldScreen.func_239562_k_(6) + 20, new TranslationTextComponent("mco.reset.world.experience"), field_237940_B_, p_237954_1_ -> {
        ...
        this.addButton(new TexturedButton(this.func_224434_c(3), RealmsResetWorldScreen.func_239562_k_(6) + 20, new TranslationTextComponent("mco.reset.world.inspiration"), field_237941_C_, p_237951_1_ -> {
    ...
    private void func_237948_a_(MatrixStack p_237948_1_, int p_237948_2_, int p_237948_3_, ITextComponent p_237948_4_, ResourceLocation p_237948_5_, boolean p_237948_6_, boolean p_237948_7_) {
        ...
        RealmsResetWorldScreen.drawCenteredString(p_237948_1_, this.font, p_237948_4_, p_237948_2_ + 30, p_237948_3_, i);
    }
    ...
    private void func_224437_b(ResetWorldInfo p_224437_1_) {
    ...
    public void func_224438_a(ResetWorldInfo p_224438_1_) {
        if (this.field_224455_a == -1) {
