...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.field_224568_d = this.addButton(new Button(i - 2, RealmsSettingsScreen.func_239562_k_(12), 106, 20, new TranslationTextComponent("mco.configure.world.buttons.done"), p_238033_1_ -> this.func_224563_a()));
        this.addButton(new Button(this.width / 2 + 2, RealmsSettingsScreen.func_239562_k_(12), 106, 20, DialogTexts.GUI_CANCEL, p_238032_1_ -> this.minecraft.displayGuiScreen(this.field_224565_a)));
        ...
        Button button = new Button(this.width / 2 - 53, RealmsSettingsScreen.func_239562_k_(0), 106, 20, new TranslationTextComponent(s), p_238031_1_ -> {
            if (this.field_224566_b.field_230586_e_ == RealmsServer.Status.OPEN) {
                TranslationTextComponent itextcomponent = new TranslationTextComponent("mco.configure.world.close.question.line1");
                TranslationTextComponent itextcomponent1 = new TranslationTextComponent("mco.configure.world.close.question.line2");
        ...
        this.field_224570_f = new TextFieldWidget(this.minecraft.fontRenderer, i, RealmsSettingsScreen.func_239562_k_(4), 212, 20, null, new TranslationTextComponent("mco.configure.world.name"));
        ...
        this.field_224569_e = new TextFieldWidget(this.minecraft.fontRenderer, i, RealmsSettingsScreen.func_239562_k_(8), 212, 20, null, new TranslationTextComponent("mco.configure.world.description"));
