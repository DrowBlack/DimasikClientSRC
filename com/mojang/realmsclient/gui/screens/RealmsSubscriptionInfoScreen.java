...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, RealmsSubscriptionInfoScreen.func_239562_k_(6), 200, 20, new TranslationTextComponent("mco.configure.world.subscription.extend"), p_238073_1_ -> {
        ...
        this.addButton(new Button(this.width / 2 - 100, RealmsSubscriptionInfoScreen.func_239562_k_(12), 200, 20, DialogTexts.GUI_BACK, p_238071_1_ -> this.minecraft.displayGuiScreen(this.field_224580_b)));
        if (this.field_224581_c.field_230591_j_) {
            this.addButton(new Button(this.width / 2 - 100, RealmsSubscriptionInfoScreen.func_239562_k_(10), 200, 20, new TranslationTextComponent("mco.configure.world.delete.button"), p_238069_1_ -> {
                TranslationTextComponent itextcomponent = new TranslationTextComponent("mco.configure.world.delete.question.line1");
                TranslationTextComponent itextcomponent1 = new TranslationTextComponent("mco.configure.world.delete.question.line2");
        ...
        if (p_238074_1_) {
            new Thread("Realms-delete-realm"){
                ...
                public void run() {
                    ...
                    RealmsSubscriptionInfoScreen.this.minecraft.execute(() -> RealmsSubscriptionInfoScreen.this.minecraft.displayGuiScreen(RealmsSubscriptionInfoScreen.this.field_224582_d));
                }
            }.start();
        }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.font.func_243248_b(matrixStack, field_243174_c, i, RealmsSubscriptionInfoScreen.func_239562_k_(0), 0xA0A0A0);
        this.font.drawString(matrixStack, this.field_224591_m, i, RealmsSubscriptionInfoScreen.func_239562_k_(1), 0xFFFFFF);
        if (this.field_224592_n == Subscription.Type.NORMAL) {
            this.font.func_243248_b(matrixStack, field_243175_p, i, RealmsSubscriptionInfoScreen.func_239562_k_(3), 0xA0A0A0);
        } else if (this.field_224592_n == Subscription.Type.RECURRING) {
            this.font.func_243248_b(matrixStack, field_243176_q, i, RealmsSubscriptionInfoScreen.func_239562_k_(3), 0xA0A0A0);
        }
        this.font.func_243248_b(matrixStack, this.field_224590_l, i, RealmsSubscriptionInfoScreen.func_239562_k_(4), 0xFFFFFF);
