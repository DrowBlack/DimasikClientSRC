...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 4, RealmsTermsScreen.func_239562_k_(12), i, 20, new TranslationTextComponent("mco.terms.buttons.agree"), p_238078_1_ -> this.func_224721_a()));
        this.addButton(new Button(this.width / 2 + 4, RealmsTermsScreen.func_239562_k_(12), i, 20, new TranslationTextComponent("mco.terms.buttons.disagree"), p_238077_1_ -> this.minecraft.displayGuiScreen(this.field_224723_b)));
    }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        int k = RealmsTermsScreen.func_239562_k_(5);
        int l = j + this.font.getStringPropertyWidth(field_243186_p) + 1;
        int i1 = k + 1 + 9;
        this.field_224727_f = j <= mouseX && mouseX <= l && k <= mouseY && mouseY <= i1;
        this.font.func_243248_b(matrixStack, field_243186_p, this.width / 2 - 120 + i, RealmsTermsScreen.func_239562_k_(5), this.field_224727_f ? 7107012 : 0x3366BB);
