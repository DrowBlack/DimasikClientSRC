...
public class TextRenderingUtils {
    ...
    public static List<Line> func_225224_a(String p_225224_0_, LineSegment ... p_225224_1_) {
        return TextRenderingUtils.func_225225_a(p_225224_0_, Arrays.asList(p_225224_1_));
    }

    private static List<Line> func_225225_a(String p_225225_0_, List<LineSegment> p_225225_1_) {
        List<String> list = TextRenderingUtils.func_225223_a(p_225225_0_);
        return TextRenderingUtils.func_225222_a(list, p_225225_1_);
    }

    private static List<Line> func_225222_a(List<String> p_225222_0_, List<LineSegment> p_225222_1_) {
        int i = 0;
        ArrayList<Line> list = Lists.newArrayList();
        for (String s : p_225222_0_) {
            ArrayList<LineSegment> list1 = Lists.newArrayList();
            for (String s1 : TextRenderingUtils.func_225226_a(s, "%link")) {
                if ("%link".equals(s1)) {
                    list1.add(p_225222_1_.get(i++));
                    continue;
                }
                list1.add(LineSegment.func_225218_a(s1));
            }
    ...
    public static class LineSegment {
        ...
        public boolean equals(Object p_equals_1_) {
            ...
            if (p_equals_1_ != null && this.getClass() == p_equals_1_.getClass()) {
                LineSegment textrenderingutils$linesegment = (LineSegment)p_equals_1_;
        ...
        public static LineSegment func_225214_a(String p_225214_0_, String p_225214_1_) {
            return new LineSegment(null, p_225214_0_, p_225214_1_);
        }

        @VisibleForTesting
        protected static LineSegment func_225218_a(String p_225218_0_) {
            return new LineSegment(p_225218_0_);
        }
    }
    ...
    public static class Line {
        ...
        Line(List<LineSegment> p_i51644_1_) {
            this.field_225213_a = p_i51644_1_;
        }

        public String toString() {
            return "Line{segments=" + String.valueOf(this.field_225213_a) + "}";
        }
        ...
        public boolean equals(Object p_equals_1_) {
            ...
            if (p_equals_1_ != null && this.getClass() == p_equals_1_.getClass()) {
                Line textrenderingutils$line = (Line)p_equals_1_;
