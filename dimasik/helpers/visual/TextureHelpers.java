package dimasik.helpers.visual;
...
public final class TextureHelpers {
    ...
    public static int uploadTextureImageAllocate(int textureId, BufferedImage texture, boolean blur, boolean clamp) {
        TextureHelpers.allocateTexture(textureId, texture.getWidth(), texture.getHeight());
        return TextureHelpers.uploadTextureImageSub(textureId, texture, 0, 0, blur, clamp);
    }
    ...
    public static int uploadTextureImageSub(int textureId, BufferedImage p_110995_1_, int p_110995_2_, int p_110995_3_, boolean p_110995_4_, boolean p_110995_5_) {
        GlStateManager.bindTexture(textureId);
        TextureHelpers.uploadTextureImageSubImpl(p_110995_1_, p_110995_2_, p_110995_3_, p_110995_4_, p_110995_5_);
        return textureId;
    }
    ...
    private static void uploadTextureImageSubImpl(BufferedImage p_110993_0_, int p_110993_1_, int p_110993_2_, boolean p_110993_3_, boolean p_110993_4_) {
        ...
        TextureHelpers.setTextureBlurred(p_110993_3_);
        TextureHelpers.setTextureClamped(p_110993_4_);
        for (int l = 0; l < i * j; l += i * k) {
            int i1 = l / i;
            int j1 = Math.min(k, j - i1);
            int k1 = i * j1;
            p_110993_0_.getRGB(0, i1, i, j1, aint, 0, i);
            TextureHelpers.copyToBuffer(aint, k1);
            TextureHelpers.texSubImage2D(3553, 0, p_110993_1_, p_110993_2_ + i1, i, j1, 32993, 33639, DATA_BUFFER);
        }
    }
    ...
    private static void copyToBuffer(int[] p_110990_0_, int p_110990_1_) {
        TextureHelpers.copyToBufferPos(p_110990_0_, 0, p_110990_1_);
    }
    ...
    private static void setTextureBlurred(boolean p_147951_0_) {
        TextureHelpers.setTextureBlurMipmap(p_147951_0_, false);
    }
    ...
    public static void allocateTexture(int textureId, int width, int height) {
        TextureHelpers.allocateTextureImpl(textureId, 0, width, height);
    }
