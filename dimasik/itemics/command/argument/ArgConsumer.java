package dimasik.itemics.command.argument;
...
import dimasik.itemics.api.command.exception.CommandNotEnoughArgumentsException;
import dimasik.itemics.api.command.exception.CommandTooManyArgumentsException;
import dimasik.itemics.api.command.manager.ICommandManager;
import dimasik.itemics.command.argument.CommandArguments;
...
implements IArgConsumer {
    ...
    public <T, O, D extends IDatatypePost<T, O>> T getDatatypePost(D datatype, O original) throws CommandInvalidTypeException, CommandNotEnoughArgumentsException {
        try {
            ...
            if (((Boolean)Itemics.settings().verboseCommandExceptions.value).booleanValue()) {
                e.printStackTrace();
            }
    ...
    implements IDatatypeContext {
        ...
        public final IItemics getItemics() {
            return ArgConsumer.this.manager.getItemics();
        }
