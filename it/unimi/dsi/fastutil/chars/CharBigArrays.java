...
public final class CharBigArrays {
    ...
    public static void radixSort(char[][] a, long from, long to) {
        ...
        while (offsetPos > 0) {
            ...
            long i = length;
            while (i-- != 0L) {
                ByteBigArrays.set(digit, i, (byte)(CharBigArrays.get(a, first + i) >>> shift & 0xFF ^ 0));
            }
            i = length;
            while (i-- != 0L) {
                int n = ByteBigArrays.get(digit, i) & 0xFF;
                count[n] = count[n] + 1L;
            }
            int lastUsed = -1;
            long p = 0L;
    ...
    public static void radixSort(char[][] a, char[][] b, long from, long to) {
        ...
        while (offsetPos > 0) {
            ...
            long i = length;
            while (i-- != 0L) {
                ByteBigArrays.set(digit, i, (byte)(CharBigArrays.get(k, first + i) >>> shift & 0xFF ^ 0));
            }
            i = length;
            while (i-- != 0L) {
                int n = ByteBigArrays.get(digit, i) & 0xFF;
