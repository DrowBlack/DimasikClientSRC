...
public final class DoubleBigArrays {
    ...
    public static void radixSort(double[][] a, long from, long to) {
        ...
        while (offsetPos > 0) {
            ...
            long i = length;
            while (i-- != 0L) {
                ByteBigArrays.set(digit, i, (byte)(DoubleBigArrays.fixDouble(DoubleBigArrays.get(a, first + i)) >>> shift & 0xFFL ^ (long)signMask));
            }
            i = length;
            while (i-- != 0L) {
    ...
    public static void radixSort(double[][] a, double[][] b, long from, long to) {
        ...
        while (offsetPos > 0) {
            ...
            long i = length;
            while (i-- != 0L) {
                ByteBigArrays.set(digit, i, (byte)(DoubleBigArrays.fixDouble(DoubleBigArrays.get(k, first + i)) >>> shift & 0xFFL ^ (long)signMask));
            }
            i = length;
            while (i-- != 0L) {
                int n2 = ByteBigArrays.get(digit, i) & 0xFF;
