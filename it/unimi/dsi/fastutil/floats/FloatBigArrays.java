...
public final class FloatBigArrays {
    ...
    public static void radixSort(float[][] a, long from, long to) {
        ...
        while (offsetPos > 0) {
            ...
            long i = length;
            while (i-- != 0L) {
                ByteBigArrays.set(digit, i, (byte)(FloatBigArrays.fixFloat(FloatBigArrays.get(a, first + i)) >>> shift & 0xFFL ^ (long)signMask));
            }
            i = length;
            while (i-- != 0L) {
    ...
    public static void radixSort(float[][] a, float[][] b, long from, long to) {
        ...
        while (offsetPos > 0) {
            ...
            long i = length;
            while (i-- != 0L) {
                ByteBigArrays.set(digit, i, (byte)(FloatBigArrays.fixFloat(FloatBigArrays.get(k, first + i)) >>> shift & 0xFFL ^ (long)signMask));
            }
            i = length;
            while (i-- != 0L) {
                int n2 = ByteBigArrays.get(digit, i) & 0xFF;
