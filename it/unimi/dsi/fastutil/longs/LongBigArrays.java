...
public final class LongBigArrays {
    ...
    public static void radixSort(long[][] a, long from, long to) {
        ...
        while (offsetPos > 0) {
            ...
            long i = length;
            while (i-- != 0L) {
                ByteBigArrays.set(digit, i, (byte)(LongBigArrays.get(a, first + i) >>> shift & 0xFFL ^ (long)signMask));
            }
            i = length;
            while (i-- != 0L) {
    ...
    public static void radixSort(long[][] a, long[][] b, long from, long to) {
        ...
        while (offsetPos > 0) {
            ...
            long i = length;
            while (i-- != 0L) {
                ByteBigArrays.set(digit, i, (byte)(LongBigArrays.get(k, first + i) >>> shift & 0xFFL ^ (long)signMask));
            }
            i = length;
            while (i-- != 0L) {
                int n2 = ByteBigArrays.get(digit, i) & 0xFF;
