...
implements ConfigurationValueType {
    ...
    public static CheckerFrameworkVersion valueOf(String versionString) {
        ...
        int n = minor = m.group(2) != null && !m.group(2).isEmpty() ? Integer.parseInt(m.group(2)) : 0;
        if (minor > 999) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CheckerFrameworkVersion)) {
            return false;
        }
        return this.version == ((CheckerFrameworkVersion)obj).version;
    }
