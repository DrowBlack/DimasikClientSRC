...
import lombok.delombok.PrettyPrinter;
import lombok.javac.CommentInfo;

public class DelombokResult {
    private final java.util.List<CommentInfo> comments;
    private final java.util.List<Integer> textBlockStarts;
    private final JCTree.JCCompilationUnit compilationUnit;
    private final boolean changed;
    private final FormatPreferences formatPreferences;

    public DelombokResult(java.util.List<CommentInfo> comments, java.util.List<Integer> textBlockStarts, JCTree.JCCompilationUnit compilationUnit, boolean changed, FormatPreferences formatPreferences) {
    ...
    public void print(Writer out) throws IOException {
        ...
        int idx = 0;
        for (int tbs : this.textBlockStarts) {
            textBlockStarts_[idx++] = tbs;
        }
