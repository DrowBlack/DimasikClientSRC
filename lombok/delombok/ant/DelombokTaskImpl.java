...
public class DelombokTaskImpl {
    ...
    public void execute(Location location) throws BuildException {
        ...
        try {
            ...
            throw new BuildException(String.valueOf(e.getMessage()) + " Run java -jar lombok.jar --format-help for detailed format help.");
        }
        ...
        try {
            ...
            throw new BuildException("I/O problem during delombok", (Throwable)e, location);
        }
    }
}
