...
extends EclipseAnnotationHandler<Locked.Read> {
    ...
    @Override
    public void handle(AnnotationValues<Locked.Read> annotation, Annotation source, EclipseNode annotationNode) {
    ...
    @Override
    public void preHandle(AnnotationValues<Locked.Read> annotation, Annotation source, EclipseNode annotationNode) {
        String annotationValue = annotation.getInstance().value();
