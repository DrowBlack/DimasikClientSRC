...
public class AdvancementRewards {
    ...
    public void apply(ServerPlayerEntity player) {
        ...
        this.function.func_218039_a(minecraftserver.getFunctionManager()).ifPresent(commandFunction -> minecraftserver.getFunctionManager().execute((FunctionObject)commandFunction, player.getCommandSource().withFeedbackDisabled().withPermissionLevel(2)));
    }

    public String toString() {
        return "AdvancementRewards{experience=" + this.experience + ", loot=" + Arrays.toString(this.loot) + ", recipes=" + Arrays.toString(this.recipes) + ", function=" + String.valueOf(this.function) + "}";
    }
    ...
    public static AdvancementRewards deserializeRewards(JsonObject json) throws JsonParseException {
        ...
        FunctionObject.CacheableFunction functionobject$cacheablefunction = json.has("function") ? new FunctionObject.CacheableFunction(new ResourceLocation(JSONUtils.getString(json, "function"))) : FunctionObject.CacheableFunction.EMPTY;
    ...
    public static class Builder {
        ...
        public static Builder experience(int experienceIn) {
            return new Builder().addExperience(experienceIn);
        }

        public Builder addExperience(int experienceIn) {
            this.experience += experienceIn;
            return this;
        }

        public static Builder recipe(ResourceLocation recipeIn) {
            return new Builder().addRecipe(recipeIn);
        }

        public Builder addRecipe(ResourceLocation recipeIn) {
