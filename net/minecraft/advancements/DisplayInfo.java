...
public class DisplayInfo {
    ...
    public static DisplayInfo deserialize(JsonObject object) {
        IFormattableTextComponent itextcomponent = ITextComponent.Serializer.getComponentFromJson(object.get("title"));
        IFormattableTextComponent itextcomponent1 = ITextComponent.Serializer.getComponentFromJson(object.get("description"));
        if (itextcomponent != null && itextcomponent1 != null) {
            ItemStack itemstack = DisplayInfo.deserializeIcon(JSONUtils.getJsonObject(object, "icon"));
