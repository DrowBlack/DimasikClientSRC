...
extends AbstractCriterionTrigger<Instance> {
    ...
    public Instance deserializeTrigger(JsonObject json, EntityPredicate.AndPredicate entityPredicate, ConditionArrayParser conditionsParser) {
        ...
        return new Instance(entityPredicate, entitypredicate$andpredicate, entitypredicate$andpredicate1, entitypredicate$andpredicate2);
    }
    ...
    public void trigger(ServerPlayerEntity player, AnimalEntity parent1, AnimalEntity parent2, @Nullable AgeableEntity child) {
        ...
        this.triggerListeners(player, instance -> instance.test(lootcontext, lootcontext1, lootcontext2));
    }
    ...
    extends CriterionInstance {
        ...
        public static Instance forAll(EntityPredicate parent, EntityPredicate partner, EntityPredicate child) {
            return new Instance(EntityPredicate.AndPredicate.ANY_AND, EntityPredicate.AndPredicate.createAndFromEntityCondition(parent), EntityPredicate.AndPredicate.createAndFromEntityCondition(partner), EntityPredicate.AndPredicate.createAndFromEntityCondition(child));
        }
