...
public class DamageSourcePredicate {
    ...
    public boolean test(ServerWorld world, Vector3d vector, DamageSource source) {
        ...
        if (this.bypassesArmor != null && this.bypassesArmor.booleanValue() != source.isUnblockable()) {
            return false;
        }
        if (this.bypassesInvulnerability != null && this.bypassesInvulnerability.booleanValue() != source.canHarmInCreative()) {
            return false;
        }
        if (this.bypassesMagic != null && this.bypassesMagic.booleanValue() != source.isDamageAbsolute()) {
            return false;
        }
        if (this.isFire != null && this.isFire.booleanValue() != source.isFireDamage()) {
            return false;
        }
        if (this.isMagic != null && this.isMagic.booleanValue() != source.isMagicDamage()) {
            return false;
        }
        if (this.isLightning != null && this.isLightning != (source == DamageSource.LIGHTNING_BOLT)) {
            return false;
        }
        if (!this.directEntity.test(world, vector, source.getImmediateSource())) {
            return false;
        }
    ...
    public static DamageSourcePredicate deserialize(@Nullable JsonElement element) {
        if (element != null && !element.isJsonNull()) {
            ...
            Boolean obool = DamageSourcePredicate.optionalBoolean(jsonobject, "is_projectile");
            Boolean obool1 = DamageSourcePredicate.optionalBoolean(jsonobject, "is_explosion");
            Boolean obool2 = DamageSourcePredicate.optionalBoolean(jsonobject, "bypasses_armor");
            Boolean obool3 = DamageSourcePredicate.optionalBoolean(jsonobject, "bypasses_invulnerability");
            Boolean obool4 = DamageSourcePredicate.optionalBoolean(jsonobject, "bypasses_magic");
            Boolean obool5 = DamageSourcePredicate.optionalBoolean(jsonobject, "is_fire");
            Boolean obool6 = DamageSourcePredicate.optionalBoolean(jsonobject, "is_magic");
            Boolean obool7 = DamageSourcePredicate.optionalBoolean(jsonobject, "is_lightning");
    ...
    public static class Builder {
        ...
        public Builder isLightning(Boolean isLightning) {
            this.isLightning = isLightning;
            return this;
        }
