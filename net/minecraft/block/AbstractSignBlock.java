...
implements IWaterLoggable {
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        boolean bl = flag = itemstack.getItem() instanceof DyeItem && player.abilities.allowEdit;
        if (worldIn.isRemote) {
        ...
        if (tileentity instanceof SignTileEntity) {
            ...
            if (flag && (flag1 = signtileentity.setTextColor(((DyeItem)itemstack.getItem()).getDyeColor())) && !player.isCreative()) {
                itemstack.shrink(1);
            }
