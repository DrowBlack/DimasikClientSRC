    ...
    public void grow(ServerWorld worldIn, Random rand, BlockPos pos, BlockState state) {
        ...
        block0: for (int i = 0; i < 128; ++i) {
            ...
            for (int j = 0; j < i / 16; ++j) {
                if (!worldIn.getBlockState((blockpos1 = blockpos1.add(rand.nextInt(3) - 1, (rand.nextInt(3) - 1) * rand.nextInt(3) / 2, rand.nextInt(3) - 1)).down()).isIn(this) || worldIn.getBlockState(blockpos1).hasOpaqueCollisionShape(worldIn, blockpos1)) continue block0;
            }
            BlockState blockstate2 = worldIn.getBlockState(blockpos1);
            if (blockstate2.isIn(blockstate.getBlock()) && rand.nextInt(10) == 0) {
                ((IGrowable)((Object)blockstate.getBlock())).grow(worldIn, rand, blockpos1, blockstate2);
            }
            ...
            if (!blockstate1.isValidPosition(worldIn, blockpos1)) continue;
