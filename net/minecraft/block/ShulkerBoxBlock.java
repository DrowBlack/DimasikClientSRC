...
extends ContainerBlock {
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        if (tileentity instanceof ShulkerBoxTileEntity) {
            ...
            if (!worldIn.isRemote && player.isCreative() && !shulkerboxtileentity.isEmpty()) {
                ...
                ItemEntity itementity = new ItemEntity(worldIn, (double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5, itemstack);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName() && (tileentity = worldIn.getTileEntity(pos)) instanceof ShulkerBoxTileEntity) {
    ...
    public static DyeColor getColorFromItem(Item itemIn) {
        return ShulkerBoxBlock.getColorFromBlock(Block.getBlockFromItem(itemIn));
    }
    ...
    public static ItemStack getColoredItemStack(@Nullable DyeColor colorIn) {
        return new ItemStack(ShulkerBoxBlock.getBlockByColor(colorIn));
    }
