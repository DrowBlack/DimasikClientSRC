...
extends AbstractSkullBlock {
    ...
    protected SkullBlock(ISkullType type, AbstractBlock.Properties properties) {
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        return (BlockState)this.getDefaultState().with(ROTATION, MathHelper.floor((double)(context.getPlacementYaw() * 16.0f / 360.0f) + 0.5) & 0xF);
    }
