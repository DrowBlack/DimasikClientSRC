...
extends ContainerBlock {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (!worldIn.isRemote && placer != null && (tileentity = worldIn.getTileEntity(pos)) instanceof StructureBlockTileEntity) {
    ...
    public void neighborChanged(BlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos, boolean isMoving) {
        TileEntity tileentity;
        if (worldIn instanceof ServerWorld && (tileentity = worldIn.getTileEntity(pos)) instanceof StructureBlockTileEntity) {
