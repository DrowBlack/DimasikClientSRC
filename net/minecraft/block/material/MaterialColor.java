...
public class MaterialColor {
    ...
    public static final MaterialColor TNT = new MaterialColor(4, 0xFF0000);
    ...
    public static final MaterialColor NETHERRACK = new MaterialColor(35, 0x700200);
    ...
    private MaterialColor(int index, int color) {
        ...
        MaterialColor.COLORS[index] = this;
    }
