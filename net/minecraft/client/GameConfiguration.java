...
public class GameConfiguration {
    ...
    public GameConfiguration(UserInformation userInfo, ScreenSize screenSize, FolderInformation folderInfo, GameInformation gameInfo, ServerInformation serverInfo) {
