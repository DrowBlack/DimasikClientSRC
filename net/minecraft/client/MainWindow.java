...
implements AutoCloseable {
    ...
    public MainWindow(IWindowEventListener mc, MonitorHandler monitonHandler, ScreenSize size, @Nullable String videoModeName, String titleIn) {
        ...
        this.videoMode = optional.isPresent() ? optional : (size.fullscreenWidth.isPresent() && size.fullscreenHeight.isPresent() ? Optional.of(new VideoMode(size.fullscreenWidth.getAsInt(), size.fullscreenHeight.getAsInt(), 8, 8, 8, 60)) : Optional.empty());
        ...
        if (Reflector.EarlyProgressVisualization_handOffWindow.exists()) {
            ...
            i = Reflector.callLong(object, Reflector.EarlyProgressVisualization_handOffWindow, () -> this.width, () -> this.height, () -> titleIn, () -> this.fullscreen && monitor != null ? monitor.getMonitorPointer() : 0L);
            if (Config.isAntialiasing()) {
                GLFW.glfwDestroyWindow(i);
                i = 0L;
            }
        }
        this.handle = i != 0L ? i : GLFW.glfwCreateWindow(this.width, this.height, titleIn, this.fullscreen && monitor != null ? monitor.getMonitorPointer() : 0L, 0L);
        if (monitor != null) {
    ...
    public void setWindowIcon(InputStream iconStream16X, InputStream iconStream32X) {
        ...
        try (MemoryStack memorystack = MemoryStack.stackPush();){
            if (iconStream16X == null) {
                throw new FileNotFoundException("/assets/minecraft/main/images/icon16.png");
            }
            if (iconStream32X == null) {
                throw new FileNotFoundException("/assets/minecraft/main/images/icon32.png");
            }
    ...
    public void logGlError(int error, long description) {
        ...
        LOGGER.error("{}: {}", (Object)error, (Object)s);
    }
    ...
    private void updateVideoMode() {
        boolean flag;
        RenderSystem.assertThread(RenderSystem::isInInitPhase);
        boolean bl = flag = GLFW.glfwGetWindowMonitor(this.handle) != 0L;
        if (this.fullscreen) {
