...
public class BackgroundMusicTracks {
    ...
    public static final BackgroundMusicSelector UNDER_WATER_MUSIC = BackgroundMusicTracks.getDefaultBackgroundMusicSelector(SoundEvents.MUSIC_UNDER_WATER);
    public static final BackgroundMusicSelector WORLD_MUSIC = BackgroundMusicTracks.getDefaultBackgroundMusicSelector(SoundEvents.MUSIC_GAME);
