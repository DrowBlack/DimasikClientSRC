...
public class RenderComponentsUtil {
    ...
    public static List<IReorderingProcessor> func_238505_a_(ITextProperties p_238505_0_, int p_238505_1_, FontRenderer p_238505_2_) {
        ...
        p_238505_0_.getComponentWithStyle((p_238503_1_, p_238503_2_) -> {
            textpropertiesmanager.func_238155_a_(ITextProperties.func_240653_a_(RenderComponentsUtil.func_238504_a_(p_238503_2_), p_238503_1_));
        ...
        p_238505_2_.getCharacterManager().func_243242_a(textpropertiesmanager.func_238156_b_(), p_238505_1_, Style.EMPTY, (p_243256_1_, p_243256_2_) -> {
            IReorderingProcessor ireorderingprocessor = LanguageMap.getInstance().func_241870_a((ITextProperties)p_243256_1_);
            list.add(p_243256_2_ != false ? IReorderingProcessor.func_242234_a(field_238502_a_, ireorderingprocessor) : ireorderingprocessor);
        });
