...
implements AutoCloseable {
    ...
    private final IFutureReloadListener reloadListener = new ReloadListener<Map<ResourceLocation, List<IGlyphProvider>>>(){
        ...
        protected Map<ResourceLocation, List<IGlyphProvider>> prepare(IResourceManager resourceManagerIn, IProfiler profilerIn) {
            ...
            HashMap<ResourceLocation, List<IGlyphProvider>> map = Maps.newHashMap();
            for (ResourceLocation resourcelocation : resourceManagerIn.getAllResourceLocations("font", p_215274_0_ -> p_215274_0_.endsWith(".json"))) {
                ...
                List list = map.computeIfAbsent(resourcelocation1, p_215272_0_ -> Lists.newArrayList(new DefaultGlyphProvider()));
                        ...
                        try (InputStream inputstream = iresource.getInputStream();
                            ...
                            for (int i = jsonarray.size() - 1; i >= 0; --i) {
                                ...
                                try {
                                    ...
                                    LOGGER.warn("Unable to read definition '{}' in fonts.json in resourcepack: '{}': {}", (Object)resourcelocation1, (Object)iresource.getPackName(), (Object)runtimeexception.getMessage());
                                }
                            }
                            profilerIn.endSection();
                        }
                        catch (RuntimeException runtimeexception1) {
                            LOGGER.warn("Unable to load font '{}' in fonts.json in resourcepack: '{}': {}", (Object)resourcelocation1, (Object)iresource.getPackName(), (Object)runtimeexception1.getMessage());
                        }
                        profilerIn.endSection();
                    }
                }
                catch (IOException ioexception) {
                    LOGGER.warn("Unable to load font '{}' in fonts.json: {}", (Object)resourcelocation1, (Object)ioexception.getMessage());
                }
                ...
                intset.forEach(p_238555_1_ -> {
                    block1: {
                        IGlyphProvider iglyphprovider2;
                        if (p_238555_1_ == 32) break block1;
                        Iterator iterator = Lists.reverse(list).iterator();
                        while (iterator.hasNext() && (iglyphprovider2 = (IGlyphProvider)iterator.next()).getGlyphInfo(p_238555_1_) == null) {
                        }
                    }
                });
                profilerIn.endSection();
        ...
        protected void apply(Map<ResourceLocation, List<IGlyphProvider>> objectIn, IResourceManager resourceManagerIn, IProfiler profilerIn) {
            ...
            objectIn.forEach((p_238556_1_, p_238556_2_) -> {
                Font font = new Font(FontResourceManager.this.textureManager, (ResourceLocation)p_238556_1_);
                font.setGlyphProviders(Lists.reverse(p_238556_2_));
                FontResourceManager.this.field_238546_d_.put((ResourceLocation)p_238556_1_, font);
            });
            profilerIn.endSection();
            profilerIn.endTick();
        }
    ...
    public FontResourceManager(TextureManager p_i49772_1_) {
        ...
        this.field_238545_c_ = Util.make(new Font(p_i49772_1_, field_238544_a_), p_238550_0_ -> p_238550_0_.setGlyphProviders(Lists.newArrayList(new DefaultGlyphProvider())));
    }
    ...
    public FontRenderer func_238548_a_() {
        return new FontRenderer(p_238552_1_ -> this.field_238546_d_.getOrDefault(this.field_238547_f_.getOrDefault(p_238552_1_, (ResourceLocation)p_238552_1_), this.field_238545_c_));
    }
