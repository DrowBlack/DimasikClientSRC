...
implements IGlyphProviderFactory {
    ...
    public IGlyphProvider create(IResourceManager resourceManagerIn) {
        ...
        block10: {
            ...
            IResource iresource = resourceManagerIn.getResource(new ResourceLocation(this.file.getNamespace(), "font/" + this.file.getPath()));
            try {
                ...
                trueTypeGlyphProvider = new TrueTypeGlyphProvider(bytebuffer, (STBTTFontinfo)stbttfontinfo, this.size, this.oversample, this.shiftX, this.shiftY, this.chars);
