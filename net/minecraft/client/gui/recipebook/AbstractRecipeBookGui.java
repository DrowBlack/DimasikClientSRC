...
extends RecipeBookGui {
    ...
    public void setupGhostRecipe(IRecipe<?> p_193951_1_, List<Slot> p_193951_2_) {
        ...
        this.ghostRecipe.addIngredient(Ingredient.fromStacks(itemstack), p_193951_2_.get((int)2).xPos, p_193951_2_.get((int)2).yPos);
