...
IRecipePlacer<Ingredient> {
    ...
    public void initSearchBar(boolean widthTooNarrowIn) {
        ...
        this.searchBar = new TextFieldWidget(this.mc.fontRenderer, i + 25, j + 14, 80, 14, new TranslationTextComponent("itemGroup.search"));
        ...
        if (this.currentTab != null) {
            this.currentTab = this.recipeTabs.stream().filter(p_209505_1_ -> p_209505_1_.func_201503_d().equals((Object)this.currentTab.func_201503_d())).findFirst().orElse(null);
        }
        if (this.currentTab == null) {
    ...
    public int updateScreenPosition(boolean p_193011_1_, int p_193011_2_, int p_193011_3_) {
        int i = this.isVisible() && !p_193011_1_ ? 177 + (p_193011_2_ - p_193011_3_ - 200) / 2 : (p_193011_2_ - p_193011_3_) / 2;
        return i;
    }
    ...
    private void updateCollections(boolean p_193003_1_) {
        ...
        list.forEach(p_193944_1_ -> p_193944_1_.canCraft(this.stackedContents, this.field_201522_g.getWidth(), this.field_201522_g.getHeight(), this.recipeBook));
        ArrayList<RecipeList> list1 = Lists.newArrayList(list);
        ...
        if (!s.isEmpty()) {
            ObjectLinkedOpenHashSet objectset = new ObjectLinkedOpenHashSet(this.mc.getSearchTree(SearchTreeManager.RECIPES).search(s.toLowerCase(Locale.ROOT)));
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        if (this.isVisible()) {
            ...
            if (!this.searchBar.isFocused() && this.searchBar.getText().isEmpty()) {
                RecipeBookGui.drawString(matrixStack, this.mc.fontRenderer, field_241620_l_, i + 25, j + 14, -1);
            } else {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (this.isVisible() && !this.mc.player.isSpectator()) {
            ...
            if (this.toggleRecipesBtn.mouseClicked(mouseX, mouseY, button)) {
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        if (this.isVisible() && !this.mc.player.isSpectator()) {
            ...
            if (this.searchBar.isFocused() && this.searchBar.getVisible() && keyCode != 256) {
                return true;
            }
            if (this.mc.gameSettings.keyBindChat.matchesKey(keyCode, scanCode) && !this.searchBar.isFocused()) {
    ...
    public void setupGhostRecipe(IRecipe<?> p_193951_1_, List<Slot> p_193951_2_) {
        ...
        this.ghostRecipe.addIngredient(Ingredient.fromStacks(itemstack), p_193951_2_.get((int)0).xPos, p_193951_2_.get((int)0).yPos);
    ...
    public void setSlotContents(Iterator<Ingredient> ingredients, int slotIn, int maxAmount, int y, int x) {
        ...
        if (!ingredient.hasNoMatchingItems()) {
            Slot slot = (Slot)this.field_201522_g.inventorySlots.get(slotIn);
