...
extends Screen {
    ...
    protected void init() {
        ...
        this.buttonResourcePack = this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 72, 200, 20, AddServerScreen.func_238624_a_(this.serverData.getResourceMode()), p_213031_1_ -> {
        ...
        this.buttonAddServer = this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 96 + 18, 200, 20, new TranslationTextComponent("addServer.add"), p_213030_1_ -> this.onButtonServerAddPressed()));
        this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 18, 200, 20, DialogTexts.GUI_CANCEL, p_213029_1_ -> this.field_213032_b.accept(false)));
        this.func_228180_b_();
    }
