...
extends Screen {
    ...
    public ConfirmBackupScreen(@Nullable Screen p_i51122_1_, ICallback p_i51122_2_, ITextComponent p_i51122_3_, ITextComponent p_i51122_4_, boolean p_i51122_5_) {
        super(p_i51122_3_);
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 155, 100 + i, 150, 20, new TranslationTextComponent("selectWorld.backupJoinConfirmButton"), p_212993_1_ -> this.callback.proceed(true, this.field_212996_j.isChecked())));
        this.addButton(new Button(this.width / 2 - 155 + 160, 100 + i, 150, 20, new TranslationTextComponent("selectWorld.backupJoinSkipButton"), p_212992_1_ -> this.callback.proceed(false, this.field_212996_j.isChecked())));
        this.addButton(new Button(this.width / 2 - 155 + 80, 124 + i, 150, 20, DialogTexts.GUI_CANCEL, p_212991_1_ -> this.minecraft.displayGuiScreen(this.parentScreen)));
