...
extends SettingsScreen {
    ...
    @Override
    protected void init() {
        this.addButton(new Button(this.width / 2 - 155, 18, 150, 20, new TranslationTextComponent("options.mouse_settings"), p_213126_1_ -> this.minecraft.displayGuiScreen(new MouseSettingsScreen(this, this.gameSettings))));
        ...
        this.addButton(new Button(this.width / 2 - 155 + 160, this.height - 29, 150, 20, DialogTexts.GUI_DONE, p_213124_1_ -> this.minecraft.displayGuiScreen(this.parentScreen)));
    }
