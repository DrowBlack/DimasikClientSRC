...
extends Screen {
    ...
    public CreateWorldScreen(@Nullable Screen p_i242064_1_, WorldSettings p_i242064_2_, DimensionGeneratorSettings p_i242064_3_, @Nullable Path p_i242064_4_, DatapackCodec p_i242064_5_, DynamicRegistries.Impl p_i242064_6_) {
        ...
        this.field_238937_w_ = this.field_238936_v_ = p_i242064_2_.getDifficulty();
        this.field_238932_M_.func_234899_a_(p_i242064_2_.getGameRules(), null);
    ...
    protected void init() {
        ...
        this.btnGameMode = this.addButton(new Button(i, 100, 150, 20, StringTextComponent.EMPTY, p_214316_1_ -> {
            ...
            public ITextComponent getMessage() {
                return new TranslationTextComponent("options.generic_value", field_243417_q, new TranslationTextComponent("selectWorld.gameMode." + CreateWorldScreen.this.field_228197_f_.field_228217_e_));
            }
        ...
        this.field_238931_H_ = this.addButton(new Button(j, 151, 150, 20, new TranslationTextComponent("selectWorld.dataPacks"), p_214320_1_ -> this.func_238958_v_()));
        this.field_238930_G_ = this.addButton(new Button(i, 185, 150, 20, new TranslationTextComponent("selectWorld.gameRules"), p_214312_1_ -> this.minecraft.displayGuiScreen(new EditGamerulesScreen(this.field_238932_M_.clone(), p_238946_1_ -> {
        ...
        this.btnMoreOptions = this.addButton(new Button(j, 185, 150, 20, new TranslationTextComponent("selectWorld.moreWorldOptions"), p_214321_1_ -> this.toggleMoreWorldOptions()));
