...
extends SettingsScreen {
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), 200, 20, Lang.getComponent("of.options.skinCustomisation.ofCape"), p_lambda$init$2_1_ -> this.minecraft.displayGuiScreen(new GuiScreenCapeOF(this))));
        this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 24 * ((i += 2) >> 1), 200, 20, DialogTexts.GUI_DONE, p_lambda$init$3_1_ -> this.minecraft.displayGuiScreen(this.parentScreen)));
    }
    ...
    private ITextComponent func_238655_a_(PlayerModelPart p_238655_1_) {
        return DialogTexts.getComposedOptionMessage(p_238655_1_.getName(), this.gameSettings.getModelParts().contains((Object)p_238655_1_));
    }
}
