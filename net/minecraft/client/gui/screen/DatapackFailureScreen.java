...
extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 155, this.height / 6 + 96, 150, 20, new TranslationTextComponent("datapackFailure.safeMode"), p_238622_1_ -> this.field_238620_b_.run()));
        this.addButton(new Button(this.width / 2 - 155 + 160, this.height / 6 + 96, 150, 20, new TranslationTextComponent("gui.toTitle"), p_238621_1_ -> this.minecraft.displayGuiScreen(null)));
    }
