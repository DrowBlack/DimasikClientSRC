...
extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, Math.min(this.height / 2 + this.textHeight / 2 + 9, this.height - 30), 200, 20, new TranslationTextComponent("gui.toMenu"), p_213033_1_ -> this.minecraft.displayGuiScreen(this.nextScreen)));
    }
