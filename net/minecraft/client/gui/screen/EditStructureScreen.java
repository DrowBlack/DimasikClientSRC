...
extends Screen {
    ...
    protected void init() {
        ...
        this.doneButton = this.addButton(new Button(this.width / 2 - 4 - 150, 210, 150, 20, DialogTexts.GUI_DONE, p_214274_1_ -> this.func_195275_h()));
        this.cancelButton = this.addButton(new Button(this.width / 2 + 4, 210, 150, 20, DialogTexts.GUI_CANCEL, p_214275_1_ -> this.func_195272_i()));
        ...
        this.nameEdit = new TextFieldWidget(this.font, this.width / 2 - 152, 40, 300, 20, (ITextComponent)new TranslationTextComponent("structure_block.structure_name")){
