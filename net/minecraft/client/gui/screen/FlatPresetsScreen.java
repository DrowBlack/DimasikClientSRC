...
extends Screen {
    ...
    private static List<FlatLayerInfo> func_238637_a_(String p_238637_0_) {
        ...
        for (String s : astring) {
            FlatLayerInfo flatlayerinfo = FlatPresetsScreen.func_238638_a_(s, i);
    ...
    public static FlatGenerationSettings func_243299_a(Registry<Biome> p_243299_0_, String p_243299_1_, FlatGenerationSettings p_243299_2_) {
        ...
        List<FlatLayerInfo> list = FlatPresetsScreen.func_238637_a_(iterator.next());
        if (list.isEmpty()) {
            return FlatGenerationSettings.func_242869_a(p_243299_0_);
        }
        ...
        if (iterator.hasNext()) {
            try {
                ...
                p_243299_0_.getOptionalValue(registrykey).orElseThrow(() -> new IllegalArgumentException("Invalid Biome: " + String.valueOf(resourcelocation)));
            }
            catch (Exception exception) {
                field_238631_a_.error("Error while parsing flat world string => {}", (Object)exception.getMessage());
            }
        ...
        flatgenerationsettings.func_242870_a(() -> (Biome)p_243299_0_.getOrThrow(registrykey1));
    ...
    private static String func_243303_b(Registry<Biome> p_243303_0_, FlatGenerationSettings p_243303_1_) {
        ...
        stringbuilder.append(";");
        stringbuilder.append(p_243303_0_.getKey(p_243303_1_.getBiome()));
    ...
    protected void init() {
        ...
        MutableRegistry<Biome> registry = this.parentScreen.createWorldGui.field_238934_c_.func_239055_b_().getRegistry(Registry.BIOME_KEY);
        this.export.setText(FlatPresetsScreen.func_243303_b(registry, this.parentScreen.func_238603_g_()));
        ...
        this.addButton(new Button(this.width / 2 + 5, this.height - 28, 150, 20, DialogTexts.GUI_CANCEL, p_243294_1_ -> this.minecraft.displayGuiScreen(this.parentScreen)));
    ...
    private static void func_238640_a_(ITextComponent p_238640_0_, IItemProvider p_238640_1_, RegistryKey<Biome> p_238640_2_, List<Structure<?>> p_238640_3_, boolean p_238640_4_, boolean p_238640_5_, boolean p_238640_6_, FlatLayerInfo ... p_238640_7_) {
        FLAT_WORLD_PRESETS.add(new LayerItem(p_238640_1_.asItem(), p_238640_0_, p_243301_6_ -> {
            HashMap<Structure<?>, StructureSeparationSettings> map = Maps.newHashMap();
            ...
            FlatGenerationSettings flatgenerationsettings = new FlatGenerationSettings(dimensionstructuressettings, (Registry<Biome>)p_243301_6_);
            if (p_238640_5_) {
            ...
            flatgenerationsettings.func_242870_a(() -> (Biome)p_243301_6_.getOrThrow(p_238640_2_));
    ...
    extends ExtendedList<PresetEntry> {
        ...
        public void setSelected(@Nullable PresetEntry entry) {
            ...
            if (entry != null) {
                NarratorChatListener.INSTANCE.say(new TranslationTextComponent("narrator.select", FLAT_WORLD_PRESETS.get(this.getEventListeners().indexOf(entry)).func_238644_a_()).getString());
            }
        ...
        extends ExtendedList.AbstractListEntry<PresetEntry> {
            ...
            public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
                LayerItem flatpresetsscreen$layeritem = FLAT_WORLD_PRESETS.get(p_230432_2_);
                this.func_238647_a_(p_230432_1_, p_230432_4_, p_230432_3_, flatpresetsscreen$layeritem.icon);
                FlatPresetsScreen.this.font.func_243248_b(p_230432_1_, flatpresetsscreen$layeritem.name, p_230432_4_ + 18 + 5, p_230432_3_ + 6, 0xFFFFFF);
            }
            ...
            private void func_214399_a() {
                ...
                LayerItem flatpresetsscreen$layeritem = FLAT_WORLD_PRESETS.get(SlotList.this.getEventListeners().indexOf(this));
                MutableRegistry<Biome> registry = FlatPresetsScreen.this.parentScreen.createWorldGui.field_238934_c_.func_239055_b_().getRegistry(Registry.BIOME_KEY);
