...
extends Screen {
    ...
    protected void init() {
        ...
        this.field_238820_p_.setResponder(p_238833_1_ -> this.func_214253_a());
        ...
        this.field_238818_b_.setResponder(p_238830_1_ -> this.func_214253_a());
        ...
        this.field_238819_c_.setResponder(p_214254_1_ -> this.func_214253_a());
        ...
        this.field_238823_t_.active = flag = JigsawBlock.getConnectingDirection(this.field_214259_a.getBlockState()).getAxis().isVertical();
        this.field_238823_t_.visible = flag;
        this.addButton(new AbstractSlider(this.width / 2 - 154, 180, 100, 20, StringTextComponent.EMPTY, 0.0){
            {
                this.func_230979_b_();
            }
            ...
            protected void func_230972_a_() {
                JigsawScreen.this.field_238821_r_ = MathHelper.floor(MathHelper.clampedLerp(0.0, 7.0, this.sliderValue));
            }
        });
        ...
        this.doneButton = this.addButton(new Button(this.width / 2 - 4 - 150, 210, 150, 20, DialogTexts.GUI_DONE, p_238828_1_ -> this.func_214256_b()));
        this.addButton(new Button(this.width / 2 + 4, 210, 150, 20, DialogTexts.GUI_CANCEL, p_238825_1_ -> this.func_214257_c()));
