...
extends Screen {
    ...
    @Override
    protected void init() {
        this.addButton(new Button(this.width / 2 - 155, this.height / 4 + 120 + 12, 150, 20, new TranslationTextComponent("gui.toTitle"), p_213048_1_ -> this.minecraft.displayGuiScreen(new MainMenuScreen())));
        this.addButton(new Button(this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, 150, 20, new TranslationTextComponent("menu.quit"), p_213047_1_ -> this.minecraft.shutdown()));
    }
