...
extends SettingsScreen {
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 168, 200, 20, DialogTexts.GUI_DONE, p_213104_1_ -> this.minecraft.displayGuiScreen(this.parentScreen)));
    }
