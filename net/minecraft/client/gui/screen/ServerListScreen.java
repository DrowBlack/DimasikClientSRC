...
extends Screen {
    ...
    protected void init() {
        ...
        this.field_195170_a = this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 96 + 12, 200, 20, new TranslationTextComponent("selectServer.select"), p_213026_1_ -> this.func_195167_h()));
        this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 20, DialogTexts.GUI_CANCEL, p_213025_1_ -> this.field_213027_d.accept(false)));
        ...
        this.ipEdit.setResponder(p_213024_1_ -> this.func_195168_i());
