...
extends GuiScreenOF {
    ...
    private void checkFabulousWarning() {
        if (this.field_241604_x_.func_241700_g_()) {
            String s2;
            String s1;
            ArrayList<ITextProperties> list = Lists.newArrayList(field_241599_p_, field_241603_t_);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        VideoSettingsScreen.drawString(matrixStack, this.minecraft.fontRenderer, s, 2, this.height - 10, 0x808080);
        String s2 = "Minecraft 1.16.5";
        int i = this.minecraft.fontRenderer.getStringWidth(s2);
        VideoSettingsScreen.drawString(matrixStack, this.minecraft.fontRenderer, s2, this.width - i - 2, this.height - 10, 0x808080);
