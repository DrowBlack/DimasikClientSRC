...
extends SettingsScreen {
    ...
    protected void func_244718_c() {
        this.addButton(new Button(this.width / 2 - 100, this.height - 27, 200, 20, DialogTexts.GUI_DONE, p_243316_1_ -> this.minecraft.displayGuiScreen(this.parentScreen)));
    }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        List<IReorderingProcessor> list = WithNarratorSettingsScreen.func_243293_a(this.field_243315_q, mouseX, mouseY);
        if (list != null) {
