...
extends AbstractRepairScreen<RepairContainer> {
    ...
    private void renameItem(String name) {
        if (!name.isEmpty()) {
            ...
            ((RepairContainer)this.container).updateItemName(s);
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
        ...
        int i = ((RepairContainer)this.container).getMaximumCost();
        if (i > 0) {
            ...
            if (itextcomponent != null) {
                ...
                int l = 69;
                AnvilScreen.fill(matrixStack, k - 2, 67, this.xSize - 8, 79, 0x4F000000);
                this.font.func_243246_a(matrixStack, itextcomponent, k, 69.0f, j);
            }
        }
    }
