...
extends AbstractOptionList<FilterListEntry> {
    ...
    public void func_244759_a(Collection<UUID> p_244759_1_, double p_244759_2_) {
        ...
        this.func_244661_g();
        this.field_244652_p.sort((p_244655_0_, p_244655_1_) -> p_244655_0_.func_244636_b().compareToIgnoreCase(p_244655_1_.func_244636_b()));
    ...
    private void func_244661_g() {
        if (this.field_244653_q != null) {
            this.field_244652_p.removeIf(p_244654_1_ -> !p_244654_1_.func_244636_b().toLowerCase(Locale.ROOT).contains(this.field_244653_q));
            this.replaceEntries(this.field_244652_p);
        }
    }
    ...
    public void func_244659_a(UUID p_244659_1_) {
        for (FilterListEntry filterlistentry : this.field_244652_p) {
            if (!filterlistentry.func_244640_c().equals(p_244659_1_)) continue;
