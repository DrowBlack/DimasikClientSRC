...
implements IRenderable {
    ...
    protected E getEntry(int index) {
        return (E)((AbstractListEntry)this.getEventListeners().get(index));
    }
    ...
    protected final E getEntryAtPosition(double p_230933_1_, double p_230933_3_) {
        ...
        return (E)(p_230933_1_ < (double)this.getScrollbarPosition() && p_230933_1_ >= (double)k && p_230933_1_ <= (double)l && j1 >= 0 && i1 >= 0 && j1 < this.getItemCount() ? (AbstractListEntry)this.getEventListeners().get(j1) : null);
    }
    ...
    public void setScrollAmount(double p_230932_1_) {
        this.scrollAmount = MathHelper.clamp(p_230932_1_, 0.0, (double)this.getMaxScroll());
    }
    ...
    protected void func_241572_a_(Ordering p_241572_1_, Predicate<E> p_241572_2_) {
        int i;
        int n = i = p_241572_1_ == Ordering.UP ? -1 : 1;
        if (!this.getEventListeners().isEmpty()) {
            ...
            while (j != (k = MathHelper.clamp(j + i, 0, this.getItemCount() - 1))) {
                AbstractListEntry e = (AbstractListEntry)this.getEventListeners().get(k);
    ...
    protected void renderList(MatrixStack p_238478_1_, int p_238478_2_, int p_238478_3_, int p_238478_4_, int p_238478_5_, float p_238478_6_) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            ((AbstractListEntry)e).render(p_238478_1_, j, k, j2, k1, j1, p_238478_4_, p_238478_5_, this.isMouseOver(p_238478_4_, p_238478_5_) && Objects.equals(this.getEntryAtPosition(p_238478_4_, p_238478_5_), e), p_238478_6_);
        }
    }
    ...
    protected E remove(int p_230964_1_) {
        AbstractListEntry e = (AbstractListEntry)this.children.get(p_230964_1_);
        return (E)(this.removeEntry((AbstractListEntry)this.children.get(p_230964_1_)) ? e : null);
    }
