...
extends AbstractOptionList<Entry> {
    ...
    public KeyBindingList(ControlsScreen controls, Minecraft mcIn) {
        ...
        for (KeyBinding keybinding : akeybinding) {
            ...
            if (!s1.equals(s)) {
                s = s1;
                this.addEntry(new CategoryEntry(new TranslationTextComponent(s1)));
            }
            if ((i = mcIn.fontRenderer.getStringPropertyWidth(itextcomponent = new TranslationTextComponent(keybinding.getKeyDescription()))) > this.maxListLabelWidth) {
    ...
    extends Entry {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            KeyBindingList.this.minecraft.fontRenderer.func_243248_b(p_230432_1_, this.labelText, KeyBindingList.this.minecraft.currentScreen.width / 2 - this.labelWidth / 2, p_230432_3_ + p_230432_6_ - 9 - 1, 0xFFFFFF);
        }
    ...
    extends Entry {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            KeyBindingList.this.minecraft.fontRenderer.func_243248_b(p_230432_1_, this.keyDesc, p_230432_4_ + 90 - KeyBindingList.this.maxListLabelWidth, p_230432_3_ + p_230432_6_ / 2 - 4, 0xFFFFFF);
