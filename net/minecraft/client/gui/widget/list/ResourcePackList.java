...
extends ExtendedList<ResourcePackEntry> {
    ...
    protected void renderHeader(MatrixStack p_230448_1_, int p_230448_2_, int p_230448_3_, Tessellator p_230448_4_) {
        IFormattableTextComponent itextcomponent = new StringTextComponent("").append(this.field_214370_e).mergeStyle(TextFormatting.UNDERLINE, TextFormatting.BOLD);
        this.minecraft.fontRenderer.func_243248_b(p_230448_1_, itextcomponent, p_230448_2_ + this.width / 2 - this.minecraft.fontRenderer.getStringPropertyWidth(itextcomponent) / 2, Math.min(this.y0 + 3, p_230448_3_), 0xFFFFFF);
    }
    ...
    extends ExtendedList.AbstractListEntry<ResourcePackEntry> {
        ...
        public ResourcePackEntry(Minecraft p_i241201_1_, ResourcePackList p_i241201_2_, Screen p_i241201_3_, PackLoadingManager.IPack p_i241201_4_) {
            ...
            this.field_243407_e = ResourcePackEntry.func_244424_a(p_i241201_1_, p_i241201_4_.func_230462_b_());
            this.field_243408_f = ResourcePackEntry.func_244425_b(p_i241201_1_, p_i241201_4_.func_243390_f());
            this.field_244422_g = ResourcePackEntry.func_244424_a(p_i241201_1_, field_214368_c);
            this.field_244423_h = ResourcePackEntry.func_244425_b(p_i241201_1_, p_i241201_4_.func_230460_a_().getDescription());
        }
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            this.field_214428_a.fontRenderer.func_238407_a_(p_230432_1_, ireorderingprocessor, p_230432_4_ + 32 + 2, p_230432_3_ + 1, 0xFFFFFF);
            ibidirenderer.func_241865_b(p_230432_1_, p_230432_4_ + 32 + 2, p_230432_3_ + 12, 10, 0x808080);
        }
        ...
        public boolean mouseClicked(double mouseX, double mouseY, int button) {
            ...
            if (this.func_238920_a_() && d0 <= 32.0) {
                if (this.field_214431_d.func_238875_m_()) {
                    PackCompatibility packcompatibility = this.field_214431_d.func_230460_a_();
                    if (packcompatibility.isCompatible()) {
                        ...
                        }, field_214369_d, itextcomponent));
                    }
                    return true;
                }
                if (d0 < 16.0 && this.field_214431_d.func_238876_n_()) {
                    this.field_214431_d.func_230472_i_();
                    return true;
                }
                if (d0 > 16.0 && d1 < 16.0 && this.field_214431_d.func_230469_o_()) {
                    this.field_214431_d.func_230467_j_();
                    return true;
                }
                if (d0 > 16.0 && d1 > 16.0 && this.field_214431_d.func_230470_p_()) {
