...
implements DebugRenderer.IDebugRenderer {
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, double camX, double camY, double camZ) {
        ...
        if (d0 - this.lastUpdate > 1.0E8) {
            this.lastUpdate = d0;
            Entity entity = this.minecraft.gameRenderer.getActiveRenderInfo().getRenderViewEntity();
            this.collisionData = entity.world.func_234867_d_(entity, entity.getBoundingBox().grow(6.0), p_239370_0_ -> true).collect(Collectors.toList());
        }
