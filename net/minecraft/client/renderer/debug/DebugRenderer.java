...
public class DebugRenderer {
    ...
    public static Optional<Entity> getTargetEntity(@Nullable Entity entityIn, int distance) {
        ...
        EntityRayTraceResult entityraytraceresult = ProjectileHelper.rayTraceEntities(entityIn, vector3d, vector3d2 = vector3d.add(vector3d1 = entityIn.getLook(1.0f).scale(distance)), axisalignedbb = entityIn.getBoundingBox().expand(vector3d1).grow(1.0), predicate = p_217727_0_ -> !p_217727_0_.isSpectator() && p_217727_0_.canBeCollidedWith(), i = distance * distance);
    ...
    public static void renderBox(BlockPos p_217735_0_, BlockPos p_217735_1_, float p_217735_2_, float p_217735_3_, float p_217735_4_, float p_217735_5_) {
        ...
        if (activerenderinfo.isValid()) {
            ...
            DebugRenderer.renderBox(axisalignedbb, p_217735_2_, p_217735_3_, p_217735_4_, p_217735_5_);
        }
    }
    ...
    public static void renderBox(BlockPos p_217736_0_, float p_217736_1_, float p_217736_2_, float p_217736_3_, float p_217736_4_, float p_217736_5_) {
        ...
        if (activerenderinfo.isValid()) {
            Vector3d vector3d = activerenderinfo.getProjectedView().inverse();
            AxisAlignedBB axisalignedbb = new AxisAlignedBB(p_217736_0_).offset(vector3d).grow(p_217736_1_);
            DebugRenderer.renderBox(axisalignedbb, p_217736_2_, p_217736_3_, p_217736_4_, p_217736_5_);
        }
    }
    ...
    public static void renderBox(AxisAlignedBB p_217730_0_, float p_217730_1_, float p_217730_2_, float p_217730_3_, float p_217730_4_) {
        DebugRenderer.renderBox(p_217730_0_.minX, p_217730_0_.minY, p_217730_0_.minZ, p_217730_0_.maxX, p_217730_0_.maxY, p_217730_0_.maxZ, p_217730_1_, p_217730_2_, p_217730_3_, p_217730_4_);
    }
    ...
    public static void renderText(String p_217731_0_, int p_217731_1_, int p_217731_2_, int p_217731_3_, int p_217731_4_) {
        DebugRenderer.renderText(p_217731_0_, (double)p_217731_1_ + 0.5, (double)p_217731_2_ + 0.5, (double)p_217731_3_ + 0.5, p_217731_4_);
    }
    ...
    public static void renderText(String p_217732_0_, double p_217732_1_, double p_217732_3_, double p_217732_5_, int p_217732_7_) {
        DebugRenderer.renderText(p_217732_0_, p_217732_1_, p_217732_3_, p_217732_5_, p_217732_7_, 0.02f);
    }
    ...
    public static void renderText(String p_217729_0_, double p_217729_1_, double p_217729_3_, double p_217729_5_, int p_217729_7_, float p_217729_8_) {
        DebugRenderer.renderText(p_217729_0_, p_217729_1_, p_217729_3_, p_217729_5_, p_217729_7_, p_217729_8_, true, 0.0f, false);
    }
    ...
    public static void renderText(String textIn, double p_217734_1_, double p_217734_3_, double p_217734_5_, int colorIn, float p_217734_8_, boolean p_217734_9_, float p_217734_10_, boolean p_217734_11_) {
        ...
        if (activerenderinfo.isValid() && minecraft.getRenderManager().options != null) {
            ...
            fontrenderer.renderString(textIn, f -= p_217734_10_ / p_217734_8_, 0.0f, colorIn, false, TransformationMatrix.identity().getMatrix(), irendertypebuffer$impl, p_217734_11_, 0, 0xF000F0);
