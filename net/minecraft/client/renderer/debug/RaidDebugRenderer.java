...
implements DebugRenderer.IDebugRenderer {
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, double camX, double camY, double camZ) {
        ...
        for (BlockPos blockpos1 : this.field_222909_b) {
            ...
            RaidDebugRenderer.func_222903_a(blockpos1);
        }
    }

    private static void func_222903_a(BlockPos p_222903_0_) {
        DebugRenderer.renderBox(p_222903_0_.add(-0.5, -0.5, -0.5), p_222903_0_.add(1.5, 1.5, 1.5), 1.0f, 0.0f, 0.0f, 0.15f);
        int i = -65536;
        RaidDebugRenderer.func_222905_a("Raid center", p_222903_0_, -65536);
    }
