...
extends MobRenderer<ShulkerEntity, ShulkerModel<ShulkerEntity>> {
    ...
    public static final ResourceLocation[] SHULKER_ENDERGOLEM_TEXTURE = (ResourceLocation[])Atlases.SHULKER_TEXTURES.stream().map(p_229125_0_ -> new ResourceLocation("textures/" + p_229125_0_.getTextureLocation().getPath() + ".png")).toArray(ResourceLocation[]::new);
