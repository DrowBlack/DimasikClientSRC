...
extends LayerRenderer<T, M> {
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (customModel.isToggled()) {
            ...
            String entityName = ((Entity)entitylivingbaseIn).getName().getString();
            boolean self = customModel.getElements().getSelected("Self") && ((Entity)entitylivingbaseIn).getUniqueID().equals(client.getUniqueID());
            boolean friend = customModel.getElements().getSelected("Friends") && Load.getInstance().getHooks().getFriendManagers().is(entityName);
            boolean bl = others = customModel.getElements().getSelected("Others") && !Load.getInstance().getHooks().getFriendManagers().is(entityName) && !((Entity)entitylivingbaseIn).getUniqueID().equals(client.getUniqueID());
    ...
    private void func_241739_a_(MatrixStack p_241739_1_, IRenderTypeBuffer p_241739_2_, T p_241739_3_, EquipmentSlotType p_241739_4_, int p_241739_5_, A p_241739_6_) {
        ArmorItem armoritem;
        ItemStack itemstack = ((LivingEntity)p_241739_3_).getItemStackFromSlot(p_241739_4_);
        if (itemstack.getItem() instanceof ArmorItem && (armoritem = (ArmorItem)itemstack.getItem()).getEquipmentSlot() == p_241739_4_) {
            if (Reflector.ForgeHooksClient.exists()) {
                p_241739_6_ = this.getArmorModelHook(p_241739_3_, itemstack, p_241739_4_, p_241739_6_);
            }
            ((BipedModel)this.getEntityModel()).setModelAttributes(p_241739_6_);
            ...
            if (armoritem instanceof IDyeableArmorItem) {
                int i = ((IDyeableArmorItem)((Object)armoritem)).getColor(itemstack);
                float f = (float)(i >> 16 & 0xFF) / 255.0f;
                float f1 = (float)(i >> 8 & 0xFF) / 255.0f;
                float f2 = (float)(i & 0xFF) / 255.0f;
                this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag, p_241739_6_, f, f1, f2, this.getArmorResource((Entity)p_241739_3_, itemstack, p_241739_4_, null));
                this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag, p_241739_6_, 1.0f, 1.0f, 1.0f, this.getArmorResource((Entity)p_241739_3_, itemstack, p_241739_4_, "overlay"));
            } else {
                this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag, p_241739_6_, 1.0f, 1.0f, 1.0f, this.getArmorResource((Entity)p_241739_3_, itemstack, p_241739_4_, null));
            }
        }
    }

    protected void setModelSlotVisible(A modelIn, EquipmentSlotType slotIn) {
        ((BipedModel)modelIn).setVisible(false);
        switch (slotIn) {
            case HEAD: {
                ((BipedModel)modelIn).bipedHead.showModel = true;
                ((BipedModel)modelIn).bipedHeadwear.showModel = true;
                break;
            }
            case CHEST: {
                ((BipedModel)modelIn).bipedBody.showModel = true;
                ((BipedModel)modelIn).bipedRightArm.showModel = true;
                ((BipedModel)modelIn).bipedLeftArm.showModel = true;
                break;
            }
            case LEGS: {
                ((BipedModel)modelIn).bipedBody.showModel = true;
                ((BipedModel)modelIn).bipedRightLeg.showModel = true;
                ((BipedModel)modelIn).bipedLeftLeg.showModel = true;
                break;
            }
            case FEET: {
                ((BipedModel)modelIn).bipedRightLeg.showModel = true;
    ...
    private void renderModel(MatrixStack p_renderModel_1_, IRenderTypeBuffer p_renderModel_2_, int p_renderModel_3_, boolean p_renderModel_4_, A p_renderModel_5_, float p_renderModel_6_, float p_renderModel_7_, float p_renderModel_8_, ResourceLocation p_renderModel_9_) {
        ...
        ((AgeableModel)p_renderModel_5_).render(p_renderModel_1_, ivertexbuilder, p_renderModel_3_, OverlayTexture.NO_OVERLAY, p_renderModel_6_, p_renderModel_7_, p_renderModel_8_, 1.0f);
    }
    ...
    private ResourceLocation func_241737_a_(ArmorItem p_241737_1_, boolean p_241737_2_, @Nullable String p_241737_3_) {
        String s = "textures/models/armor/" + p_241737_1_.getArmorMaterial().getName() + "_layer_" + (p_241737_2_ ? 2 : 1) + (String)(p_241737_3_ == null ? "" : "_" + p_241737_3_) + ".png";
    ...
    protected A getArmorModelHook(T p_getArmorModelHook_1_, ItemStack p_getArmorModelHook_2_, EquipmentSlotType p_getArmorModelHook_3_, A p_getArmorModelHook_4_) {
        return (A)((BipedModel)(Reflector.ForgeHooksClient_getArmorModel.exists() ? Reflector.ForgeHooksClient_getArmorModel.call(new Object[]{p_getArmorModelHook_1_, p_getArmorModelHook_2_, p_getArmorModelHook_3_, p_getArmorModelHook_4_}) : p_getArmorModelHook_4_));
    }
    ...
    public ResourceLocation getArmorResource(Entity p_getArmorResource_1_, ItemStack p_getArmorResource_2_, EquipmentSlotType p_getArmorResource_3_, String p_getArmorResource_4_) {
        ...
        if ((resourcelocation = ARMOR_TEXTURE_RES_MAP.get(s2)) == null) {
