...
extends TileEntityRenderer<BedTileEntity> {
    ...
    public void render(BedTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        if (world != null) {
            ...
            TileEntityMerger.ICallbackWrapper<BedTileEntity> icallbackwrapper = TileEntityMerger.func_226924_a_(TileEntityType.BED, BedBlock::getMergeType, BedBlock::getFootDirection, ChestBlock.FACING, blockstate, world, tileEntityIn.getPos(), (p_228846_0_, p_228846_1_) -> false);
            int i = ((Int2IntFunction)icallbackwrapper.apply(new DualBrightnessCallback())).get(combinedLightIn);
    ...
    private void func_228847_a_(MatrixStack p_228847_1_, IRenderTypeBuffer p_228847_2_, boolean p_228847_3_, Direction p_228847_4_, RenderMaterial p_228847_5_, int p_228847_6_, int p_228847_7_, boolean p_228847_8_) {
        ...
        p_228847_1_.push();
        p_228847_1_.translate(0.0, 0.5625, p_228847_8_ ? -1.0 : 0.0);
        p_228847_1_.rotate(Vector3f.XP.rotationDegrees(90.0f));
        p_228847_1_.translate(0.5, 0.5, 0.5);
