...
implements IPackFinder {
    ...
    public void findPacks(Consumer<ResourcePackInfo> infoConsumer, ResourcePackInfo.IFactory infoFactory) {
        ...
        ResourcePackInfo resourcepackinfo = ResourcePackInfo.createResourcePack("vanilla", true, () -> this.vanillaPack, infoFactory, ResourcePackInfo.Priority.BOTTOM, IPackNameDecorator.BUILTIN);
        ...
        if ((resourcepackinfo1 = this.func_239453_a_(infoFactory)) != null) {
    ...
    public CompletableFuture<?> downloadResourcePack(String url, String hash) {
        ...
        try {
            ...
            if (file1.exists()) {
                ...
                minecraft.runImmediately(() -> minecraft.displayGuiScreen(workingscreen));
                completablefuture = HTTPUtil.downloadResourcePack(file1, url, map, 0x6400000, workingscreen, minecraft.getProxy());
            }
            completablefuture1 = this.currentDownload = ((CompletableFuture)completablefuture.thenCompose(p_217812_3_ -> !this.checkHash(s1, file1) ? Util.completedExceptionallyFuture(new RuntimeException("Hash check failure for file " + String.valueOf(file1) + ", see log")) : this.setServerPack(file1, IPackNameDecorator.SERVER))).whenComplete((p_217815_1_, p_217815_2_) -> {
                if (p_217815_2_ != null) {
                    LOGGER.warn("Pack application failed: {}, deleting file {}", (Object)p_217815_2_.getMessage(), (Object)file1);
                    DownloadingPackFinder.deleteQuiet(file1);
                }
            });
        }
        finally {
    ...
    public CompletableFuture<Void> setServerPack(File fileIn, IPackNameDecorator p_217816_2_) {
        ...
        this.serverPack = new ResourcePackInfo("server", true, () -> new FilePack(fileIn), new TranslationTextComponent("resourcePack.server.name"), packmetadatasection.getDescription(), PackCompatibility.getCompatibility(packmetadatasection.getPackFormat()), ResourcePackInfo.Priority.TOP, true, p_217816_2_);
    ...
    private ResourcePackInfo func_239453_a_(ResourcePackInfo.IFactory p_239453_1_) {
        ...
        if (file1 != null && file1.isFile()) {
            resourcepackinfo = DownloadingPackFinder.func_239454_a_(p_239453_1_, () -> DownloadingPackFinder.func_239460_c_(file1));
        }
        if (resourcepackinfo == null && SharedConstants.developmentMode && (file2 = this.resourceIndex.getFile("../resourcepacks/programmer_art")) != null && file2.isDirectory()) {
            resourcepackinfo = DownloadingPackFinder.func_239454_a_(p_239453_1_, () -> DownloadingPackFinder.func_239459_b_(file2));
        }
