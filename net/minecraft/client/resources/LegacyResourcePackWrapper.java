...
public class LegacyResourcePackWrapper
implements IResourcePack {
    ...
    public static final Map<ResourceLocation, ResourceLocation> NEW_TO_LEGACY_MAP = Util.make(() -> {
        ...
        BiConsumer<String, String> biconsumer = (p_239468_1_, p_239468_2_) -> {
            ResourceLocation resourcelocation = new ResourceLocation((String)p_239468_1_);
            ResourceLocation resourcelocation1 = new ResourceLocation((String)p_239468_2_);
            builder.put(resourcelocation, resourcelocation1);
            builder.put(LegacyResourcePackWrapper.getMetaFileLocation(resourcelocation), LegacyResourcePackWrapper.getMetaFileLocation(resourcelocation1));
        };
