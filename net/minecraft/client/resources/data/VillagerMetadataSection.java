...
public class VillagerMetadataSection {
    ...
    public VillagerMetadataSection(HatType p_i50904_1_) {
    ...
    public static enum HatType {
        ...
        public static HatType func_217821_a(String p_217821_0_) {
            return field_217824_d.getOrDefault(p_217821_0_, NONE);
        }

        static {
            field_217824_d = Arrays.stream(HatType.values()).collect(Collectors.toMap(HatType::func_217823_a, p_217822_0_ -> p_217822_0_));
        }
    }
}
