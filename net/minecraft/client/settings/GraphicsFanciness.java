...
public enum GraphicsFanciness {
    ...
    static {
        field_238159_d_ = (GraphicsFanciness[])Arrays.stream(GraphicsFanciness.values()).sorted(Comparator.comparingInt(GraphicsFanciness::func_238162_a_)).toArray(GraphicsFanciness[]::new);
    }
}
