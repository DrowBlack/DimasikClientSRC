...
public class Framebuffer {
    ...
    public void resize(int p_216491_1_, int p_216491_2_, boolean p_216491_3_) {
        if (!RenderSystem.isOnRenderThread()) {
            RenderSystem.recordRenderCall(() -> this.resizeRaw(p_216491_1_, p_216491_2_, p_216491_3_));
        } else {
    ...
    public void framebufferRenderExt(int width, int height, boolean p_178038_3_) {
        ...
        if (!RenderSystem.isInInitPhase()) {
            RenderSystem.recordRenderCall(() -> this.framebufferRenderExtRaw(width, height, p_178038_3_));
        } else {
