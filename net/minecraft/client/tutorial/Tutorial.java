...
public class Tutorial {
    ...
    public void func_244698_a(TutorialToast p_244698_1_, int p_244698_2_) {
        this.field_244696_c.add(new ToastTimeInfo(p_244698_1_, p_244698_2_));
        this.minecraft.getToastGui().add(p_244698_1_);
    }

    public void func_244697_a(TutorialToast p_244697_1_) {
        this.field_244696_c.removeIf(p_244699_1_ -> p_244699_1_.field_244701_a == p_244697_1_);
        p_244697_1_.hide();
    }

    public void tick() {
        this.field_244696_c.removeIf(p_244700_0_ -> p_244700_0_.func_244704_a());
        if (this.tutorialStep != null) {
