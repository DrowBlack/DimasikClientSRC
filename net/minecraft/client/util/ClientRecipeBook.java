...
extends RecipeBook {
    ...
    public void func_243196_a(Iterable<IRecipe<?>> p_243196_1_) {
        Map<RecipeBookCategories, List<List<IRecipe<?>>>> map = ClientRecipeBook.func_243201_b(p_243196_1_);
        HashMap map1 = Maps.newHashMap();
        ImmutableList.Builder builder = ImmutableList.builder();
        map.forEach((p_243197_2_, p_243197_3_) -> {
            List list = map1.put(p_243197_2_, (List)p_243197_3_.stream().map(RecipeList::new).peek(builder::add).collect(ImmutableList.toImmutableList()));
        });
    ...
    private static Map<RecipeBookCategories, List<List<IRecipe<?>>>> func_243201_b(Iterable<IRecipe<?>> p_243201_0_) {
        HashMap<RecipeBookCategories, List<List<IRecipe<?>>>> map = Maps.newHashMap();
        ...
        for (IRecipe<?> irecipe : p_243201_0_) {
            ...
            ArrayList<IRecipe<?>> list = (ArrayList<IRecipe<?>>)table.get((Object)recipebookcategories, s);
            if (list == null) {
    ...
    public List<RecipeList> getRecipes(RecipeBookCategories p_202891_1_) {
        return this.recipesByCategory.getOrDefault((Object)p_202891_1_, Collections.emptyList());
    }
}
