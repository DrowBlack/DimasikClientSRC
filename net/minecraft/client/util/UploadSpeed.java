...
public enum UploadSpeed {
    ...
    public static UploadSpeed func_237682_a_(long p_237682_0_) {
        ...
        try {
            ...
            return UploadSpeed.valueOf(s + "B");
        }
    ...
    public static double func_237683_a_(long p_237683_0_, UploadSpeed p_237683_2_) {
        return p_237683_2_ == B ? (double)p_237683_0_ : (double)p_237683_0_ / Math.pow(1024.0, p_237683_2_.ordinal());
    }
    ...
    public static String func_237685_b_(long p_237685_0_, UploadSpeed p_237685_2_) {
        return String.format("%." + (p_237685_2_ == GB ? "1" : "0") + "f %s", UploadSpeed.func_237683_a_(p_237685_0_, p_237685_2_), p_237685_2_.name());
    }
}
