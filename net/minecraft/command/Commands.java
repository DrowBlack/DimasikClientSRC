...
public class Commands {
    ...
    public Commands(EnvironmentType envType) {
        ...
        this.dispatcher.findAmbiguities((p_201302_1_, p_201302_2_, p_201302_3_, p_201302_4_) -> LOGGER.warn("Ambiguity between arguments {} and {} with inputs: {}", (Object)this.dispatcher.getPath(p_201302_2_), (Object)this.dispatcher.getPath(p_201302_3_), (Object)p_201302_4_));
        this.dispatcher.setConsumer((p_197058_0_, p_197058_1_, p_197058_2_) -> ((CommandSource)p_197058_0_.getSource()).onCommandComplete(p_197058_0_, p_197058_1_, p_197058_2_));
    }
    ...
    public int handleCommand(CommandSource source, String command) {
        ...
        try {
            int n2 = this.dispatcher.execute(stringreader, source);
            return n2;
        }
            ...
            if (commandsyntaxexception.getInput() != null && commandsyntaxexception.getCursor() >= 0) {
                ...
                IFormattableTextComponent iformattabletextcomponent1 = new StringTextComponent("").mergeStyle(TextFormatting.GRAY).modifyStyle(p_211705_1_ -> p_211705_1_.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, command)));
                if (j > 10) {
                ...
                if (j < commandsyntaxexception.getInput().length()) {
                    IFormattableTextComponent itextcomponent = new StringTextComponent(commandsyntaxexception.getInput().substring(j)).mergeStyle(TextFormatting.RED, TextFormatting.UNDERLINE);
                    iformattabletextcomponent1.append(itextcomponent);
                }
                iformattabletextcomponent1.append(new TranslationTextComponent("command.context.here").mergeStyle(TextFormatting.RED, TextFormatting.ITALIC));
            ...
            source.sendErrorMessage(new TranslationTextComponent("command.failed").modifyStyle(p_211704_1_ -> p_211704_1_.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, iformattabletextcomponent))));
            if (SharedConstants.developmentMode) {
    ...
    public void send(ServerPlayerEntity player) {
        HashMap<CommandNode<CommandSource>, CommandNode<ISuggestionProvider>> map = Maps.newHashMap();
    ...
    public static Predicate<String> predicate(IParser parser) {
        return p_212591_1_ -> {
            try {
                parser.parse(new StringReader((String)p_212591_1_));
                return true;
            }
            catch (CommandSyntaxException commandsyntaxexception) {
                return false;
