...
public class TimerCallbackSerializers<C> {
    ...
    public <T extends ITimerCallback<C>> CompoundNBT func_216339_a(T p_216339_1_) {
        ITimerCallback.Serializer<T, T> serializer = this.func_216338_a(p_216339_1_.getClass());
    ...
    public ITimerCallback<C> func_216341_a(CompoundNBT p_216341_1_) {
        ...
        if (serializer == null) {
            LOGGER.error("Failed to deserialize timer callback: " + String.valueOf(p_216341_1_));
            return null;
        }
        try {
            ...
            LOGGER.error("Failed to deserialize timer callback: " + String.valueOf(p_216341_1_), (Throwable)exception);
            return null;
        }
    }
}
