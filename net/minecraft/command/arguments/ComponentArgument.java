...
implements ArgumentType<ITextComponent> {
    ...
    public static final DynamicCommandExceptionType COMPONENT_INVALID = new DynamicCommandExceptionType(textComponent -> new TranslationTextComponent("argument.component.invalid", textComponent));
    ...
    public ITextComponent parse(StringReader p_parse_1_) throws CommandSyntaxException {
        try {
            IFormattableTextComponent itextcomponent = ITextComponent.Serializer.getComponentFromReader(p_parse_1_);
