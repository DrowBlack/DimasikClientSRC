...
implements ArgumentType<ResourceLocation> {
    ...
    public static final DynamicCommandExceptionType ENTITY_UNKNOWN_TYPE = new DynamicCommandExceptionType(p_211367_0_ -> new TranslationTextComponent("entity.notFound", p_211367_0_));
    ...
    public static ResourceLocation getEntityId(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
        return EntitySummonArgument.checkIfEntityExists(context.getArgument(name, ResourceLocation.class));
    }

    private static ResourceLocation checkIfEntityExists(ResourceLocation id) throws CommandSyntaxException {
        Registry.ENTITY_TYPE.getOptional(id).filter(EntityType::isSummonable).orElseThrow(() -> ENTITY_UNKNOWN_TYPE.create(id));
        return id;
    }

    @Override
    public ResourceLocation parse(StringReader p_parse_1_) throws CommandSyntaxException {
        return EntitySummonArgument.checkIfEntityExists(ResourceLocation.read(p_parse_1_));
    }
