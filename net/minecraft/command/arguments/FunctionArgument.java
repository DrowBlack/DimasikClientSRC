...
implements ArgumentType<IResult> {
    ...
    private static final DynamicCommandExceptionType FUNCTION_UNKNOWN_TAG = new DynamicCommandExceptionType(p_208691_0_ -> new TranslationTextComponent("arguments.function.tag.unknown", p_208691_0_));
    private static final DynamicCommandExceptionType FUNCTION_UNKNOWN = new DynamicCommandExceptionType(p_208694_0_ -> new TranslationTextComponent("arguments.function.unknown", p_208694_0_));
    ...
    private static FunctionObject func_218108_c(CommandContext<CommandSource> p_218108_0_, ResourceLocation p_218108_1_) throws CommandSyntaxException {
        return p_218108_0_.getSource().getServer().getFunctionManager().get(p_218108_1_).orElseThrow(() -> FUNCTION_UNKNOWN.create(p_218108_1_.toString()));
    }
    ...
    public static Pair<ResourceLocation, Either<FunctionObject, ITag<FunctionObject>>> func_218110_b(CommandContext<CommandSource> p_218110_0_, String p_218110_1_) throws CommandSyntaxException {
        return p_218110_0_.getArgument(p_218110_1_, IResult.class).func_218102_b(p_218110_0_);
    }
