...
implements ArgumentType<ScoreCriteria> {
    ...
    public static final DynamicCommandExceptionType OBJECTIVE_INVALID_CRITERIA = new DynamicCommandExceptionType(p_208672_0_ -> new TranslationTextComponent("argument.criteria.invalid", p_208672_0_));
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> p_listSuggestions_1_, SuggestionsBuilder p_listSuggestions_2_) {
        ArrayList<String> list = Lists.newArrayList(ScoreCriteria.INSTANCES.keySet());
