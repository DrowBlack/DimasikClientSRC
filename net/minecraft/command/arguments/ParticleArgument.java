...
implements ArgumentType<IParticleData> {
    ...
    public static final DynamicCommandExceptionType PARTICLE_NOT_FOUND = new DynamicCommandExceptionType(particle -> new TranslationTextComponent("particle.notFound", particle));
    ...
    public IParticleData parse(StringReader p_parse_1_) throws CommandSyntaxException {
        return ParticleArgument.parseParticle(p_parse_1_);
    }
    ...
    public static IParticleData parseParticle(StringReader reader) throws CommandSyntaxException {
        ...
        ParticleType<?> particletype = Registry.PARTICLE_TYPE.getOptional(resourcelocation).orElseThrow(() -> PARTICLE_NOT_FOUND.create(resourcelocation));
        return ParticleArgument.deserializeParticle(reader, particletype);
    }
