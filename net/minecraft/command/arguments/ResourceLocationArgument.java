...
implements ArgumentType<ResourceLocation> {
    ...
    private static final DynamicCommandExceptionType ADVANCEMENT_NOT_FOUND = new DynamicCommandExceptionType(p_208676_0_ -> new TranslationTextComponent("advancement.advancementNotFound", p_208676_0_));
    private static final DynamicCommandExceptionType RECIPE_NOT_FOUND = new DynamicCommandExceptionType(p_208677_0_ -> new TranslationTextComponent("recipe.notFound", p_208677_0_));
    private static final DynamicCommandExceptionType field_228258_d_ = new DynamicCommandExceptionType(p_208674_0_ -> new TranslationTextComponent("predicate.unknown", p_208674_0_));
    private static final DynamicCommandExceptionType field_239090_e_ = new DynamicCommandExceptionType(p_239091_0_ -> new TranslationTextComponent("attribute.unknown", p_239091_0_));
    ...
    public static IRecipe<?> getRecipe(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
        ...
        ResourceLocation resourcelocation = context.getArgument(name, ResourceLocation.class);
        return recipemanager.getRecipe(resourcelocation).orElseThrow(() -> RECIPE_NOT_FOUND.create(resourcelocation));
    }
    ...
    public static Attribute func_239094_d_(CommandContext<CommandSource> p_239094_0_, String p_239094_1_) throws CommandSyntaxException {
        ...
        return Registry.ATTRIBUTE.getOptional(resourcelocation).orElseThrow(() -> field_239090_e_.create(resourcelocation));
    }
