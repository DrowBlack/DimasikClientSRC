...
implements ArgumentType<Integer> {
    ...
    private static final DynamicCommandExceptionType SLOT_UNKNOWN = new DynamicCommandExceptionType(p_208679_0_ -> new TranslationTextComponent("slot.unknown", p_208679_0_));
