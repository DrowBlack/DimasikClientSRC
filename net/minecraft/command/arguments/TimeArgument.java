...
implements ArgumentType<Integer> {
    ...
    private static final DynamicCommandExceptionType field_218095_c = new DynamicCommandExceptionType(p_218092_0_ -> new TranslationTextComponent("argument.time.invalid_tick_count", p_218092_0_));
    ...
    public Integer parse(StringReader p_parse_1_) throws CommandSyntaxException {
        ...
        int i = field_218096_d.getOrDefault((Object)s, 0);
        if (i == 0) {
