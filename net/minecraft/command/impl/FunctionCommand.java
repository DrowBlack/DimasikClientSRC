...
public class FunctionCommand {
    public static final SuggestionProvider<CommandSource> FUNCTION_SUGGESTER = (p_198477_0_, p_198477_1_) -> {
        FunctionManager functionmanager = ((CommandSource)p_198477_0_.getSource()).getServer().getFunctionManager();
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("function").requires(p_198480_0_ -> p_198480_0_.hasPermissionLevel(2))).then(Commands.argument("name", FunctionArgument.function()).suggests(FUNCTION_SUGGESTER).executes(p_198479_0_ -> FunctionCommand.executeFunctions((CommandSource)p_198479_0_.getSource(), FunctionArgument.getFunctions(p_198479_0_, "name")))));
    }
