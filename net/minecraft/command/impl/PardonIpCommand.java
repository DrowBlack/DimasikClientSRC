...
public class PardonIpCommand {
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("pardon-ip").requires(p_198556_0_ -> p_198556_0_.hasPermissionLevel(3))).then(Commands.argument("target", StringArgumentType.word()).suggests((p_198554_0_, p_198554_1_) -> ISuggestionProvider.suggest(((CommandSource)p_198554_0_.getSource()).getServer().getPlayerList().getBannedIPs().getKeys(), p_198554_1_)).executes(p_198555_0_ -> PardonIpCommand.unbanIp((CommandSource)p_198555_0_.getSource(), StringArgumentType.getString(p_198555_0_, "target")))));
    }
