...
public class ReplaceItemCommand {
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("replaceitem").requires(p_198607_0_ -> p_198607_0_.hasPermissionLevel(2))).then(Commands.literal("block").then((ArgumentBuilder<CommandSource, ?>)Commands.argument("pos", BlockPosArgument.blockPos()).then((ArgumentBuilder<CommandSource, ?>)Commands.argument("slot", SlotArgument.slot()).then((ArgumentBuilder<CommandSource, ?>)((RequiredArgumentBuilder)Commands.argument("item", ItemArgument.item()).executes(p_198601_0_ -> ReplaceItemCommand.replaceItemBlock((CommandSource)p_198601_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198601_0_, "pos"), SlotArgument.getSlot(p_198601_0_, "slot"), ItemArgument.getItem(p_198601_0_, "item").createStack(1, false)))).then(Commands.argument("count", IntegerArgumentType.integer(1, 64)).executes(p_198605_0_ -> ReplaceItemCommand.replaceItemBlock((CommandSource)p_198605_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198605_0_, "pos"), SlotArgument.getSlot(p_198605_0_, "slot"), ItemArgument.getItem(p_198605_0_, "item").createStack(IntegerArgumentType.getInteger(p_198605_0_, "count"), true))))))))).then(Commands.literal("entity").then((ArgumentBuilder<CommandSource, ?>)Commands.argument("targets", EntityArgument.entities()).then((ArgumentBuilder<CommandSource, ?>)Commands.argument("slot", SlotArgument.slot()).then((ArgumentBuilder<CommandSource, ?>)((RequiredArgumentBuilder)Commands.argument("item", ItemArgument.item()).executes(p_198600_0_ -> ReplaceItemCommand.replaceItemEntities((CommandSource)p_198600_0_.getSource(), EntityArgument.getEntities(p_198600_0_, "targets"), SlotArgument.getSlot(p_198600_0_, "slot"), ItemArgument.getItem(p_198600_0_, "item").createStack(1, false)))).then(Commands.argument("count", IntegerArgumentType.integer(1, 64)).executes(p_198606_0_ -> ReplaceItemCommand.replaceItemEntities((CommandSource)p_198606_0_.getSource(), EntityArgument.getEntities(p_198606_0_, "targets"), SlotArgument.getSlot(p_198606_0_, "slot"), ItemArgument.getItem(p_198606_0_, "item").createStack(IntegerArgumentType.getInteger(p_198606_0_, "count"), true)))))))));
    }
