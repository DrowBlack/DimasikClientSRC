...
public class SaveAllCommand {
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("save-all").requires(p_198615_0_ -> p_198615_0_.hasPermissionLevel(4))).executes(p_198610_0_ -> SaveAllCommand.saveAll((CommandSource)p_198610_0_.getSource(), false))).then(Commands.literal("flush").executes(p_198613_0_ -> SaveAllCommand.saveAll((CommandSource)p_198613_0_.getSource(), true))));
    }
