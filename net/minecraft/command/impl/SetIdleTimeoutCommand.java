...
public class SetIdleTimeoutCommand {
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("setidletimeout").requires(p_198692_0_ -> p_198692_0_.hasPermissionLevel(3))).then(Commands.argument("minutes", IntegerArgumentType.integer(0)).executes(p_198691_0_ -> SetIdleTimeoutCommand.setTimeout((CommandSource)p_198691_0_.getSource(), IntegerArgumentType.getInteger(p_198691_0_, "minutes")))));
    }
