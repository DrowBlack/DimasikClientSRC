...
implements IDataAccessor {
    private static final SuggestionProvider<CommandSource> field_229834_b_ = (p_229838_0_, p_229838_1_) -> ISuggestionProvider.func_212476_a(StorageAccessor.func_229840_b_(p_229838_0_).getSavedDataKeys(), p_229838_1_);
    public static final Function<String, DataCommand.IDataProvider> field_229833_a_ = p_229839_0_ -> new DataCommand.IDataProvider((String)p_229839_0_){
        final /* synthetic */ String val$p_229839_0_;
        {
        ...
        public IDataAccessor createAccessor(CommandContext<CommandSource> context) {
            return new StorageAccessor(StorageAccessor.func_229840_b_(context), ResourceLocationArgument.getResourceLocation(context, this.val$p_229839_0_));
        }
        ...
        public ArgumentBuilder<CommandSource, ?> createArgument(ArgumentBuilder<CommandSource, ?> builder, Function<ArgumentBuilder<CommandSource, ?>, ArgumentBuilder<CommandSource, ?>> action) {
            return builder.then((ArgumentBuilder<CommandSource, ?>)Commands.literal("storage").then(action.apply(Commands.argument(this.val$p_229839_0_, ResourceLocationArgument.resourceLocation()).suggests(field_229834_b_))));
        }
    };
