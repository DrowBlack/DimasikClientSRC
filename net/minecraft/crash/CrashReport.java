...
public class CrashReport {
    ...
    private void populateEnvironment() {
        this.systemDetailsCategory.addDetail("Minecraft Version", () -> SharedConstants.getVersion().getName());
        this.systemDetailsCategory.addDetail("Minecraft Version ID", () -> SharedConstants.getVersion().getId());
