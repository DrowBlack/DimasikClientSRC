...
public class BlockModelProvider {
    ...
    private static FinishedVariantBlockState func_239968_d_(Block p_239968_0_, ResourceLocation p_239968_1_) {
        return FinishedVariantBlockState.func_240121_a_(p_239968_0_, BlockModelProvider.func_239915_a_(p_239968_1_));
    }
    ...
    private void func_239953_c_(Block p_239953_1_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239979_e_(p_239953_1_, resourcelocation, resourcelocation1));
    }
    ...
    private void func_239965_d_(Block p_239965_1_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239968_d_(p_239965_1_, resourcelocation));
    }
    ...
    private static IFinishedBlockState func_239943_b_(Block p_239943_0_, ResourceLocation p_239943_1_, ResourceLocation p_239943_2_, ResourceLocation p_239943_3_, ResourceLocation p_239943_4_) {
        return FinishedVariantBlockState.func_240119_a_(p_239943_0_).func_240125_a_(BlockModelProvider.func_239903_a_(BlockModelProvider.func_239903_a_(BlockStateVariantBuilder.func_240136_a_(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.DOUBLE_BLOCK_HALF, BlockStateProperties.DOOR_HINGE, BlockStateProperties.OPEN), DoubleBlockHalf.LOWER, p_239943_1_, p_239943_2_), DoubleBlockHalf.UPPER, p_239943_3_, p_239943_4_));
    }
    ...
    private static IFinishedBlockState func_239986_f_(Block p_239986_0_, ResourceLocation p_239986_1_) {
        return FinishedVariantBlockState.func_240120_a_(p_239986_0_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, p_239986_1_)).func_240125_a_(BlockModelProvider.func_239983_f_());
    }

    private void func_243685_g(Block p_243685_1_, ResourceLocation p_243685_2_) {
        this.field_239834_a_.accept(BlockModelProvider.func_239986_f_(p_243685_1_, p_243685_2_));
    }
    ...
    private void func_239882_a_(Block p_239882_1_, TexturedModel.ISupplier p_239882_2_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239986_f_(p_239882_1_, resourcelocation));
    }
    ...
    private void func_239939_b_(Block p_239939_1_, TexturedModel.ISupplier p_239939_2_) {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_239939_1_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, resourcelocation)).func_240125_a_(BlockModelProvider.func_239933_b_()));
    }
    ...
    private void func_239883_a_(Block p_239883_1_, TexturedModel.ISupplier p_239883_2_, TexturedModel.ISupplier p_239883_3_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_240000_h_(p_239883_1_, resourcelocation, resourcelocation1));
    }
    ...
    private static IFinishedBlockState func_240006_i_(Block p_240006_0_, ResourceLocation p_240006_1_, ResourceLocation p_240006_2_) {
        return FinishedVariantBlockState.func_240119_a_(p_240006_0_).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.POWERED, p_240006_2_, p_240006_1_));
    }
    ...
    private void func_239956_c_(Block p_239956_1_, TexturedModel.ISupplier p_239956_2_) {
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239956_1_, p_239956_2_.func_240466_a_(p_239956_1_, this.field_239835_b_)));
    }
    ...
    private void func_239880_a_(Block p_239880_1_, ModelTextures p_239880_2_, ModelsUtil p_239880_3_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239880_1_, resourcelocation));
    }

    private BlockTextureCombiner func_239884_a_(Block p_239884_1_, TexturedModel p_239884_2_) {
        return new BlockTextureCombiner(p_239884_2_.func_240464_b_()).func_240058_a_(p_239884_1_, p_239884_2_.func_240457_a_());
    }

    private BlockTextureCombiner func_239967_d_(Block p_239967_1_, TexturedModel.ISupplier p_239967_2_) {
        TexturedModel texturedmodel = p_239967_2_.get(p_239967_1_);
        return new BlockTextureCombiner(texturedmodel.func_240464_b_()).func_240058_a_(p_239967_1_, texturedmodel.func_240457_a_());
    }

    private BlockTextureCombiner func_239984_f_(Block p_239984_1_) {
        return this.func_239967_d_(p_239984_1_, TexturedModel.field_240434_a_);
    }

    private BlockTextureCombiner func_239905_a_(ModelTextures p_239905_1_) {
        return new BlockTextureCombiner(p_239905_1_);
    }
    ...
    private void func_239991_g_(Block p_239991_1_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239943_b_(p_239991_1_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3));
    }
    ...
    private void func_239998_h_(Block p_239998_1_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239988_f_(p_239998_1_, resourcelocation, resourcelocation1, resourcelocation2));
    ...
    private void func_240004_i_(Block p_240004_1_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239995_g_(p_240004_1_, resourcelocation, resourcelocation1, resourcelocation2));
        this.func_239957_c_(p_240004_1_, resourcelocation1);
    }

    private LogsVariantHelper func_240009_j_(Block p_240009_1_) {
        return new LogsVariantHelper(ModelTextures.func_240378_l_(p_240009_1_));
    }
    ...
    private void func_239872_a_(Block p_239872_1_, Block p_239872_2_) {
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239872_1_, ModelsResourceUtil.func_240221_a_(p_239872_2_)));
    }

    private void func_239877_a_(Block p_239877_1_, TintMode p_239877_2_) {
        this.func_239934_b_(p_239877_1_);
        this.func_239937_b_(p_239877_1_, p_239877_2_);
    }

    private void func_239878_a_(Block p_239878_1_, TintMode p_239878_2_, ModelTextures p_239878_3_) {
        this.func_239934_b_(p_239878_1_);
        this.func_239938_b_(p_239878_1_, p_239878_2_, p_239878_3_);
    }

    private void func_239937_b_(Block p_239937_1_, TintMode p_239937_2_) {
    ...
    private void func_239938_b_(Block p_239938_1_, TintMode p_239938_2_, ModelTextures p_239938_3_) {
        ResourceLocation resourcelocation = p_239938_2_.func_240066_a_().func_240228_a_(p_239938_1_, p_239938_3_, this.field_239835_b_);
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239938_1_, resourcelocation));
    }

    private void func_239874_a_(Block p_239874_1_, Block p_239874_2_, TintMode p_239874_3_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239874_2_, resourcelocation));
    }
    ...
    private void func_239935_b_(Block p_239935_1_, Block p_239935_2_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239935_1_, resourcelocation));
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_239935_2_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, resourcelocation1)).func_240125_a_(BlockModelProvider.func_239933_b_()));
    ...
    private void func_239954_c_(Block p_239954_1_, Block p_239954_2_) {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(p_239954_1_).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.AGE_0_7).func_240145_a_(p_239881_3_ -> BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, StockModelShapes.STEM_GROWTH_STAGES[p_239881_3_].func_240228_a_(p_239954_1_, modeltextures, this.field_239835_b_)))));
    }
    ...
    private void func_239873_a_(Block p_239873_1_, Block p_239873_2_, Block p_239873_3_, Block p_239873_4_, Block p_239873_5_, Block p_239873_6_, Block p_239873_7_, Block p_239873_8_) {
        this.func_239877_a_(p_239873_1_, TintMode.NOT_TINTED);
        this.func_239877_a_(p_239873_2_, TintMode.NOT_TINTED);
    ...
    private void func_239955_c_(Block p_239955_1_, TintMode p_239955_2_) {
    ...
    private void func_239990_g_() {
        ...
        ResourceLocation resourcelocation1 = this.func_239886_a_(Blocks.SUNFLOWER, "_bottom", TintMode.NOT_TINTED.func_240066_a_(), ModelTextures::func_240361_c_);
    ...
    private void func_240021_m_(Block p_240021_1_) {
        ...
        BlockStateVariantBuilder blockstatevariantbuilder = BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.POWERED, BlockStateProperties.RAIL_SHAPE_STRAIGHT).func_240152_a_((p_239919_6_, p_239919_7_) -> {
            switch (p_239919_7_) {
                case NORTH_SOUTH: {
                    return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, p_239919_6_ != false ? resourcelocation3 : resourcelocation);
                }
                case EAST_WEST: {
                    return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, p_239919_6_ != false ? resourcelocation3 : resourcelocation).replaceInfoValue(BlockModelFields.field_240201_b_, BlockModelFields.Rotation.R90);
                }
                case ASCENDING_EAST: {
                    return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, p_239919_6_ != false ? resourcelocation4 : resourcelocation1).replaceInfoValue(BlockModelFields.field_240201_b_, BlockModelFields.Rotation.R90);
                }
                case ASCENDING_WEST: {
                    return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, p_239919_6_ != false ? resourcelocation5 : resourcelocation2).replaceInfoValue(BlockModelFields.field_240201_b_, BlockModelFields.Rotation.R90);
                }
                case ASCENDING_NORTH: {
                    return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, p_239919_6_ != false ? resourcelocation4 : resourcelocation1);
                }
                case ASCENDING_SOUTH: {
                    return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, p_239919_6_ != false ? resourcelocation5 : resourcelocation2);
                }
            }
    ...
    private BreakParticleHelper func_239916_a_(ResourceLocation p_239916_1_, Block p_239916_2_) {
        return new BreakParticleHelper(p_239916_1_, p_239916_2_);
    }

    private BreakParticleHelper func_239966_d_(Block p_239966_1_, Block p_239966_2_) {
        return new BreakParticleHelper(ModelsResourceUtil.func_240221_a_(p_239966_1_), p_239966_2_);
    }
    ...
    private void func_239871_a_(Block p_239871_1_, Item p_239871_2_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239871_1_, resourcelocation));
    }
    ...
    private void func_239993_g_(Block p_239993_1_, ResourceLocation p_239993_2_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239993_1_, resourcelocation));
    }
    ...
    private void func_239976_e_(Block p_239976_1_, Block p_239976_2_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239976_2_, resourcelocation));
    }
    ...
    private void func_240023_n_(Block p_240023_1_) {
        ...
        ResourceLocation resourcelocation1 = this.func_239886_a_(p_240023_1_, "_conditional", StockModelShapes.TEMPLATE_COMMAND_BLOCK, p_239947_1_ -> modeltextures.func_240360_c_(StockTextureAliases.SIDE, (ResourceLocation)p_239947_1_));
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(p_240023_1_).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.CONDITIONAL, resourcelocation1, resourcelocation)).func_240125_a_(BlockModelProvider.func_239974_e_()));
    }
    ...
    private void func_240025_o_(Block p_240025_1_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_240025_1_, resourcelocation).func_240125_a_(BlockModelProvider.func_239952_c_()));
    }

    private List<BlockModelDefinition> func_239864_a_(int p_239864_1_) {
        String s = "_age" + p_239864_1_;
        return IntStream.range(1, 5).mapToObj(p_239913_1_ -> BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, ModelsResourceUtil.func_240222_a_(Blocks.BAMBOO, p_239913_1_ + s))).collect(Collectors.toList());
    }
    ...
    private void func_239887_a_(Block p_239887_1_, Function<Block, ModelTextures> p_239887_2_) {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(p_239887_1_).func_240125_a_(BlockModelProvider.func_239933_b_()).func_240125_a_(BlockModelProvider.func_239895_a_(BlockStateProperties.HONEY_LEVEL, 5, resourcelocation1, resourcelocation)));
    }
    ...
    private void func_239876_a_(Block p_239876_1_, Property<Integer> p_239876_2_, int ... p_239876_3_) {
        ...
        BlockStateVariantBuilder blockstatevariantbuilder = BlockStateVariantBuilder.func_240133_a_(p_239876_2_).func_240145_a_(p_239920_4_ -> {
            ...
            ResourceLocation resourcelocation = int2objectmap.computeIfAbsent(i, p_239870_3_ -> this.func_239886_a_(p_239876_1_, "_stage" + i, StockModelShapes.CROP, ModelTextures::func_240370_g_));
    ...
    private void func_239977_e_(Block p_239977_1_, TexturedModel.ISupplier p_239977_2_) {
        ...
        ResourceLocation resourcelocation2 = p_239977_2_.get(p_239977_1_).func_240460_a_(p_239963_1_ -> p_239963_1_.func_240349_a_(StockTextureAliases.FRONT, resourcelocation1)).func_240458_a_(p_239977_1_, "_on", this.field_239835_b_);
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(p_239977_1_).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.LIT, resourcelocation2, resourcelocation)).func_240125_a_(BlockModelProvider.func_239933_b_()));
    }
    ...
    private void func_239921_a_(Block ... p_239921_1_) {
        ...
        for (Block block : p_239921_1_) {
            ...
            this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(block).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.LIT, resourcelocation1, resourcelocation)).func_240125_a_(BlockModelProvider.func_239952_c_()));
        }
    }
    ...
    private void func_240028_q_() {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_240001_h_(Blocks.SMOOTH_STONE_SLAB, resourcelocation, resourcelocation1, resourcelocation2));
    ...
    private void func_239875_a_(Block p_239875_1_, Block p_239875_2_, BiFunction<Block, Block, ModelTextures> p_239875_3_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_239875_1_, StockModelShapes.CUBE.func_240228_a_(p_239875_1_, modeltextures, this.field_239835_b_)));
    }
    ...
    private void func_239879_a_(Block p_239879_1_, ModelTextures p_239879_2_) {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_239879_1_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, resourcelocation)).func_240125_a_(BlockModelProvider.func_239933_b_()));
    }
    ...
    private void func_240042_x_() {
        ...
        ResourceLocation resourcelocation1 = this.func_239886_a_(Blocks.CHORUS_FLOWER, "_dead", StockModelShapes.TEMPLATE_CHORUS_FLOWER, p_239906_1_ -> modeltextures.func_240360_c_(StockTextureAliases.TEXTURE, (ResourceLocation)p_239906_1_));
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.CHORUS_FLOWER).func_240125_a_(BlockModelProvider.func_239895_a_(BlockStateProperties.AGE_0_5, 5, resourcelocation1, resourcelocation)));
    }
    ...
    private void func_240031_r_(Block p_240031_1_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_240031_1_, StockModelShapes.CUBE_BOTTOM_TOP.func_240228_a_(p_240031_1_, modeltextures, this.field_239835_b_)));
    }
    ...
    private void func_239840_D_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.FARMLAND).func_240125_a_(BlockModelProvider.func_239895_a_(BlockStateProperties.MOISTURE_0_7, 7, resourcelocation1, resourcelocation)));
    }
    ...
    private static List<BlockModelDefinition> func_239914_a_(List<ResourceLocation> p_239914_0_, UnaryOperator<BlockModelDefinition> p_239914_1_) {
        return p_239914_0_.stream().map(p_239950_0_ -> BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, p_239950_0_)).map(p_239914_1_).collect(Collectors.toList());
    }

    private void func_239841_E_() {
        IMultiPartPredicateBuilder.Properties imultipartpredicatebuilder = IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, false).func_240098_a_(BlockStateProperties.EAST, false).func_240098_a_(BlockStateProperties.SOUTH, false).func_240098_a_(BlockStateProperties.WEST, false).func_240098_a_(BlockStateProperties.UP, false);
        ...
        this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.FIRE).func_240109_a_(imultipartpredicatebuilder, BlockModelProvider.func_239914_a_(list, p_240016_0_ -> p_240016_0_)).func_240109_a_(IMultiPartPredicateBuilder.func_240090_b_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, true), imultipartpredicatebuilder), BlockModelProvider.func_239914_a_(list1, p_240012_0_ -> p_240012_0_)).func_240109_a_(IMultiPartPredicateBuilder.func_240090_b_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.EAST, true), imultipartpredicatebuilder), BlockModelProvider.func_239914_a_(list1, p_240007_0_ -> p_240007_0_.replaceInfoValue(BlockModelFields.field_240201_b_, BlockModelFields.Rotation.R90))).func_240109_a_(IMultiPartPredicateBuilder.func_240090_b_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.SOUTH, true), imultipartpredicatebuilder), BlockModelProvider.func_239914_a_(list1, p_240002_0_ -> p_240002_0_.replaceInfoValue(BlockModelFields.field_240201_b_, BlockModelFields.Rotation.R180))).func_240109_a_(IMultiPartPredicateBuilder.func_240090_b_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WEST, true), imultipartpredicatebuilder), BlockModelProvider.func_239914_a_(list1, p_239996_0_ -> p_239996_0_.replaceInfoValue(BlockModelFields.field_240201_b_, BlockModelFields.Rotation.R270))).func_240109_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.UP, true), BlockModelProvider.func_239914_a_(list2, p_239989_0_ -> p_239989_0_)));
    }
    ...
    private void func_239842_F_() {
        ...
        this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.SOUL_FIRE).func_240112_a_(BlockModelProvider.func_239914_a_(list, p_239981_0_ -> p_239981_0_)).func_240112_a_(BlockModelProvider.func_239914_a_(list1, p_239971_0_ -> p_239971_0_)).func_240112_a_(BlockModelProvider.func_239914_a_(list1, p_239961_0_ -> p_239961_0_.replaceInfoValue(BlockModelFields.field_240201_b_, BlockModelFields.Rotation.R90))).func_240112_a_(BlockModelProvider.func_239914_a_(list1, p_239945_0_ -> p_239945_0_.replaceInfoValue(BlockModelFields.field_240201_b_, BlockModelFields.Rotation.R180))).func_240112_a_(BlockModelProvider.func_239914_a_(list1, p_239904_0_ -> p_239904_0_.replaceInfoValue(BlockModelFields.field_240201_b_, BlockModelFields.Rotation.R270))));
    }
    ...
    private void func_240039_v_(Block p_240039_1_) {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(p_240039_1_).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.HANGING, resourcelocation1, resourcelocation)));
    }
    ...
    private void func_239844_H_() {
        ...
        ResourceLocation resourcelocation1 = TexturedModel.field_240438_e_.get(Blocks.MYCELIUM).func_240460_a_(p_239951_1_ -> p_239951_1_.func_240349_a_(StockTextureAliases.BOTTOM, resourcelocation)).func_240459_a_(Blocks.MYCELIUM, this.field_239835_b_);
        this.func_239889_a_(Blocks.MYCELIUM, resourcelocation1, blockmodeldefinition);
        ResourceLocation resourcelocation2 = TexturedModel.field_240438_e_.get(Blocks.PODZOL).func_240460_a_(p_239917_1_ -> p_239917_1_.func_240349_a_(StockTextureAliases.BOTTOM, resourcelocation)).func_240459_a_(Blocks.PODZOL, this.field_239835_b_);
    ...
    private void func_239889_a_(Block p_239889_1_, ResourceLocation p_239889_2_, BlockModelDefinition p_239889_3_) {
        List<BlockModelDefinition> list = Arrays.asList(BlockModelProvider.func_239915_a_(p_239889_2_));
    ...
    private void func_239999_h_(Block p_239999_1_, Block p_239999_2_) {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(p_239999_1_).func_240125_a_(BlockModelProvider.func_239895_a_(BlockStateProperties.POWER_0_15, 1, resourcelocation1, resourcelocation)));
    }
    ...
    private void func_240041_w_(Block p_240041_1_) {
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_240041_1_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, ModelsResourceUtil.func_240221_a_(p_240041_1_))).func_240125_a_(BlockModelProvider.func_239933_b_()));
    }
    ...
    private void func_239853_Q_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.OBSERVER).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.POWERED, resourcelocation1, resourcelocation)).func_240125_a_(BlockModelProvider.func_239974_e_()));
    }
    ...
    private void func_239890_a_(Block p_239890_1_, ResourceLocation p_239890_2_, ModelTextures p_239890_3_) {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(p_239890_1_).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.EXTENDED, p_239890_2_, resourcelocation)).func_240125_a_(BlockModelProvider.func_239974_e_()));
    }
    ...
    private void func_239856_T_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.SCAFFOLDING).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.BOTTOM, resourcelocation1, resourcelocation)));
    }
    ...
    private void func_239857_U_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.REDSTONE_LAMP).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.LIT, resourcelocation1, resourcelocation)));
    }
    ...
    private void func_240010_j_(Block p_240010_1_, Block p_240010_2_) {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_240010_1_, StockModelShapes.TEMPLATE_TORCH.func_240228_a_(p_240010_1_, modeltextures, this.field_239835_b_)));
    ...
    private void func_239858_V_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.REDSTONE_TORCH).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.LIT, resourcelocation, resourcelocation1)));
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.REDSTONE_WALL_TORCH).func_240125_a_(BlockModelProvider.func_239894_a_(BlockStateProperties.LIT, resourcelocation2, resourcelocation3)).func_240125_a_(BlockModelProvider.func_239964_d_()));
    ...
    private void func_239859_W_() {
        ...
        })).func_240125_a_(BlockModelProvider.func_239952_c_()));
    }
    ...
    private void func_239861_Y_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.SNOW).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.LAYERS_1_8).func_240145_a_(p_239918_1_ -> BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, p_239918_1_ < 8 ? ModelsResourceUtil.func_240222_a_(Blocks.SNOW, "_height" + p_239918_1_ * 2) : resourcelocation))));
    ...
    private void func_239923_aa_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.STRUCTURE_BLOCK).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.STRUCTURE_BLOCK_MODE).func_240145_a_(p_239896_1_ -> BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, this.func_239886_a_(Blocks.STRUCTURE_BLOCK, "_" + p_239896_1_.getString(), StockModelShapes.CUBE_ALL, ModelTextures::func_240356_b_)))));
    }

    private void func_239924_ab_() {
        this.func_239866_a_(Items.SWEET_BERRIES);
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.SWEET_BERRY_BUSH).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.AGE_0_3).func_240145_a_(p_239910_1_ -> BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, this.func_239886_a_(Blocks.SWEET_BERRY_BUSH, "_stage" + p_239910_1_, StockModelShapes.CROSS, ModelTextures::func_240361_c_)))));
    }
    ...
    private void func_239926_ad_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.TRIPWIRE_HOOK).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.ATTACHED, BlockStateProperties.POWERED).func_240152_a_((p_239908_0_, p_239908_1_) -> BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, ModelTextures.func_240347_a_(Blocks.TRIPWIRE_HOOK, (p_239908_0_ != false ? "_attached" : "") + (p_239908_1_ != false ? "_on" : ""))))).func_240125_a_(BlockModelProvider.func_239933_b_()));
    }
    ...
    private void func_239927_ae_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.TURTLE_EGG).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.EGGS_1_4, BlockStateProperties.HATCH_0_2).func_240155_b_((p_239949_1_, p_239949_2_) -> Arrays.asList(BlockModelProvider.func_239915_a_(this.func_239912_a_((Integer)p_239949_1_, (Integer)p_239949_2_))))));
    }
    ...
    private void func_239936_b_(Block p_239936_1_, Block p_239936_2_, TintMode p_239936_3_) {
    ...
    private void func_239930_ah_() {
        ...
        this.field_239834_a_.accept(BlockModelProvider.func_239979_e_(Blocks.INFESTED_STONE, resourcelocation, resourcelocation1));
    ...
    private void func_240019_l_(Block p_240019_1_, Block p_240019_2_) {
        this.func_239877_a_(p_240019_1_, TintMode.NOT_TINTED);
        ModelTextures modeltextures = ModelTextures.func_240365_d_(ModelTextures.func_240347_a_(p_240019_1_, "_pot"));
        ResourceLocation resourcelocation = TintMode.NOT_TINTED.func_240067_b_().func_240228_a_(p_240019_2_, modeltextures, this.field_239835_b_);
        this.field_239834_a_.accept(BlockModelProvider.func_239978_e_(p_240019_2_, resourcelocation));
    }
    ...
    private void func_239931_ai_() {
        ...
        this.field_239834_a_.accept(FinishedVariantBlockState.func_240119_a_(Blocks.RESPAWN_ANCHOR).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.CHARGES).func_240145_a_(p_239922_1_ -> BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.field_240202_c_, aresourcelocation[p_239922_1_]))));
    ...
    public void func_239863_a_() {
        ...
        this.func_239956_c_(Blocks.CHISELED_QUARTZ_BLOCK, TexturedModel.field_240436_c_.func_240467_a_(p_239982_0_ -> p_239982_0_.func_240349_a_(StockTextureAliases.SIDE, ModelTextures.func_240341_C_(Blocks.CHISELED_QUARTZ_BLOCK))));
        ...
        this.func_239905_a_(ModelTextures.func_240345_a_(Blocks.STONE)).func_240059_a_(p_239972_1_ -> {
            ResourceLocation resourcelocation = StockModelShapes.CUBE_ALL.func_240228_a_(Blocks.STONE, (ModelTextures)p_239972_1_, this.field_239835_b_);
            ResourceLocation resourcelocation1 = StockModelShapes.CUBE_MIRRORED_ALL.func_240228_a_(Blocks.STONE, (ModelTextures)p_239972_1_, this.field_239835_b_);
            this.field_239834_a_.accept(BlockModelProvider.func_239979_e_(Blocks.STONE, resourcelocation, resourcelocation1));
        ...
        this.func_239884_a_(Blocks.CUT_SANDSTONE, TexturedModel.field_240436_c_.get(Blocks.SANDSTONE).func_240460_a_(p_239962_0_ -> p_239962_0_.func_240349_a_(StockTextureAliases.SIDE, ModelTextures.func_240341_C_(Blocks.CUT_SANDSTONE)))).func_240064_f_(Blocks.CUT_SANDSTONE_SLAB);
        ...
        this.func_239884_a_(Blocks.CUT_RED_SANDSTONE, TexturedModel.field_240436_c_.get(Blocks.RED_SANDSTONE).func_240460_a_(p_239946_0_ -> p_239946_0_.func_240349_a_(StockTextureAliases.SIDE, ModelTextures.func_240341_C_(Blocks.CUT_RED_SANDSTONE)))).func_240064_f_(Blocks.CUT_RED_SANDSTONE_SLAB);
        ...
        SpawnEggItem.getEggs().forEach(p_239868_1_ -> this.func_239867_a_((Item)p_239868_1_, ModelsResourceUtil.func_240224_b_("template_spawn_egg")));
    }
    ...
    class BlockTextureCombiner {
        ...
        public BlockTextureCombiner func_240058_a_(Block p_240058_1_, ModelsUtil p_240058_2_) {
        ...
        public BlockTextureCombiner func_240059_a_(Function<ModelTextures, ResourceLocation> p_240059_1_) {
            this.field_240055_c_ = p_240059_1_.apply(this.field_240054_b_);
            return this;
        }

        public BlockTextureCombiner func_240056_a_(Block p_240056_1_) {
        ...
        public BlockTextureCombiner func_240060_b_(Block p_240060_1_) {
        ...
        public BlockTextureCombiner func_240061_c_(Block p_240061_1_) {
        ...
        public BlockTextureCombiner func_240062_d_(Block p_240062_1_) {
        ...
        public BlockTextureCombiner func_240063_e_(Block p_240063_1_) {
        ...
        public BlockTextureCombiner func_240057_a_(Block p_240057_1_, Block p_240057_2_) {
        ...
        public BlockTextureCombiner func_240064_f_(Block p_240064_1_) {
        ...
        public BlockTextureCombiner func_240065_g_(Block p_240065_1_) {
    ...
    class LogsVariantHelper {
        ...
        public LogsVariantHelper func_240070_a_(Block p_240070_1_) {
        ...
        public LogsVariantHelper func_240071_b_(Block p_240071_1_) {
        ...
        public LogsVariantHelper func_240072_c_(Block p_240072_1_) {
    ...
    class BreakParticleHelper {
        ...
        public BreakParticleHelper func_240051_a_(Block ... p_240051_1_) {
        ...
        public BreakParticleHelper func_240052_b_(Block ... p_240052_1_) {
        ...
        public BreakParticleHelper func_240050_a_(ModelsUtil p_240050_1_, Block ... p_240050_2_) {
