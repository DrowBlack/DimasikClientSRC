...
implements IDataProvider {
    ...
    public void act(DirectoryCache cache) {
        ...
        List list = Registry.BLOCK.stream().filter(p_240084_1_ -> !map.containsKey(p_240084_1_)).collect(Collectors.toList());
        if (!list.isEmpty()) {
    ...
    private <T> void func_240081_a_(DirectoryCache p_240081_1_, Path p_240081_2_, Map<T, ? extends Supplier<JsonElement>> p_240081_3_, BiFunction<Path, T, Path> p_240081_4_) {
        p_240081_3_.forEach((p_240088_3_, p_240088_4_) -> {
            ...
            try {
                IDataProvider.save(field_240079_c_, p_240081_1_, (JsonElement)p_240088_4_.get(), path);
            }
            catch (Exception exception) {
                field_240078_b_.error("Couldn't save {}", (Object)path, (Object)exception);
            }
        });
    }
