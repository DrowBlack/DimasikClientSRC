...
implements IFinishedBlockState {
    ...
    public FinishedMultiPartBlockState func_240112_a_(List<BlockModelDefinition> p_240112_1_) {
        this.field_240105_b_.add(new Part(p_240112_1_));
        return this;
    }
    ...
    public FinishedMultiPartBlockState func_240109_a_(IMultiPartPredicateBuilder p_240109_1_, List<BlockModelDefinition> p_240109_2_) {
        this.field_240105_b_.add(new ConditionalPart(p_240109_1_, p_240109_2_));
        return this;
    }
    ...
    public JsonElement get() {
        ...
        this.field_240105_b_.forEach(p_240107_1_ -> p_240107_1_.func_230525_a_(statecontainer));
    ...
    extends Part {
        ...
        @Override
        public void func_230526_a_(JsonObject p_230526_1_) {
            p_230526_1_.add("when", (JsonElement)this.field_240113_a_.get());
        }
    }
}
