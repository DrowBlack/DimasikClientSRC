...
implements IDataProvider {
    ...
    public void act(DirectoryCache cache) {
        ...
        this.field_218444_e.forEach(p_218438_1_ -> ((Consumer)((Supplier)p_218438_1_.getFirst()).get()).accept((p_218437_2_, p_218437_3_) -> {
            if (map.put((ResourceLocation)p_218437_2_, p_218437_3_.setParameterSet((LootParameterSet)p_218438_1_.getSecond()).build()) != null) {
        ...
        for (ResourceLocation resourcelocation : Sets.difference(LootTables.getReadOnlyLootTables(), map.keySet())) {
            validationtracker.addProblem("Missing built-in table: " + String.valueOf(resourcelocation));
        }
        map.forEach((p_229439_1_, p_229439_2_) -> LootTableManager.validateLootTable(validationtracker, p_229439_1_, p_229439_2_));
        Multimap<String, String> multimap = validationtracker.getProblems();
        if (!multimap.isEmpty()) {
            multimap.forEach((p_229440_0_, p_229440_1_) -> LOGGER.warn("Found validation problem in " + p_229440_0_ + ": " + p_229440_1_));
            throw new IllegalStateException("Failed to validate loot tables, see logs");
        }
        map.forEach((p_229441_2_, p_229441_3_) -> {
            Path path1 = LootTableProvider.getPath(path, p_229441_2_);
            try {
