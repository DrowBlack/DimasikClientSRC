...
implements IDataProvider {
    ...
    public void act(DirectoryCache cache) throws IOException {
        ...
        Registry.REGISTRY.keySet().forEach(registryId -> jsonobject.add(registryId.toString(), RegistryDumpReport.serialize(Registry.REGISTRY.getOrDefault((ResourceLocation)registryId))));
    ...
    private static <T> JsonElement serialize(Registry<T> registry) {
        ...
        int j = Registry.REGISTRY.getId(registry);
