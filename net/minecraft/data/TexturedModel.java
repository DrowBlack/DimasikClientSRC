...
public class TexturedModel {
    ...
    private static ISupplier func_240461_a_(Function<Block, ModelTextures> p_240461_0_, ModelsUtil p_240461_1_) {
        return p_240462_2_ -> new TexturedModel((ModelTextures)p_240461_0_.apply(p_240462_2_), p_240461_1_);
    }
    ...
    public static interface ISupplier {
        ...
        default public ResourceLocation func_240466_a_(Block p_240466_1_, BiConsumer<ResourceLocation, Supplier<JsonElement>> p_240466_2_) {
            return this.get(p_240466_1_).func_240459_a_(p_240466_1_, p_240466_2_);
        }

        default public ResourceLocation func_240465_a_(Block p_240465_1_, String p_240465_2_, BiConsumer<ResourceLocation, Supplier<JsonElement>> p_240465_3_) {
            return this.get(p_240465_1_).func_240458_a_(p_240465_1_, p_240465_2_, p_240465_3_);
        }

        default public ISupplier func_240467_a_(Consumer<ModelTextures> p_240467_1_) {
            return p_240468_2_ -> this.get(p_240468_2_).func_240460_a_(p_240467_1_);
        }
    }
}
