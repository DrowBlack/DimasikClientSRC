...
public final class VariantPropertyBuilder {
    ...
    private static final Comparator<Property.ValuePair<?>> field_240185_b_ = Comparator.comparing(p_240192_0_ -> p_240192_0_.func_240181_a_().getName());
    ...
    public VariantPropertyBuilder func_240188_a_(Property.ValuePair<?> p_240188_1_) {
        return new VariantPropertyBuilder((List<Property.ValuePair<?>>)((Object)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().addAll(this.field_240186_c_)).add(p_240188_1_)).build()));
    }

    public VariantPropertyBuilder func_240189_a_(VariantPropertyBuilder p_240189_1_) {
        return new VariantPropertyBuilder((List<Property.ValuePair<?>>)((Object)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().addAll(this.field_240186_c_)).addAll(p_240189_1_.field_240186_c_)).build()));
    }
