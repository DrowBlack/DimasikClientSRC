...
public abstract class Enchantment {
    ...
    public static Enchantment getEnchantmentByID(int id) {
        return (Enchantment)Registry.ENCHANTMENT.getByValue(id);
    }
    ...
    public Map<EquipmentSlotType, ItemStack> getEntityEquipment(LivingEntity livingEntityIn) {
        EnumMap<EquipmentSlotType, ItemStack> map = Maps.newEnumMap(EquipmentSlotType.class);
    ...
    public ITextComponent getDisplayName(int level) {
        TranslationTextComponent iformattabletextcomponent = new TranslationTextComponent(this.getName());
        if (this.isCurse()) {
