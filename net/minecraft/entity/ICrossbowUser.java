...
extends IRangedAttackMob {
    ...
    default public void func_234281_b_(LivingEntity p_234281_1_, float p_234281_2_) {
        ...
        if (p_234281_1_.canEquip(Items.CROSSBOW)) {
            CrossbowItem.fireProjectiles(p_234281_1_.world, p_234281_1_, hand, itemstack, p_234281_2_, 14 - p_234281_1_.world.getDifficulty().getId() * 4);
        }
        this.func_230283_U__();
    }

    default public void func_234279_a_(LivingEntity p_234279_1_, LivingEntity p_234279_2_, ProjectileEntity p_234279_3_, float p_234279_4_, float p_234279_5_) {
        ...
        double d3 = p_234279_2_.getPosYHeight(0.3333333333333333) - p_234279_3_.getPosY() + d2 * (double)0.2f;
        Vector3f vector3f = this.func_234280_a_(p_234279_1_, new Vector3d(d0, d3, d1), p_234279_4_);
        p_234279_3_.shoot(vector3f.getX(), vector3f.getY(), vector3f.getZ(), p_234279_5_, 14 - p_234279_1_.world.getDifficulty().getId() * 4);
        p_234279_1_.playSound(SoundEvents.ITEM_CROSSBOW_SHOOT, 1.0f, 1.0f / (p_234279_1_.getRNG().nextFloat() * 0.4f + 0.8f));
    }

    default public Vector3f func_234280_a_(LivingEntity p_234280_1_, Vector3d p_234280_2_, float p_234280_3_) {
        Vector3d vector3d = p_234280_2_.normalize();
        Vector3d vector3d1 = vector3d.crossProduct(new Vector3d(0.0, 1.0, 0.0));
