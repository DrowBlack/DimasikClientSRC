...
extends Task<LivingEntity> {
    ...
    protected boolean shouldExecute(ServerWorld worldIn, LivingEntity owner) {
        ...
        return worldIn.getDimensionKey() == globalpos.getDimension() && globalpos.getPos().withinDistance(owner.getPositionVec(), 16.0);
    }
    ...
    private boolean func_223019_a(ServerWorld world, BlockPos pos, LivingEntity p_223019_3_) {
        ...
        return blockstate.getBlock().isIn(BlockTags.BEDS) && blockstate.get(BedBlock.OCCUPIED) != false && !p_223019_3_.isSleeping();
    }
