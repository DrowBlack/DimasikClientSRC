...
extends Task<VillagerEntity> {
    ...
    protected void startExecuting(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
        ...
        if (optional.isPresent()) {
            BrainUtil.getNearbyVillagers(entityIn, p_234021_3_ -> this.func_234018_a_((PointOfInterestType)optional.get(), (VillagerEntity)p_234021_3_, blockpos)).findFirst().ifPresent(p_234023_4_ -> this.func_234022_a_(worldIn, entityIn, (VillagerEntity)p_234023_4_, blockpos, p_234023_4_.getBrain().getMemory(MemoryModuleType.JOB_SITE).isPresent()));
        }
    }
