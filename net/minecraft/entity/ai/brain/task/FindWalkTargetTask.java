...
extends Task<CreatureEntity> {
    ...
    private void func_220594_a(CreatureEntity p_220594_1_, SectionPos p_220594_2_) {
        ...
        p_220594_1_.getBrain().setMemory(MemoryModuleType.WALK_TARGET, optional.map(p_220596_1_ -> new WalkTarget((Vector3d)p_220596_1_, this.speed, 0)));
    }
    ...
    private void func_220593_a(CreatureEntity p_220593_1_) {
        ...
        p_220593_1_.getBrain().setMemory(MemoryModuleType.WALK_TARGET, optional.map(p_220595_1_ -> new WalkTarget((Vector3d)p_220595_1_, this.speed, 0)));
    }
}
