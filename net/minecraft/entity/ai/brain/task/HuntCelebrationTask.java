...
extends Task<E> {
    ...
    protected void startExecuting(ServerWorld worldIn, MobEntity entityIn, long gameTimeIn) {
        BlockPos blockpos = HuntCelebrationTask.func_233899_a_(entityIn);
        boolean flag = blockpos.withinDistance(entityIn.getPosition(), (double)this.field_233897_b_);
        if (!flag) {
            BrainUtil.setTargetPosition(entityIn, HuntCelebrationTask.func_233900_a_(entityIn, blockpos), this.field_233898_c_, this.field_233897_b_);
        }
    }

    private static BlockPos func_233900_a_(MobEntity p_233900_0_, BlockPos p_233900_1_) {
        Random random = p_233900_0_.world.rand;
        return p_233900_1_.add(HuntCelebrationTask.func_233901_a_(random), 0, HuntCelebrationTask.func_233901_a_(random));
    }
