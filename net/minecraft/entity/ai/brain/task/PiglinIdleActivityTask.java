...
extends Task<E> {
    ...
    protected void startExecuting(ServerWorld worldIn, E entityIn, long gameTimeIn) {
        Brain<?> brain = ((LivingEntity)entityIn).getBrain();
        brain.replaceMemory(this.field_233883_d_, brain.getMemory(this.field_233882_c_).get(), this.field_233884_e_.getRandomWithinRange(worldIn.rand));
    }
}
