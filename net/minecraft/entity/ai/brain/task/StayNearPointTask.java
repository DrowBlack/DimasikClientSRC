...
extends Task<VillagerEntity> {
    ...
    private void func_225457_a(VillagerEntity p_225457_1_, long p_225457_2_) {
        Brain<VillagerEntity> brain = p_225457_1_.getBrain();
    ...
    protected void startExecuting(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
        ...
        brain.getMemory(this.field_220548_a).ifPresent(p_220545_6_ -> {
            if (!this.func_242303_a(worldIn, (GlobalPos)p_220545_6_) && !this.func_223017_a(worldIn, entityIn)) {
                if (this.func_242304_a(entityIn, (GlobalPos)p_220545_6_)) {
                    int i;
                    Vector3d vector3d = null;
                    int j = 1000;
                    for (i = 0; i < 1000 && (vector3d == null || this.func_242304_a(entityIn, GlobalPos.getPosition(worldIn.getDimensionKey(), new BlockPos(vector3d)))); ++i) {
                ...
                } else if (!this.func_220547_b(worldIn, entityIn, (GlobalPos)p_220545_6_)) {
