...
extends Task<VillagerEntity> {
    ...
    protected void startExecuting(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
        ...
        worldIn.getPointOfInterestManager().getType(globalpos.getPos()).ifPresent(p_233933_3_ -> BrainUtil.getNearbyVillagers(entityIn, p_233935_3_ -> this.func_233934_a_(globalpos, (PointOfInterestType)p_233933_3_, (VillagerEntity)p_233935_3_)).reduce(entityIn, SwitchVillagerJobTask::func_233932_a_));
    }
