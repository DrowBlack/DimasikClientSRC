...
extends Goal {
    ...
    public FollowMobGoal(MobEntity p_i47417_1_, double p_i47417_2_, float p_i47417_4_, float p_i47417_5_) {
        ...
        this.followPredicate = p_210291_1_ -> p_210291_1_ != null && p_i47417_1_.getClass() != p_210291_1_.getClass();
    ...
    public void tick() {
        if (this.followingEntity != null && !this.entity.getLeashed()) {
            ...
            if (--this.timeToRecalcPath <= 0) {
                ...
                double d3 = d0 * d0 + (d1 = this.entity.getPosY() - this.followingEntity.getPosY()) * d1 + (d2 = this.entity.getPosZ() - this.followingEntity.getPosZ()) * d2;
