...
extends Goal {
    ...
    public boolean shouldExecute() {
        ...
        Vector3d vector3d = RandomPositionGenerator.func_221024_a(this.entity, 15, 7, p_220734_3_ -> {
            if (!serverworld.isVillage((BlockPos)p_220734_3_)) {
                return Double.NEGATIVE_INFINITY;
            }
            Optional<BlockPos> optional1 = serverworld.getPointOfInterestManager().find(PointOfInterestType.MATCH_ANY, this::func_220733_a, (BlockPos)p_220734_3_, 10, PointOfInterestManager.Status.IS_OCCUPIED);
        ...
        for (int i = 0; i < this.path.getCurrentPathLength(); ++i) {
            ...
            if (!DoorBlock.isWooden(this.entity.world, blockpos1)) continue;
