...
extends RandomWalkingGoal {
    ...
    protected Vector3d getPosition() {
        ...
        int i = 0;
        while (vector3d != null && !this.creature.world.getBlockState(new BlockPos(vector3d)).allowsMovement(this.creature.world, new BlockPos(vector3d), PathType.WATER) && i++ < 10) {
