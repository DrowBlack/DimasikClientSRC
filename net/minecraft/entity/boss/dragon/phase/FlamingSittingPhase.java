...
extends SittingPhase {
    ...
    public void serverTick() {
        ...
        if (this.flameTicks >= 200) {
            ...
            float f = 5.0f;
            double d0 = this.dragon.dragonPartHead.getPosX() + vector3d.x * 5.0 / 2.0;
            double d1 = this.dragon.dragonPartHead.getPosZ() + vector3d.z * 5.0 / 2.0;
            double d3 = d2 = this.dragon.dragonPartHead.getPosYHeight(0.5);
