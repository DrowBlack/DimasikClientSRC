...
IVillagerDataHolder {
    ...
    public static final Map<MemoryModuleType<GlobalPos>, BiPredicate<VillagerEntity, PointOfInterestType>> JOB_SITE_PREDICATE_MAP = ImmutableMap.of(MemoryModuleType.HOME, (villager, poiType) -> poiType == PointOfInterestType.HOME, MemoryModuleType.JOB_SITE, (villager, poiType) -> villager.getVillagerData().getProfession().getPointOfInterest() == poiType, MemoryModuleType.POTENTIAL_JOB_SITE, (villager, poiType) -> PointOfInterestType.ANY_VILLAGER_WORKSTATION.test((PointOfInterestType)poiType), MemoryModuleType.MEETING_POINT, (villager, poiType) -> poiType == PointOfInterestType.MEETING);
    ...
    public void writeAdditional(CompoundNBT compound) {
        ...
        VillagerData.CODEC.encodeStart(NBTDynamicOps.INSTANCE, this.getVillagerData()).resultOrPartial(LOGGER::error).ifPresent(data -> compound.put("VillagerData", (INBT)data));
    ...
    public void readAdditional(CompoundNBT compound) {
        ...
        if (compound.contains("VillagerData", 10)) {
            DataResult dataresult = VillagerData.CODEC.parse(new Dynamic<INBT>(NBTDynamicOps.INSTANCE, compound.get("VillagerData")));
        ...
        this.gossip.read(new Dynamic<ListNBT>(NBTDynamicOps.INSTANCE, listnbt));
    ...
    public void onDeath(DamageSource cause) {
        LOGGER.info("Villager {} died, message: '{}'", (Object)this, (Object)cause.getDeathMessage(this).getString());
    ...
    private void sawMurder(Entity murderer) {
        ...
        if (this.world instanceof ServerWorld && (optional = this.brain.getMemory(MemoryModuleType.VISIBLE_MOBS)).isPresent()) {
            ...
            optional.get().stream().filter(gossipTarget -> gossipTarget instanceof IReputationTracking).forEach(gossipTarget -> serverworld.updateReputation(IReputationType.VILLAGER_KILLED, murderer, (IReputationTracking)((Object)gossipTarget)));
        }
    }
    ...
    private void eat() {
        if (this.isHungry() && this.getFoodValueFromInventory() != 0) {
            for (int i = 0; i < this.getVillagerInventory().getSizeInventory(); ++i) {
                ...
                if (itemstack.isEmpty() || (integer = FOOD_VALUES.get(itemstack.getItem())) == null) continue;
    ...
    public VillagerEntity func_241840_a(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        ...
        VillagerType villagertype = d0 < 0.5 ? VillagerType.func_242371_a(p_241840_1_.func_242406_i(this.getPosition())) : (d0 < 0.75 ? this.getVillagerData().getType() : ((VillagerEntity)p_241840_2_).getVillagerData().getType());
        VillagerEntity villagerentity = new VillagerEntity(EntityType.VILLAGER, p_241840_1_, villagertype);
        villagerentity.onInitialSpawn(p_241840_1_, p_241840_1_.getDifficultyForLocation(villagerentity.getPosition()), SpawnReason.BREEDING, null, null);
    ...
    public void func_241841_a(ServerWorld p_241841_1_, LightningBoltEntity p_241841_2_) {
        if (p_241841_1_.getDifficulty() != Difficulty.PEACEFUL) {
            LOGGER.info("Villager {} was struck by lightning {}.", (Object)this, (Object)p_241841_2_);
    ...
    private int getFoodValueFromInventory() {
        Inventory inventory = this.getVillagerInventory();
        return FOOD_VALUES.entrySet().stream().mapToInt(foodValueEntry -> inventory.count((Item)foodValueEntry.getKey()) * (Integer)foodValueEntry.getValue()).sum();
    }
    ...
    protected void populateTradeData() {
        ...
        if (int2objectmap != null && !int2objectmap.isEmpty() && (avillagertrades$itrade = (VillagerTrades.ITrade[])int2objectmap.get(villagerdata.getLevel())) != null) {
    ...
    public void func_242367_a(ServerWorld p_242367_1_, long p_242367_2_, int p_242367_4_) {
        ...
        List list1;
        if (this.canSpawnGolems(p_242367_2_) && (list1 = (list = p_242367_1_.getEntitiesWithinAABB(VillagerEntity.class, axisalignedbb = this.getBoundingBox().grow(10.0, 10.0, 10.0))).stream().filter(villager -> villager.canSpawnGolems(p_242367_2_)).limit(5L).collect(Collectors.toList())).size() >= p_242367_4_ && (irongolementity = this.trySpawnGolem(p_242367_1_)) != null) {
    ...
    private IronGolemEntity trySpawnGolem(ServerWorld p_213759_1_) {
        ...
        for (int i = 0; i < 10; ++i) {
            IronGolemEntity irongolementity;
            double d1;
            double d0 = p_213759_1_.rand.nextInt(16) - 8;
            BlockPos blockpos1 = this.getValidGolemSpawnPosition(blockpos, d0, d1 = (double)(p_213759_1_.rand.nextInt(16) - 8));
            if (blockpos1 == null || (irongolementity = EntityType.IRON_GOLEM.create(p_213759_1_, null, null, null, blockpos1, SpawnReason.MOB_SUMMONED, false, false)) == null) continue;
    ...
    private BlockPos getValidGolemSpawnPosition(BlockPos pos, double x, double z) {
        ...
        for (int j = 6; j >= -6; --j) {
            ...
            if (!blockstate1.isAir() && !blockstate1.getMaterial().isLiquid() || !blockstate.getMaterial().isOpaque()) continue;
            return blockpos1;
        }
        return null;
    }
    ...
    public void setGossips(INBT gossip) {
        this.gossip.read(new Dynamic<INBT>(NBTDynamicOps.INSTANCE, gossip));
    }
