...
IFlinging {
    ...
    public ZoglinEntity(EntityType<? extends ZoglinEntity> p_i231566_1_, World p_i231566_2_) {
        super((EntityType<? extends MonsterEntity>)p_i231566_1_, p_i231566_2_);
    ...
    private static void func_234329_b_(Brain<ZoglinEntity> p_234329_0_) {
        p_234329_0_.registerActivity(Activity.IDLE, 10, ImmutableList.of(new ForgetAttackTargetTask<ZoglinEntity>(ZoglinEntity::func_234335_eQ_), new RunSometimesTask<LivingEntity>(new LookAtEntityTask(8.0f), RangedInteger.createRangedInteger(30, 60)), new FirstShuffledTask(ImmutableList.of(Pair.of(new WalkRandomlyTask(0.4f), 2), Pair.of(new WalkTowardsLookTargetTask(0.4f, 3), 2), Pair.of(new DummyTask(30, 60), 1)))));
    }

    private static void func_234330_c_(Brain<ZoglinEntity> p_234330_0_) {
        p_234330_0_.registerActivity(Activity.FIGHT, 10, ImmutableList.of(new MoveToTargetTask(1.0f), new SupplementedTask<MobEntity>(ZoglinEntity::func_234331_eI_, new AttackTargetTask(40)), new SupplementedTask<MobEntity>(ZoglinEntity::isChild, new AttackTargetTask(15)), new FindNewAttackTargetTask()), MemoryModuleType.ATTACK_TARGET);
    }
    ...
    protected void func_234332_eJ_() {
        ...
        Activity activity1 = this.brain.getTemporaryActivity().orElse(null);
