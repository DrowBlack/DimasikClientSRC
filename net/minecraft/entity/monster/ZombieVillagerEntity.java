...
implements IVillagerDataHolder {
    ...
    public ZombieVillagerEntity(EntityType<? extends ZombieVillagerEntity> p_i50186_1_, World p_i50186_2_) {
        super((EntityType<? extends ZombieEntity>)p_i50186_1_, p_i50186_2_);
    ...
    public void writeAdditional(CompoundNBT compound) {
        ...
        VillagerData.CODEC.encodeStart(NBTDynamicOps.INSTANCE, this.getVillagerData()).resultOrPartial(LOGGER::error).ifPresent(p_234343_1_ -> compound.put("VillagerData", (INBT)p_234343_1_));
        if (this.offers != null) {
    ...
    private void cureZombie(ServerWorld p_213791_1_) {
        ...
        villagerentity.onInitialSpawn(p_213791_1_, p_213791_1_.getDifficultyForLocation(villagerentity.getPosition()), SpawnReason.CONVERSION, null, null);
        if (this.converstionStarter != null && (playerentity = p_213791_1_.getPlayerByUuid(this.converstionStarter)) instanceof ServerPlayerEntity) {
