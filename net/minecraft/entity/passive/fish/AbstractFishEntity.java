        ...
        public void tick() {
            ...
            if (this.action == MovementController.Action.MOVE_TO && !this.fish.getNavigator().noPath()) {
                ...
                if (d1 != 0.0) {
                    ...
                    this.fish.setMotion(this.fish.getMotion().add(0.0, (double)this.fish.getAIMoveSpeed() * (d1 / d3) * 0.1, 0.0));
                }
                if (d0 != 0.0 || d2 != 0.0) {
                    float f1 = (float)(MathHelper.atan2(d2, d0) * 57.2957763671875) - 90.0f;
                    this.fish.renderYawOffset = this.fish.rotationYaw = this.limitAngle(this.fish.rotationYaw, f1, 90.0f);
                }
            } else {
