...
public class SpawnLocationHelper {
    ...
    protected static BlockPos func_241092_a_(ServerWorld p_241092_0_, int p_241092_1_, int p_241092_2_, boolean p_241092_3_) {
        ...
        int n = i = flag ? p_241092_0_.getChunkProvider().getChunkGenerator().getGroundHeight() : chunk.getTopBlockY(Heightmap.Type.MOTION_BLOCKING, p_241092_1_ & 0xF, p_241092_2_ & 0xF);
        if (i < 0) {
            return null;
        }
        int j = chunk.getTopBlockY(Heightmap.Type.WORLD_SURFACE, p_241092_1_ & 0xF, p_241092_2_ & 0xF);
        if (j <= i && j > chunk.getTopBlockY(Heightmap.Type.OCEAN_FLOOR, p_241092_1_ & 0xF, p_241092_2_ & 0xF)) {
            return null;
        }
        for (int k = i + 1; k >= 0; --k) {
            ...
            return ((BlockPos)blockpos$mutable.up()).toImmutable();
        }
        return null;
    }
    ...
    public static BlockPos func_241094_a_(ServerWorld p_241094_0_, ChunkPos p_241094_1_, boolean p_241094_2_) {
        for (int i = p_241094_1_.getXStart(); i <= p_241094_1_.getXEnd(); ++i) {
            for (int j = p_241094_1_.getZStart(); j <= p_241094_1_.getZEnd(); ++j) {
                BlockPos blockpos = SpawnLocationHelper.func_241092_a_(p_241094_0_, i, j, p_241094_2_);
