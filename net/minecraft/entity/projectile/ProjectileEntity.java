...
extends Entity {
    ...
    private boolean func_234615_h_() {
        ...
        if (entity != null) {
            for (Entity entity1 : this.world.getEntitiesInAABBexcluding(this, this.getBoundingBox().expand(this.getMotion()).grow(1.0), p_234613_0_ -> !p_234613_0_.isSpectator() && p_234613_0_.canBeCollidedWith())) {
                if (entity1.getLowestRidingEntity() != entity.getLowestRidingEntity()) continue;
                return false;
            }
        }
        return true;
    ...
    public void func_234612_a_(Entity p_234612_1_, float p_234612_2_, float p_234612_3_, float p_234612_4_, float p_234612_5_, float p_234612_6_) {
        float f = -MathHelper.sin(p_234612_3_ * ((float)Math.PI / 180)) * MathHelper.cos(p_234612_2_ * ((float)Math.PI / 180));
        float f1 = -MathHelper.sin((p_234612_2_ + p_234612_4_) * ((float)Math.PI / 180));
        float f2 = MathHelper.cos(p_234612_3_ * ((float)Math.PI / 180)) * MathHelper.cos(p_234612_2_ * ((float)Math.PI / 180));
        this.shoot(f, f1, f2, p_234612_5_, p_234612_6_);
        Vector3d vector3d = p_234612_1_.getMotion();
        this.setMotion(this.getMotion().add(vector3d.x, p_234612_1_.isOnGround() ? 0.0 : vector3d.y, vector3d.z));
    }
    ...
    public void setVelocity(double x, double y, double z) {
        ...
        if (this.prevRotationPitch == 0.0f && this.prevRotationYaw == 0.0f) {
            ...
            this.rotationPitch = (float)(MathHelper.atan2(y, f) * 57.2957763671875);
            this.rotationYaw = (float)(MathHelper.atan2(x, z) * 57.2957763671875);
            this.prevRotationPitch = this.rotationPitch;
            this.prevRotationYaw = this.rotationYaw;
