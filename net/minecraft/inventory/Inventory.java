...
IRecipeHelperPopulator {
    ...
    public List<ItemStack> func_233543_f_() {
        List<ItemStack> list = this.inventoryContents.stream().filter(p_233544_0_ -> !p_233544_0_.isEmpty()).collect(Collectors.toList());
        this.clear();
        return list;
    }
    ...
    public boolean func_233541_b_(ItemStack p_233541_1_) {
        ...
        for (ItemStack itemstack : this.inventoryContents) {
            if (!itemstack.isEmpty() && (!this.func_233540_a_(itemstack, p_233541_1_) || itemstack.getCount() >= itemstack.getMaxStackSize())) continue;
            flag = true;
            break;
        }
        return flag;
    ...
    public String toString() {
        return this.inventoryContents.stream().filter(p_223371_0_ -> !p_223371_0_.isEmpty()).collect(Collectors.toList()).toString();
    }
    ...
    private void func_223372_c(ItemStack p_223372_1_) {
        for (int i = 0; i < this.slotsCount; ++i) {
            ...
            if (!p_223372_1_.isEmpty()) continue;
            return;
        }
    }
