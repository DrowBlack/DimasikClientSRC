...
extends Container {
    ...
    public void onContainerClosed(PlayerEntity playerIn) {
        ...
        this.field_234644_e_.consume((p_234647_2_, p_234647_3_) -> this.clearContainer(playerIn, (World)p_234647_2_, this.field_234643_d_));
    }

    @Override
    public boolean canInteractWith(PlayerEntity playerIn) {
        return this.field_234644_e_.applyOrElse((p_234646_2_, p_234646_3_) -> !this.func_230302_a_(p_234646_2_.getBlockState((BlockPos)p_234646_3_)) ? false : playerIn.getDistanceSq((double)p_234646_3_.getX() + 0.5, (double)p_234646_3_.getY() + 0.5, (double)p_234646_3_.getZ() + 0.5) <= 64.0, true);
    }
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 2) {
                ...
                if (index >= 3 && index < 39) {
                    int i;
                    int n = i = this.func_241210_a_(itemstack) ? 1 : 0;
