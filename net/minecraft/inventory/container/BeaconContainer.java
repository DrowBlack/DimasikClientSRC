...
extends Container {
    ...
    public BeaconContainer(int id, IInventory inventory, IIntArray p_i50100_3_, IWorldPosCallable worldPosCallable) {
        ...
        BeaconContainer.assertIntArraySize(p_i50100_3_, 3);
    ...
    public void onContainerClosed(PlayerEntity playerIn) {
        ...
        if (!playerIn.world.isRemote && !(itemstack = this.beaconSlot.decrStackSize(this.beaconSlot.getSlotStackLimit())).isEmpty()) {
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return BeaconContainer.isWithinUsableDistance(this.worldPosCallable, playerIn, Blocks.BEACON);
    }
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (!this.beaconSlot.getHasStack() && this.beaconSlot.isItemValid(itemstack1) && itemstack1.getCount() == 1 ? !this.mergeItemStack(itemstack1, 0, 1, false) : (index >= 1 && index < 28 ? !this.mergeItemStack(itemstack1, 28, 37, false) : (index >= 28 && index < 37 ? !this.mergeItemStack(itemstack1, 1, 28, false) : !this.mergeItemStack(itemstack1, 1, 37, false)))) {
                return ItemStack.EMPTY;
            }
