...
extends AbstractRepairContainer {
    ...
    protected ItemStack func_230301_a_(PlayerEntity p_230301_1_, ItemStack p_230301_2_) {
        ...
        this.field_234644_e_.consume((p_234633_1_, p_234633_2_) -> {
            BlockState blockstate = p_234633_1_.getBlockState((BlockPos)p_234633_2_);
            if (!p_230301_1_.abilities.isCreativeMode && blockstate.isIn(BlockTags.ANVIL) && p_230301_1_.getRNG().nextFloat() < 0.12f) {
                BlockState blockstate1 = AnvilBlock.damage(blockstate);
                if (blockstate1 == null) {
                    p_234633_1_.removeBlock((BlockPos)p_234633_2_, false);
                    p_234633_1_.playEvent(1029, (BlockPos)p_234633_2_, 0);
                } else {
                    p_234633_1_.setBlockState((BlockPos)p_234633_2_, blockstate1, 2);
                    p_234633_1_.playEvent(1030, (BlockPos)p_234633_2_, 0);
                }
            } else {
                p_234633_1_.playEvent(1030, (BlockPos)p_234633_2_, 0);
            }
    ...
    public void updateRepairOutput() {
        ...
        if (itemstack.isEmpty()) {
            ...
            if (!itemstack2.isEmpty()) {
                boolean flag;
                boolean bl = flag = itemstack2.getItem() == Items.ENCHANTED_BOOK && !EnchantedBookItem.getEnchantments(itemstack2).isEmpty();
