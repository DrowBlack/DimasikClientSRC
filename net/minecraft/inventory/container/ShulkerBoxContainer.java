...
extends Container {
    ...
    public ShulkerBoxContainer(int id, PlayerInventory playerInventory, IInventory inventory) {
        ...
        ShulkerBoxContainer.assertInventorySize(inventory, 27);
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index < this.inventory.getSizeInventory() ? !this.mergeItemStack(itemstack1, this.inventory.getSizeInventory(), this.inventorySlots.size(), true) : !this.mergeItemStack(itemstack1, 0, this.inventory.getSizeInventory(), false)) {
