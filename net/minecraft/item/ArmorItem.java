...
implements IArmorVanishable {
    ...
    public static boolean func_226626_a_(IBlockSource blockSource, ItemStack stack) {
        ...
        List<Entity> list = blockSource.getWorld().getEntitiesWithinAABB(LivingEntity.class, new AxisAlignedBB(blockpos), EntityPredicates.NOT_SPECTATING.and(new EntityPredicates.ArmoredMob(stack)));
        if (list.isEmpty()) {
            return false;
        }
