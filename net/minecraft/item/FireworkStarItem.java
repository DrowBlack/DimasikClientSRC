...
extends Item {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        if (compoundnbt != null) {
            FireworkStarItem.func_195967_a(compoundnbt, tooltip);
        }
    }
    ...
    public static void func_195967_a(CompoundNBT compound, List<ITextComponent> tooltip) {
        ...
        if (aint.length > 0) {
            tooltip.add(FireworkStarItem.func_200298_a_(new StringTextComponent("").mergeStyle(TextFormatting.GRAY), aint));
        }
        if ((aint1 = compound.getIntArray("FadeColors")).length > 0) {
            tooltip.add(FireworkStarItem.func_200298_a_(new TranslationTextComponent("item.minecraft.firework_star.fade_to").appendString(" ").mergeStyle(TextFormatting.GRAY), aint1));
        }
    ...
    private static ITextComponent func_200298_a_(IFormattableTextComponent p_200298_0_, int[] p_200298_1_) {
        for (int i = 0; i < p_200298_1_.length; ++i) {
            ...
            p_200298_0_.append(FireworkStarItem.func_200297_a(p_200298_1_[i]));
        }
        return p_200298_0_;
    }
