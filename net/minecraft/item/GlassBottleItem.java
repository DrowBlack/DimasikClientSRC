...
extends Item {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        List<AreaEffectCloudEntity> list = worldIn.getEntitiesWithinAABB(AreaEffectCloudEntity.class, playerIn.getBoundingBox().grow(2.0), p_210311_0_ -> p_210311_0_ != null && p_210311_0_.isAlive() && p_210311_0_.getOwner() instanceof EnderDragonEntity);
        ...
        BlockRayTraceResult raytraceresult = GlassBottleItem.rayTrace(worldIn, playerIn, RayTraceContext.FluidMode.SOURCE_ONLY);
