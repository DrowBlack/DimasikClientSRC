...
extends SpecialRecipe {
    ...
    public boolean matches(CraftingInventory inv, World worldIn) {
        ...
        for (int i = 0; i < inv.getSizeInventory(); ++i) {
            ...
            if (itemstack.getItem() == Blocks.RED_MUSHROOM.asItem() && !flag1) {
                flag1 = true;
                continue;
            }
            if (itemstack.getItem().isIn(ItemTags.SMALL_FLOWERS) && !flag) {
                flag = true;
                continue;
            }
    ...
    public ItemStack getCraftingResult(CraftingInventory inv) {
        ...
        for (int i = 0; i < inv.getSizeInventory(); ++i) {
            ...
            if (itemstack1.isEmpty() || !itemstack1.getItem().isIn(ItemTags.SMALL_FLOWERS)) continue;
