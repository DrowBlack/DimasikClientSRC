...
public class ConditionArrayParser {
    ...
    public final ILootCondition[] func_234050_a_(JsonArray p_234050_1_, String p_234050_2_, LootParameterSet p_234050_3_) {
        ILootCondition[] ailootcondition = this.field_234048_d_.fromJson((JsonElement)p_234050_1_, ILootCondition[].class);
        ValidationTracker validationtracker = new ValidationTracker(p_234050_3_, this.field_234047_c_::func_227517_a_, p_234052_0_ -> null);
        for (ILootCondition ilootcondition : ailootcondition) {
            ilootcondition.func_225580_a_(validationtracker);
            validationtracker.getProblems().forEach((p_234051_1_, p_234051_2_) -> field_234045_a_.warn("Found validation problem in advancement trigger {}/{}: {}", (Object)p_234050_2_, p_234051_1_, p_234051_2_));
        }
