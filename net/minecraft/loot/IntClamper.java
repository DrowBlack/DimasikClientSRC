...
implements IntUnaryOperator {
    ...
    private IntClamper(@Nullable Integer p_i51273_1_, @Nullable Integer p_i51273_2_) {
        ...
        if (p_i51273_1_ == null) {
            if (p_i51273_2_ == null) {
                this.field_215854_c = p_215845_0_ -> p_215845_0_;
            } else {
                int i = p_i51273_2_;
                this.field_215854_c = p_215844_1_ -> Math.min(i, p_215844_1_);
            }
        } else {
            int k = p_i51273_1_;
            if (p_i51273_2_ == null) {
                this.field_215854_c = p_215846_1_ -> Math.max(k, p_215846_1_);
            } else {
                int j = p_i51273_2_;
                this.field_215854_c = p_215847_2_ -> MathHelper.clamp(p_215847_2_, k, j);
            }
        }
    }
    ...
    public static IntClamper func_215848_a(int p_215848_0_) {
        return new IntClamper(p_215848_0_, null);
    }

    public static IntClamper func_215851_b(int p_215851_0_) {
        return new IntClamper(null, p_215851_0_);
    }
    ...
    JsonSerializer<IntClamper> {
        ...
        public IntClamper deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            Integer integer = jsonobject.has("min") ? Integer.valueOf(JSONUtils.getInt(jsonobject, "min")) : null;
            Integer integer1 = jsonobject.has("max") ? Integer.valueOf(JSONUtils.getInt(jsonobject, "max")) : null;
