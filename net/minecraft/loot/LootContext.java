...
public class LootContext {
    ...
    public static class Builder {
        ...
        public Builder withSeededRandom(long seed, Random p_216020_3_) {
            this.rand = seed == 0L ? p_216020_3_ : new Random(seed);
            return this;
        }
        ...
        public <T> T assertPresent(LootParameter<T> parameter) {
            Object t = this.lootParameters.get(parameter);
            if (t == null) {
        ...
        public LootContext build(LootParameterSet parameterSet) {
            Sets.SetView<LootParameter<?>> set = Sets.difference(this.lootParameters.keySet(), parameterSet.getAllParameters());
            if (!set.isEmpty()) {
                throw new IllegalArgumentException("Parameters not allowed in this parameter set: " + String.valueOf(set));
            }
            Sets.SetView<LootParameter<?>> set1 = Sets.difference(parameterSet.getRequiredParameters(), this.lootParameters.keySet());
            if (!set1.isEmpty()) {
            ...
            MinecraftServer minecraftserver = LootContext.getServer(this.world);
            LootTableManager lootTableManager1 = LootContext.getLootTableManager(minecraftserver);
            LootPredicateManager LootPredicateManager2 = LootContext.getLootPredicateManager(minecraftserver);
            return new LootContext(random, this.luck, this.world, lootTableManager1::getLootTableFromLocation, LootPredicateManager2::func_227517_a_, this.lootParameters, this.field_216026_c);
        }
    }
}
