...
public class ValidationTracker {
    ...
    public ValidationTracker(LootParameterSet p_i225889_1_, Function<ResourceLocation, ILootCondition> p_i225889_2_, Function<ResourceLocation, LootTable> p_i225889_3_) {
        this(HashMultimap.create(), () -> "", p_i225889_1_, p_i225889_2_, ImmutableSet.of(), p_i225889_3_, ImmutableSet.of());
    }
    ...
    public ValidationTracker func_227534_b_(String p_227534_1_) {
        return new ValidationTracker(this.field_227519_a_, () -> this.func_227533_b_() + p_227534_1_, this.field_227521_c_, this.field_227522_d_, this.field_227523_e_, this.field_227524_f_, this.field_227525_g_);
    }

    public ValidationTracker func_227531_a_(String p_227531_1_, ResourceLocation p_227531_2_) {
        ImmutableCollection immutableset = ((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().addAll(this.field_227525_g_)).add(p_227531_2_)).build();
        return new ValidationTracker(this.field_227519_a_, () -> this.func_227533_b_() + p_227531_1_, this.field_227521_c_, this.field_227522_d_, this.field_227523_e_, this.field_227524_f_, (Set<ResourceLocation>)((Object)immutableset));
    }

    public ValidationTracker func_227535_b_(String p_227535_1_, ResourceLocation p_227535_2_) {
        ImmutableCollection immutableset = ((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().addAll(this.field_227523_e_)).add(p_227535_2_)).build();
        return new ValidationTracker(this.field_227519_a_, () -> this.func_227533_b_() + p_227535_1_, this.field_227521_c_, this.field_227522_d_, (Set<ResourceLocation>)((Object)immutableset), this.field_227524_f_, this.field_227525_g_);
    }
