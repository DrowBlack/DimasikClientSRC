...
implements ILootCondition {
    ...
    public static Builder builder(ILootCondition.IBuilder ... buildersIn) {
        return new Builder(buildersIn);
    }
    ...
    implements ILootCondition.IBuilder {
        ...
        @Override
        public Builder alternative(ILootCondition.IBuilder builderIn) {
