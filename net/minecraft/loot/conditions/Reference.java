...
implements ILootCondition {
    ...
    public void func_225580_a_(ValidationTracker p_225580_1_) {
        if (p_225580_1_.func_227536_b_(this.field_227562_b_)) {
            p_225580_1_.addProblem("Condition " + String.valueOf(this.field_227562_b_) + " is recursively called");
        } else {
            ...
            if (ilootcondition == null) {
                p_225580_1_.addProblem("Unknown condition table called " + String.valueOf(this.field_227562_b_));
            } else {
                ilootcondition.func_225580_a_(p_225580_1_.func_227531_a_(".{" + String.valueOf(this.field_227562_b_) + "}", this.field_227562_b_));
            }
        }
    }
