...
extends LootFunction {
    ...
    private ApplyBonus(ILootCondition[] conditionsIn, Enchantment enchantmentIn, IFormula p_i51246_3_) {
        super(conditionsIn);
    ...
    public static LootFunction.Builder<?> binomialWithBonusCount(Enchantment p_215870_0_, float p_215870_1_, int p_215870_2_) {
        return ApplyBonus.builder(p_215864_3_ -> new ApplyBonus((ILootCondition[])p_215864_3_, p_215870_0_, new BinomialWithBonusCountFormula(p_215870_2_, p_215870_1_)));
    }

    public static LootFunction.Builder<?> oreDrops(Enchantment p_215869_0_) {
        return ApplyBonus.builder(p_215866_1_ -> new ApplyBonus((ILootCondition[])p_215866_1_, p_215869_0_, new OreDropsFormula()));
    }

    public static LootFunction.Builder<?> uniformBonusCount(Enchantment p_215871_0_) {
        return ApplyBonus.builder(p_215872_1_ -> new ApplyBonus((ILootCondition[])p_215872_1_, p_215871_0_, new UniformBonusCountFormula(1)));
    }

    public static LootFunction.Builder<?> uniformBonusCount(Enchantment p_215865_0_, int p_215865_1_) {
        return ApplyBonus.builder(p_215868_2_ -> new ApplyBonus((ILootCondition[])p_215868_2_, p_215865_0_, new UniformBonusCountFormula(p_215865_1_)));
    }
    ...
    implements IFormula {
        ...
        public void func_216202_a(JsonObject p_216202_1_, JsonSerializationContext p_216202_2_) {
            ...
            p_216202_1_.addProperty("probability", Float.valueOf(this.probability));
        }
    ...
    extends LootFunction.Serializer<ApplyBonus> {
        ...
        public ApplyBonus deserialize(JsonObject object, JsonDeserializationContext deserializationContext, ILootCondition[] conditionsIn) {
            ...
            Enchantment enchantment = Registry.ENCHANTMENT.getOptional(resourcelocation).orElseThrow(() -> new JsonParseException("Invalid enchantment id: " + String.valueOf(resourcelocation)));
            ResourceLocation resourcelocation1 = new ResourceLocation(JSONUtils.getString(object, "formula"));
            IFormulaDeserializer applybonus$iformuladeserializer = field_215875_a.get(resourcelocation1);
            if (applybonus$iformuladeserializer == null) {
                throw new JsonParseException("Invalid formula id: " + String.valueOf(resourcelocation1));
            }
            IFormula applybonus$iformula = object.has("parameters") ? applybonus$iformuladeserializer.deserialize(JSONUtils.getJsonObject(object, "parameters"), deserializationContext) : applybonus$iformuladeserializer.deserialize(new JsonObject(), deserializationContext);
