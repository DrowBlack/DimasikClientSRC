...
extends LootFunction {
    ...
    public void func_225580_a_(ValidationTracker p_225580_1_) {
        if (p_225580_1_.func_227532_a_(this.field_215928_a)) {
            p_225580_1_.addProblem("Table " + String.valueOf(this.field_215928_a) + " is recursively called");
        } else {
            super.func_225580_a_(p_225580_1_);
            LootTable loottable = p_225580_1_.func_227539_c_(this.field_215928_a);
            if (loottable == null) {
                p_225580_1_.addProblem("Unknown loot table called " + String.valueOf(this.field_215928_a));
            } else {
                loottable.validate(p_225580_1_.func_227531_a_("->{" + String.valueOf(this.field_215928_a) + "}", this.field_215928_a));
            }
        }
    }
