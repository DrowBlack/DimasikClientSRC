...
implements INBT {
    public static final Codec<CompoundNBT> CODEC = Codec.PASSTHROUGH.comapFlatMap(dynamic -> {
        ...
        return inbt instanceof CompoundNBT ? DataResult.success((CompoundNBT)inbt) : DataResult.error("Not a compound tag: " + String.valueOf(inbt));
    }, nbt -> new Dynamic<CompoundNBT>(NBTDynamicOps.INSTANCE, (CompoundNBT)nbt));
    ...
    public static final INBTType<CompoundNBT> TYPE = new INBTType<CompoundNBT>(){
        ...
        public CompoundNBT readNBT(DataInput input, int depth, NBTSizeTracker accounter) throws IOException {
            ...
            HashMap<String, INBT> map = Maps.newHashMap();
    ...
    public void write(DataOutput output) throws IOException {
        for (String s : this.tagMap.keySet()) {
            ...
            CompoundNBT.writeEntry(s, inbt, output);
        }
        output.writeByte(0);
    }
    ...
    public String toString() {
        ...
        for (String s : collection) {
            ...
            stringbuilder.append(CompoundNBT.handleEscape(s)).append(':').append(this.tagMap.get(s));
        }
    ...
    private CrashReport generateCrashReport(String tagName, INBTType<?> type, ClassCastException exception) {
        ...
        crashreportcategory.addDetail("Tag type found", () -> this.tagMap.get(tagName).getType().getName());
    ...
    public CompoundNBT copy() {
        HashMap<String, INBT> map = Maps.newHashMap(Maps.transformValues(this.tagMap, INBT::copy));
        return new CompoundNBT(map);
    }
    ...
    protected static ITextComponent getNameComponent(String name) {
        ...
        IFormattableTextComponent itextcomponent = new StringTextComponent(s.substring(1, s.length() - 1)).mergeStyle(SYNTAX_HIGHLIGHTING_KEY);
    ...
    public ITextComponent toFormattedComponent(String indentation, int indentDepth) {
        ...
        while (iterator.hasNext()) {
            ...
            IFormattableTextComponent iformattabletextcomponent1 = new StringTextComponent(Strings.repeat(indentation, indentDepth + 1)).append(CompoundNBT.getNameComponent(s)).appendString(String.valueOf(':')).appendString(" ").append(this.tagMap.get(s).toFormattedComponent(indentation, indentDepth + 1));
            if (iterator.hasNext()) {
