...
implements INBT {
    ...
    public ITextComponent toFormattedComponent(String indentation, int indentDepth) {
        String s = StringNBT.quoteAndEscape(this.data);
        String s1 = s.substring(0, 1);
        IFormattableTextComponent itextcomponent = new StringTextComponent(s.substring(1, s.length() - 1)).mergeStyle(SYNTAX_HIGHLIGHTING_STRING);
