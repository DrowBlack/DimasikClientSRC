        ...
        switch (packetIn.getRequestedState()) {
            case LOGIN: {
                ...
                if (packetIn.getProtocolVersion() != SharedConstants.getVersion().getProtocolVersion()) {
                    TranslationTextComponent itextcomponent = packetIn.getProtocolVersion() < 754 ? new TranslationTextComponent("multiplayer.disconnect.outdated_client", SharedConstants.getVersion().getName()) : new TranslationTextComponent("multiplayer.disconnect.incompatible", SharedConstants.getVersion().getName());
