...
implements IPacket<IServerPlayNetHandler> {
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        this.field_218793_d = buf.readString(Short.MAX_VALUE);
        this.field_240850_f_ = JigsawTileEntity.OrientationType.func_235673_a_(buf.readString(Short.MAX_VALUE)).orElse(JigsawTileEntity.OrientationType.ALIGNED);
    }
