...
implements IPacket<IClientPlayNetHandler> {
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        for (int i = 0; i < this.icons.length; ++i) {
            ...
            this.icons[i] = new MapDecoration(mapdecoration$type, buf.readByte(), buf.readByte(), (byte)(buf.readByte() & 0xF), buf.readBoolean() ? buf.readTextComponent() : null);
        }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException {
        ...
        for (MapDecoration mapdecoration : this.icons) {
            ...
            buf.writeByte(mapdecoration.getRotation() & 0xF);
