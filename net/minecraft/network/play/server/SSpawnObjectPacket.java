...
implements IPacket<IClientPlayNetHandler> {
    ...
    public SSpawnObjectPacket(int entityId, UUID uuid, double xPos, double yPos, double zPos, float pitch, float yaw, EntityType<?> entityType, int entityData, Vector3d speedVector) {
        ...
        this.speedX = (int)(MathHelper.clamp(speedVector.x, -3.9, 3.9) * 8000.0);
        this.speedY = (int)(MathHelper.clamp(speedVector.y, -3.9, 3.9) * 8000.0);
        this.speedZ = (int)(MathHelper.clamp(speedVector.z, -3.9, 3.9) * 8000.0);
    }
    ...
    public SSpawnObjectPacket(Entity entity, EntityType<?> entityType, int entityData, BlockPos pos) {
        this(entity.getEntityId(), entity.getUniqueID(), pos.getX(), pos.getY(), pos.getZ(), entity.rotationPitch, entity.rotationYaw, entityType, entityData, entity.getMotion());
    }
