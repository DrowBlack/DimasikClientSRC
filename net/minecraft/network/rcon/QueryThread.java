...
extends RConThread {
    ...
    public static QueryThread func_242129_a(IServer p_242129_0_) {
        ...
        field_232648_d_.warn("Invalid query port {} found in server.properties (queries disabled)", (Object)i);
        return null;
    }
    ...
    private boolean parseIncomingPacket(DatagramPacket requestPacket) throws IOException {
        ...
        field_232648_d_.debug("Packet len {} [{}]", (Object)i, (Object)socketaddress);
        if (3 <= i && -2 == abyte[0] && -3 == abyte[1]) {
            field_232648_d_.debug("Packet '{}' [{}]", (Object)RConUtils.getByteAsHexString(abyte[2]), (Object)socketaddress);
            switch (abyte[2]) {
                case 0: {
    ...
    private byte[] createQueryResponse(DatagramPacket requestPacket) throws IOException {
        ...
        this.output.writeInt(0);
        for (String s : astring = this.field_232649_r_.getOnlinePlayerNames()) {
    ...
    private void sendAuthChallenge(DatagramPacket requestPacket) throws IOException {
        Auth querythread$auth = new Auth(requestPacket);
    ...
    private void cleanQueryClientsMap() {
        long i;
        if (this.running && (i = Util.milliTime()) >= this.lastAuthCheckTime + 30000L) {
            this.lastAuthCheckTime = i;
            this.queryClients.values().removeIf(p_232650_2_ -> p_232650_2_.hasExpired(i));
        }
    }
