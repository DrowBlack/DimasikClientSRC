...
implements IParticleData {
    ...
    public static Codec<ItemParticleData> func_239809_a_(ParticleType<ItemParticleData> p_239809_0_) {
        return ItemStack.CODEC.xmap(p_239810_1_ -> new ItemParticleData(p_239809_0_, (ItemStack)p_239810_1_), p_239808_0_ -> p_239808_0_.itemStack);
    }
    ...
    public String getParameters() {
        return String.valueOf(Registry.PARTICLE_TYPE.getKey(this.getType())) + " " + new ItemInput(this.itemStack.getItem(), this.itemStack.getTag()).serialize();
    }
