...
extends WalkNodeProcessor {
    ...
    public FlaggedPathPoint func_224768_a(double p_224768_1_, double p_224768_3_, double p_224768_5_) {
        return new FlaggedPathPoint(this.openPoint(MathHelper.floor(p_224768_1_), MathHelper.floor(p_224768_3_ + 0.5), MathHelper.floor(p_224768_5_)));
    }
    ...
    public int func_222859_a(PathPoint[] p_222859_1_, PathPoint p_222859_2_) {
        ...
        if (flag && flag3 && (pathpoint6 = this.func_203245_a(p_222859_2_.x - 1, p_222859_2_.y, p_222859_2_.z - 1, 1, d0)) != null && !pathpoint6.visited) {
            p_222859_1_[i++] = pathpoint6;
        }
        if (flag && flag2 && (pathpoint7 = this.func_203245_a(p_222859_2_.x + 1, p_222859_2_.y, p_222859_2_.z - 1, 1, d0)) != null && !pathpoint7.visited) {
            p_222859_1_[i++] = pathpoint7;
        }
        if (flag1 && flag3 && (pathpoint8 = this.func_203245_a(p_222859_2_.x - 1, p_222859_2_.y, p_222859_2_.z + 1, 1, d0)) != null && !pathpoint8.visited) {
            p_222859_1_[i++] = pathpoint8;
        }
        if (flag1 && flag2 && (pathpoint9 = this.func_203245_a(p_222859_2_.x + 1, p_222859_2_.y, p_222859_2_.z + 1, 1, d0)) != null && !pathpoint9.visited) {
    ...
    private double func_203246_a(BlockPos p_203246_1_) {
        if (!this.entity.isInWater()) {
            ...
            return (double)blockpos.getY() + (voxelshape.isEmpty() ? 0.0 : voxelshape.getEnd(Direction.Axis.Y));
        }
    ...
    private PathPoint func_203245_a(int p_203245_1_, int p_203245_2_, int p_203245_3_, int p_203245_4_, double p_203245_5_) {
        ...
        double d1 = (double)this.entity.getWidth() / 2.0;
        if (f >= 0.0f) {
        ...
        if (pathnodetype != PathNodeType.WATER && pathnodetype != PathNodeType.WALKABLE) {
            ...
            if (pathnodetype == PathNodeType.OPEN) {
                AxisAlignedBB axisalignedbb = new AxisAlignedBB((double)p_203245_1_ - d1 + 0.5, (double)p_203245_2_ + 0.001, (double)p_203245_3_ - d1 + 0.5, (double)p_203245_1_ + d1 + 0.5, (float)p_203245_2_ + this.entity.getHeight(), (double)p_203245_3_ + d1 + 0.5);
    ...
    public PathNodeType getPathNodeType(IBlockReader blockaccessIn, int x, int y, int z) {
        ...
        PathNodeType pathnodetype = WalkAndSwimNodeProcessor.func_237238_b_(blockaccessIn, blockpos$mutable.setPos(x, y, z));
        if (pathnodetype == PathNodeType.WATER) {
            for (Direction direction : Direction.values()) {
                PathNodeType pathnodetype2 = WalkAndSwimNodeProcessor.func_237238_b_(blockaccessIn, blockpos$mutable.setPos(x, y, z).move(direction));
        ...
        if (pathnodetype == PathNodeType.OPEN && y >= 1) {
            ...
            PathNodeType pathnodetype1 = WalkAndSwimNodeProcessor.func_237238_b_(blockaccessIn, blockpos$mutable.setPos(x, y - 1, z));
        ...
        if (pathnodetype == PathNodeType.WALKABLE) {
            pathnodetype = WalkAndSwimNodeProcessor.func_237232_a_(blockaccessIn, blockpos$mutable.setPos(x, y, z), pathnodetype);
        }
        return pathnodetype;
    }
}
