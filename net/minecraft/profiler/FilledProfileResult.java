...
implements IProfileResult {
    ...
    private static final Comparator<Map.Entry<String, Section>> field_230092_d_ = Map.Entry.comparingByValue(Comparator.comparingLong(p_230096_0_ -> p_230096_0_.field_230108_b_)).reversed();
    ...
    public List<DataPoint> getDataPoints(String sectionPath) {
        ...
        IProfilerSection iprofilersection1 = this.func_230104_c_((String)sectionPath);
        ...
        for (String s1 : this.field_230093_e_.keySet()) {
            if (!FilledProfileResult.func_230097_a_((String)sectionPath, s1)) continue;
        ...
        for (String s2 : this.field_230093_e_.keySet()) {
            if (!FilledProfileResult.func_230097_a_((String)sectionPath, s2)) continue;
        ...
        if ((float)l > f) {
            list.add(new DataPoint("unspecified", (double)((float)l - f) * 100.0 / (double)l, (double)((float)l - f) * 100.0 / (double)i, k));
        }
        Collections.sort(list);
        list.add(0, new DataPoint(s, 100.0, (double)l * 100.0 / (double)i, k));
        return list;
    }
    ...
    private Map<String, Section> func_230106_h_() {
        TreeMap<String, Section> map = Maps.newTreeMap();
        this.field_230093_e_.forEach((p_230101_1_, p_230101_2_) -> {
            Object2LongMap<String> object2longmap = p_230101_2_.func_230039_c_();
            if (!object2longmap.isEmpty()) {
                List<String> list = field_230091_c_.splitToList((CharSequence)p_230101_1_);
                object2longmap.forEach((p_230103_2_, p_230103_3_) -> map.computeIfAbsent((String)p_230103_2_, p_230105_0_ -> new Section()).func_230112_a_(list.iterator(), (long)p_230103_3_));
            }
        });
        return map;
    }
    ...
    public boolean writeToFile(File p_219919_1_) {
        ...
        try {
            ...
            boolean flag;
            try {
                LOGGER.error("Could not save profiler results to {}", (Object)p_219919_1_, (Object)throwable);
                flag = false;
            }
    ...
    private void format(int p_219928_1_, String p_219928_2_, StringBuilder p_219928_3_) {
        ...
        object2longmap.forEach((p_230100_3_, p_230100_4_) -> FilledProfileResult.func_230098_a_(p_219928_3_, p_219928_1_).append('#').append((String)p_230100_3_).append(' ').append(p_230100_4_).append('/').append(p_230100_4_ / (long)this.ticksTotal).append('\n'));
        if (list.size() >= 3) {
            for (int i = 1; i < list.size(); ++i) {
                DataPoint datapoint = list.get(i);
                FilledProfileResult.func_230098_a_(p_219928_3_, p_219928_1_).append(datapoint.name).append('(').append(datapoint.field_223511_c).append('/').append(String.format(Locale.ROOT, "%.0f", Float.valueOf((float)datapoint.field_223511_c / (float)this.ticksTotal))).append(')').append(" - ").append(String.format(Locale.ROOT, "%.2f", datapoint.relTime)).append("%/").append(String.format(Locale.ROOT, "%.2f", datapoint.rootRelTime)).append("%\n");
    ...
    private void func_230095_a_(int p_230095_1_, String p_230095_2_, Section p_230095_3_, int p_230095_4_, StringBuilder p_230095_5_) {
        FilledProfileResult.func_230098_a_(p_230095_5_, p_230095_1_).append(p_230095_2_).append(" total:").append(p_230095_3_.field_230107_a_).append('/').append(p_230095_3_.field_230108_b_).append(" average: ").append(p_230095_3_.field_230107_a_ / (long)p_230095_4_).append('/').append(p_230095_3_.field_230108_b_ / (long)p_230095_4_).append('\n');
        p_230095_3_.field_230109_c_.entrySet().stream().sorted(field_230092_d_).forEach(p_230094_4_ -> this.func_230095_a_(p_230095_1_ + 1, (String)p_230094_4_.getKey(), (Section)p_230094_4_.getValue(), p_230095_4_, p_230095_5_));
    }

    private void func_230102_a_(Map<String, Section> p_230102_1_, StringBuilder p_230102_2_, int p_230102_3_) {
    ...
    static class Section {
        ...
        public void func_230112_a_(Iterator<String> p_230112_1_, long p_230112_2_) {
            ...
            if (!p_230112_1_.hasNext()) {
                ...
                this.field_230109_c_.computeIfAbsent(p_230112_1_.next(), p_230111_0_ -> new Section()).func_230112_a_(p_230112_1_, p_230112_2_);
            }
        }
    }
}
