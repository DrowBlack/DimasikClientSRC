...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, this.height / 2 + this.field_230717_q_ / 2 + 9, 200, 20, DialogTexts.GUI_BACK, p_239547_2_ -> minecraft.displayGuiScreen(this.field_230716_p_)));
    }
