        ...
        if (flag2) {
            ...
            if (flag) {
                ...
                if (realmsserveraddress1.field_230602_b_ != null && realmsserveraddress1.field_230603_c_ != null) {
                    TranslationTextComponent itextcomponent = new TranslationTextComponent("mco.configure.world.resourcepack.question.line1");
                    TranslationTextComponent itextcomponent1 = new TranslationTextComponent("mco.configure.world.resourcepack.question.line2");
                    ConnectingToRealmsAction.func_238127_a_(new RealmsLongConfirmationScreen(p_238121_2_ -> {
                        try {
                            if (p_238121_2_) {
                                ...
                                try {
                                    ((CompletableFuture)Minecraft.getInstance().getPackFinder().downloadResourcePack(realmsserveraddress1.field_230602_b_, realmsserveraddress1.field_230603_c_).thenRun(() -> this.func_224987_a(new RealmsLongRunningMcoTaskScreen(this.field_238117_d_, new ConnectedToRealmsAction(this.field_238117_d_, this.field_238116_c_, realmsserveraddress1))))).exceptionally(function);
                                }
