...
implements AutoCloseable {
     ...
     */
    @Nullable
    public static ResourcePackInfo createResourcePack(String nameIn, boolean p_195793_1_, Supplier<IResourcePack> p_195793_2_, IFactory factory, Priority p_195793_4_, IPackNameDecorator p_195793_5_) {
        try (IResourcePack iresourcepack = p_195793_2_.get();){
            ...
            if (packmetadatasection != null) {
                ResourcePackInfo resourcePackInfo = factory.create(nameIn, p_195793_1_, p_195793_2_, iresourcepack, packmetadatasection, p_195793_4_, p_195793_5_);
    ...
    public ITextComponent getChatLink(boolean p_195794_1_) {
        return TextComponentUtils.wrapWithSquareBrackets(this.decorator.decorate(new StringTextComponent(this.name))).modifyStyle(p_211689_2_ -> p_211689_2_.setFormatting(p_195794_1_ ? TextFormatting.GREEN : TextFormatting.RED).setInsertion(StringArgumentType.escapeIfRequired(this.name)).setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new StringTextComponent("").append(this.title).appendString("\n").append(this.description))));
    }
    ...
    public static enum Priority {
        ...
        public <T> int insert(List<T> p_198993_1_, T p_198993_2_, Function<T, ResourcePackInfo> p_198993_3_, boolean p_198993_4_) {
            ...
            Priority priority = resourcepackinfo$priority = p_198993_4_ ? this.opposite() : this;
            if (resourcepackinfo$priority == BOTTOM) {
                ResourcePackInfo resourcepackinfo1;
                int j;
                for (j = 0; j < p_198993_1_.size() && (resourcepackinfo1 = p_198993_3_.apply(p_198993_1_.get(j))).isOrderLocked() && resourcepackinfo1.getPriority() == this; ++j) {
                }
                p_198993_1_.add(j, p_198993_2_);
                return j;
            }
            for (i = p_198993_1_.size() - 1; i >= 0 && (resourcepackinfo = p_198993_3_.apply(p_198993_1_.get(i))).isOrderLocked() && resourcepackinfo.getPriority() == this; --i) {
            }
