...
public class ScoreCriteria {
    ...
    public ScoreCriteria(String p_i47676_1_) {
        this(p_i47676_1_, false, RenderType.INTEGER);
    }

    protected ScoreCriteria(String p_i47677_1_, boolean p_i47677_2_, RenderType p_i47677_3_) {
    ...
    public static Optional<ScoreCriteria> func_216390_a(String p_216390_0_) {
        ...
        return i < 0 ? Optional.empty() : Registry.STATS.getOptional(ResourceLocation.create(p_216390_0_.substring(0, i), '.')).flatMap(p_216392_2_ -> ScoreCriteria.func_216391_a(p_216392_2_, ResourceLocation.create(p_216390_0_.substring(i + 1), '.')));
    }
    ...
    public static enum RenderType {
        ...
        public static RenderType byId(String p_211839_0_) {
        ...
        static {
            ...
            for (RenderType scorecriteria$rendertype : RenderType.values()) {
