...
public class Main {
    ...
    public static void main(String[] p_main_0_) {
        ...
        try {
            ...
            if (optionset.has(optionspec4)) {
                Main.func_240761_a_(saveformat$levelsave, DataFixesManager.getDataFixer(), optionset.has(optionspec5), () -> true, iserverconfiguration.getDimensionGeneratorSettings().func_236226_g_());
            }
            ...
            final DedicatedServer dedicatedserver = MinecraftServer.func_240784_a_(p_240762_16_ -> {
                boolean flag1;
                DedicatedServer dedicatedserver1 = new DedicatedServer((Thread)p_240762_16_, dynamicregistries$impl, saveformat$levelsave, resourcepacklist, datapackregistries, iserverconfiguration1, serverpropertiesprovider, DataFixesManager.getDataFixer(), minecraftsessionservice, gameprofilerepository, playerprofilecache, LoggingChunkStatusListener::new);
                dedicatedserver1.setServerOwner((String)optionset.valueOf(optionspec8));
                dedicatedserver1.setServerPort((Integer)optionset.valueOf(optionspec11));
                dedicatedserver1.setDemo(optionset.has(optionspec2));
                dedicatedserver1.setServerId((String)optionset.valueOf(optionspec12));
    ...
    private static void func_240761_a_(SaveFormat.LevelSave p_240761_0_, DataFixer p_240761_1_, boolean p_240761_2_, BooleanSupplier p_240761_3_, ImmutableSet<RegistryKey<World>> p_240761_4_) {
        ...
        while (!worldoptimizer.isFinished()) {
            ...
            if ((i = worldoptimizer.getTotalChunks()) > 0) {
                int j = worldoptimizer.getConverted() + worldoptimizer.getSkipped();
                field_240759_a_.info("{}% completed ({} / {} chunks)...", (Object)MathHelper.floor((float)j / (float)i * 100.0f), (Object)j, (Object)i);
            }
