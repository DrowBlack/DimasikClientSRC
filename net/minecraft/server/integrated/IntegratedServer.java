...
extends MinecraftServer {
    ...
    public CrashReport addServerInfoToCrashReport(CrashReport report) {
        ...
        report.getCategory().addDetail("Is Modded", () -> this.func_230045_q_().orElse("Probably not. Jar signature remains and both client + server brands are untouched."));
        return report;
    }
    ...
    public boolean shareToLAN(GameType gameMode, boolean cheats, int port) {
        try {
            this.getNetworkSystem().addEndpoint(null, port);
