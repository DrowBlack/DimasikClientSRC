...
public abstract class Property<T extends Comparable<T>> {
    ...
    private final Codec<T> field_235916_d_ = Codec.STRING.comapFlatMap(p_lambda$new$1_1_ -> this.parseValue((String)p_lambda$new$1_1_).map(DataResult::success).orElseGet(() -> DataResult.error("Unable to read property: " + String.valueOf(this) + " with value: " + p_lambda$new$1_1_)), this::getName);
    ...
    public ValuePair<T> func_241490_b_(T p_241490_1_) {
        return new ValuePair<T>(this, p_241490_1_);
    }

    public ValuePair<T> func_241489_a_(StateHolder<?, ?> p_241489_1_) {
        return new ValuePair(this, p_241489_1_.get(this));
    }
    ...
    public static final class ValuePair<T extends Comparable<T>> {
        ...
        public boolean equals(Object p_equals_1_) {
            ...
            if (!(p_equals_1_ instanceof ValuePair)) {
                return false;
            }
            ValuePair valuepair = (ValuePair)p_equals_1_;
