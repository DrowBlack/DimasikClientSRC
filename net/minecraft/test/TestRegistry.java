...
public class TestRegistry {
    ...
    public static Collection<TestFunctionInfo> func_229530_a_(String p_229530_0_) {
        return field_229526_a_.stream().filter(p_229535_1_ -> TestRegistry.func_229532_a_(p_229535_1_, p_229530_0_)).collect(Collectors.toList());
    }
    ...
    public static Optional<TestFunctionInfo> func_229537_d_(String p_229537_0_) {
        return TestRegistry.func_229529_a_().stream().filter(p_229531_1_ -> p_229531_1_.func_229657_a_().equalsIgnoreCase(p_229537_0_)).findFirst();
    }

    public static TestFunctionInfo func_229538_e_(String p_229538_0_) {
        Optional<TestFunctionInfo> optional = TestRegistry.func_229537_d_(p_229538_0_);
