...
public class TestTracker {
    ...
    public void func_229507_b_() {
        if (!this.func_229518_k_()) {
            ...
            if (this.field_229496_i_ >= 0L) {
                ...
                Iterator objectiterator = this.field_229494_g_.object2LongEntrySet().iterator();
                ...
                if (this.field_229496_i_ > (long)this.field_229492_e_) {
                    if (this.field_229493_f_.isEmpty()) {
                        ...
                        this.field_229493_f_.forEach(p_229509_1_ -> p_229509_1_.func_229568_b_(this.field_229496_i_));
                        if (this.field_229500_m_ == null) {
                            this.func_229506_a_(new TestTimeoutException("No sequences finished"));
                        }
                    }
                } else {
                    this.field_229493_f_.forEach(p_229505_1_ -> p_229505_1_.func_229567_a_(this.field_229496_i_));
                }
            }
        }
    }
    ...
    public void func_229506_a_(Throwable p_229506_1_) {
        ...
        this.field_229491_d_.forEach(p_229511_1_ -> p_229511_1_.func_225645_c_(this));
    }
    ...
    public void func_240543_a_(BlockPos p_240543_1_, int p_240543_2_) {
        ...
        this.field_229491_d_.forEach(p_229508_1_ -> p_229508_1_.func_225644_a_(this));
    }
