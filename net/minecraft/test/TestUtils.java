...
public class TestUtils {
    ...
    public static Collection<TestTracker> func_240554_b_(Collection<TestFunctionInfo> p_240554_0_, BlockPos p_240554_1_, Rotation p_240554_2_, ServerWorld p_240554_3_, TestCollection p_240554_4_, int p_240554_5_) {
        return TestUtils.func_240552_a_(TestUtils.func_229548_a_(p_240554_0_), p_240554_1_, p_240554_2_, p_240554_3_, p_240554_4_, p_240554_5_);
    }
    ...
    public static Collection<TestBatch> func_229548_a_(Collection<TestFunctionInfo> p_229548_0_) {
        ...
        return map.keySet().stream().flatMap(p_229550_1_ -> {
            ...
            return Streams.stream(Iterables.partition(collection, 100)).map(p_240551_4_ -> new TestBatch(p_229550_1_ + ":" + mutableint.incrementAndGet(), collection, consumer));
    ...
    private static void func_229563_c_(TestTracker p_229563_0_) {
        ...
        TestUtils.func_229556_a_(p_229563_0_.func_229514_g_(), p_229563_0_.func_229520_q_() ? TextFormatting.RED : TextFormatting.YELLOW, s);
        if (throwable instanceof TestBlockPosException) {
            TestBlockPosException testblockposexception = (TestBlockPosException)throwable;
            TestUtils.func_229554_a_(p_229563_0_.func_229514_g_(), testblockposexception.func_229459_c_(), testblockposexception.func_229458_a_());
        }
    ...
    private static void func_229560_b_(TestTracker p_229560_0_, String p_229560_1_) {
        ...
        ItemStack itemstack = TestUtils.func_229546_a_(p_229560_0_.func_229510_c_(), p_229560_0_.func_229520_q_(), p_229560_1_);
    ...
    private static void func_229556_a_(ServerWorld p_229556_0_, TextFormatting p_229556_1_, String p_229556_2_) {
        p_229556_0_.getPlayers(p_229557_0_ -> true).forEach(p_229544_2_ -> p_229544_2_.sendMessage(new StringTextComponent(p_229556_2_).mergeStyle(p_229556_1_), Util.DUMMY_UUID));
    }
    ...
    public static void func_229555_a_(ServerWorld p_229555_0_, BlockPos p_229555_1_, TestCollection p_229555_2_, int p_229555_3_) {
        ...
        BlockPos.getAllInBox(blockpos, blockpos1).filter(p_229562_1_ -> p_229555_0_.getBlockState((BlockPos)p_229562_1_).isIn(Blocks.STRUCTURE_BLOCK)).forEach(p_229553_1_ -> {
            StructureBlockTileEntity structureblocktileentity = (StructureBlockTileEntity)p_229555_0_.getTileEntity((BlockPos)p_229553_1_);
