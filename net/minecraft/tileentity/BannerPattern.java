...
public enum BannerPattern {
    ...
    static {
        ...
        BANNERS_WITH_ITEMS = (int)Arrays.stream(BANNER_PATTERNS).filter(pattern -> pattern.hasPatternItem).count();
    ...
    public static class Builder {
        ...
        public Builder setPatternWithColor(BannerPattern pattern, DyeColor color) {
