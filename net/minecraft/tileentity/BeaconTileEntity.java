...
ITickableTileEntity {
    ...
    public void tick() {
        ...
        BeamSegment beacontileentity$beamsegment = this.beamColorSegments.isEmpty() ? null : this.beamColorSegments.get(this.beamColorSegments.size() - 1);
        ...
        for (int i1 = 0; i1 < 10 && blockpos.getY() <= l; ++i1) {
            ...
            if (block instanceof IBeaconBeamColorProvider) {
                float[] afloat = ((IBeaconBeamColorProvider)((Object)block)).getColor().getColorComponentValues();
        ...
        if (this.beaconSize >= l) {
            ...
            if (!this.world.isRemote) {
                ...
                if (!flag && flag1) {
                    ...
                    for (ServerPlayerEntity serverplayerentity : this.world.getEntitiesWithinAABB(ServerPlayerEntity.class, new AxisAlignedBB(i, j, k, i, j - 4, k).grow(10.0, 5.0, 10.0))) {
    ...
    private void addEffectsToPlayers() {
        if (!this.world.isRemote && this.primaryEffect != null) {
            ...
            AxisAlignedBB axisalignedbb = new AxisAlignedBB(this.pos).grow(d0).expand(0.0, this.world.getHeight(), 0.0);
    ...
    public void read(BlockState state, CompoundNBT nbt) {
        ...
        this.primaryEffect = BeaconTileEntity.isBeaconEffect(nbt.getInt("Primary"));
        this.secondaryEffect = BeaconTileEntity.isBeaconEffect(nbt.getInt("Secondary"));
