...
ITickableTileEntity {
    ...
    public void tick() {
        ...
        if (this.numPlayersUsing > 0 && this.lidAngle == 0.0f) {
            ...
            this.world.playSound(null, d0, (double)j + 0.5, d1, SoundEvents.BLOCK_ENDER_CHEST_OPEN, SoundCategory.BLOCKS, 0.5f, this.world.rand.nextFloat() * 0.1f + 0.9f);
        }
        if (this.numPlayersUsing == 0 && this.lidAngle > 0.0f || this.numPlayersUsing > 0 && this.lidAngle < 1.0f) {
            ...
            if (this.lidAngle < 0.5f && f2 >= 0.5f) {
                ...
                this.world.playSound(null, d3, (double)j + 0.5, d2, SoundEvents.BLOCK_ENDER_CHEST_CLOSE, SoundCategory.BLOCKS, 0.5f, this.world.rand.nextFloat() * 0.1f + 0.9f);
            }
