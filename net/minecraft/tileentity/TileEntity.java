...
public abstract class TileEntity {
    ...
    public void addInfoToCrashReport(CrashReportCategory reportCategory) {
        reportCategory.addDetail("Name", () -> String.valueOf(Registry.BLOCK_ENTITY_TYPE.getKey(this.getType())) + " // " + this.getClass().getCanonicalName());
        if (this.world != null) {
    ...
    public void warnInvalidBlock() {
        if (!this.warnedInvalidBlock) {
            ...
            LOGGER.warn("Block entity invalid: {} @ {}", () -> Registry.BLOCK_ENTITY_TYPE.getKey(this.getType()), this::getPos);
        }
    }
}
