...
public class ActionResult<T> {
    ...
    public static <T> ActionResult<T> resultSuccess(T p_226248_0_) {
        return new ActionResult<T>(ActionResultType.SUCCESS, p_226248_0_);
    }

    public static <T> ActionResult<T> resultConsume(T p_226249_0_) {
        return new ActionResult<T>(ActionResultType.CONSUME, p_226249_0_);
    }

    public static <T> ActionResult<T> resultPass(T p_226250_0_) {
        return new ActionResult<T>(ActionResultType.PASS, p_226250_0_);
    }

    public static <T> ActionResult<T> resultFail(T p_226251_0_) {
        return new ActionResult<T>(ActionResultType.FAIL, p_226251_0_);
    }

    public static <T> ActionResult<T> func_233538_a_(T p_233538_0_, boolean p_233538_1_) {
        return p_233538_1_ ? ActionResult.resultSuccess(p_233538_0_) : ActionResult.resultConsume(p_233538_0_);
    }
}
