...
public class ArbitraryBitLengthIntArray {
    ...
    public ArbitraryBitLengthIntArray(int p_i231443_1_, int p_i231443_2_, long[] p_i231443_3_) {
        Validate.inclusiveBetween(1L, 32L, p_i231443_1_);
    ...
    public void func_233049_a_(int p_233049_1_, int p_233049_2_) {
        Validate.inclusiveBetween(0L, this.field_233046_d_ - 1, p_233049_1_);
        Validate.inclusiveBetween(0L, this.field_233045_c_, p_233049_2_);
        int i = p_233049_1_ * this.field_233044_b_;
        int j = i >> 6;
        int k = (p_233049_1_ + 1) * this.field_233044_b_ - 1 >> 6;
        int l = i ^ j << 6;
        this.field_233043_a_[j] = this.field_233043_a_[j] & (this.field_233045_c_ << l ^ 0xFFFFFFFFFFFFFFFFL) | ((long)p_233049_2_ & this.field_233045_c_) << l;
        if (j != k) {
            int i1 = 64 - l;
    ...
    public int func_233048_a_(int p_233048_1_) {
        Validate.inclusiveBetween(0L, this.field_233046_d_ - 1, p_233048_1_);
