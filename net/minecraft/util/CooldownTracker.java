...
import dimasik.Load;
import dimasik.events.main.player.EventCooldown;
...
public class CooldownTracker {
    ...
    public float getCooldown(Item itemIn, float partialTicks) {
        ...
        Load.getInstance().getEvents().call(eventCooldown);
        if (eventCooldown.getCooldown() != 0.0f) {
            return eventCooldown.getCooldown();
        }
