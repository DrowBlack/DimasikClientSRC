...
public class RandomObjectDescriptor {
    ...
    public static String getRandomObjectDescriptor(UUID uuid) {
        Random random = RandomObjectDescriptor.getRandomFromUUID(uuid);
        return RandomObjectDescriptor.getRandomString(random, FIRST_PART) + RandomObjectDescriptor.getRandomString(random, SECOND_PART);
    }
