...
public class WeightedList<U> {
    ...
    private WeightedList(List<Entry<U>> p_i231541_1_) {
    ...
    public static <U> Codec<WeightedList<U>> func_234002_a_(Codec<U> p_234002_0_) {
        return Entry.func_234008_a_(p_234002_0_).listOf().xmap(WeightedList::new, p_234001_0_ -> p_234001_0_.field_220658_a);
    }

    public WeightedList<U> func_226313_a_(U p_226313_1_, int p_226313_2_) {
        this.field_220658_a.add(new Entry<U>(p_226313_1_, p_226313_2_));
        return this;
    }
    ...
    public WeightedList<U> func_226314_a_(Random p_226314_1_) {
        this.field_220658_a.forEach(p_234004_1_ -> p_234004_1_.func_220648_a(p_226314_1_.nextFloat()));
        this.field_220658_a.sort(Comparator.comparingDouble(p_234003_0_ -> p_234003_0_.func_220649_a()));
        return this;
    }
    ...
    public String toString() {
        return "WeightedList[" + String.valueOf(this.field_220658_a) + "]";
    }
    ...
    public static class Entry<T> {
        ...
        public String toString() {
            return this.field_220652_c + ":" + String.valueOf(this.field_220651_b);
        }

        public static <E> Codec<Entry<E>> func_234008_a_(final Codec<E> p_234008_0_) {
            return new Codec<Entry<E>>(){

                @Override
                public <T> DataResult<Pair<Entry<E>, T>> decode(DynamicOps<T> p_decode_1_, T p_decode_2_) {
                    Dynamic dynamic = new Dynamic(p_decode_1_, p_decode_2_);
                    return dynamic.get("data").flatMap(p_234008_0_::parse).map((? super R p_234012_1_) -> new Entry<Object>(p_234012_1_, dynamic.get("weight").asInt(1))).map((? super R p_234013_1_) -> Pair.of(p_234013_1_, p_decode_1_.empty()));
                }

                @Override
                public <T> DataResult<T> encode(Entry<E> p_encode_1_, DynamicOps<T> p_encode_2_, T p_encode_3_) {
