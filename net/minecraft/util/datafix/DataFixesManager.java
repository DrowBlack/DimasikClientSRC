...
public class DataFixesManager {
    ...
    private static DataFixer createFixer() {
        ...
        DataFixesManager.addFixers(datafixerbuilder);
    ...
    private static void addFixers(DataFixerBuilder builder) {
        ...
        builder.addFixer(ItemRename.create(schema17, "cooked_fished item renamer", namespacedString -> Objects.equals(NamespacedSchema.ensureNamespaced(namespacedString), "minecraft:cooked_fished") ? "minecraft:cooked_fish" : namespacedString));
        ...
        builder.addFixer(ItemRename.create(schema31, "totem item renamer", DataFixesManager.rename("minecraft:totem", "minecraft:totem_of_undying")));
        ...
        builder.addFixer(BlockRename.create(schema51, "Colorless shulker block fixer", namespacedString -> Objects.equals(NamespacedSchema.ensureNamespaced(namespacedString), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : namespacedString));
        builder.addFixer(ItemRename.create(schema51, "Colorless shulker item fixer", namespacedString -> Objects.equals(NamespacedSchema.ensureNamespaced(namespacedString), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : namespacedString));
        Schema schema52 = builder.addSchema(1475, NAMESPACED_SCHEMA_FACTORY);
        builder.addFixer(BlockRename.create(schema52, "Flowing fixer", DataFixesManager.rename(ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava"))));
        Schema schema53 = builder.addSchema(1480, NAMESPACED_SCHEMA_FACTORY);
        builder.addFixer(BlockRename.create(schema53, "Rename coral blocks", DataFixesManager.rename(RenamedCoral.field_204918_a)));
        builder.addFixer(ItemRename.create(schema53, "Rename coral items", DataFixesManager.rename(RenamedCoral.field_204918_a)));
        ...
        builder.addFixer(ItemRename.create(schema55, "Rename pufferfish egg item", DataFixesManager.rename(PufferfishRename.field_207461_a)));
        Schema schema56 = builder.addSchema(1484, NAMESPACED_SCHEMA_FACTORY);
        builder.addFixer(ItemRename.create(schema56, "Rename seagrass items", DataFixesManager.rename(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
        builder.addFixer(BlockRename.create(schema56, "Rename seagrass blocks", DataFixesManager.rename(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
        ...
        builder.addFixer(ItemRename.create(schema57, "Rename cod/salmon egg items", DataFixesManager.rename(EntityCodSalmonFix.field_209759_b)));
        Schema schema58 = builder.addSchema(1487, NAMESPACED_SCHEMA_FACTORY);
        builder.addFixer(ItemRename.create(schema58, "Rename prismarine_brick(s)_* blocks", DataFixesManager.rename(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
        builder.addFixer(BlockRename.create(schema58, "Rename prismarine_brick(s)_* items", DataFixesManager.rename(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
        Schema schema59 = builder.addSchema(1488, NAMESPACED_SCHEMA_FACTORY);
        builder.addFixer(BlockRename.create(schema59, "Rename kelp/kelptop", DataFixesManager.rename(ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant"))));
        builder.addFixer(ItemRename.create(schema59, "Rename kelptop", DataFixesManager.rename("minecraft:kelp_top", "minecraft:kelp")));
        ...
        builder.addFixer(BlockRename.create(schema60, "Rename melon_block", DataFixesManager.rename("minecraft:melon_block", "minecraft:melon")));
        builder.addFixer(ItemRename.create(schema60, "Rename melon_block/melon/speckled_melon", DataFixesManager.rename(ImmutableMap.of("minecraft:melon_block", "minecraft:melon", "minecraft:melon", "minecraft:melon_slice", "minecraft:speckled_melon", "minecraft:glistering_melon_slice"))));
        ...
        builder.addFixer(BlockRename.create(schema68, "Block renamening fix", DataFixesManager.rename(EntityRenaming1510.BLOCK_RENAME_MAP)));
        builder.addFixer(ItemRename.create(schema68, "Item renamening fix", DataFixesManager.rename(EntityRenaming1510.ITEM_RENAME_MAP)));
        ...
        builder.addFixer(BlockRename.create(schema70, "Rename coral fan blocks", DataFixesManager.rename(CoralFansRenameList.field_211870_a)));
        ...
        builder.addFixer(ItemRename.create(schema72, "Rename dye items", DataFixesManager.rename(DyeRenameMap.field_219828_a)));
        ...
        builder.addFixer(BlockRename.create(schema74, "Rename sign blocks & stone slabs", DataFixesManager.rename(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign"))));
        builder.addFixer(ItemRename.create(schema74, "Rename sign item & stone slabs", DataFixesManager.rename(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign"))));
        ...
        builder.addFixer(ItemRename.create(schema85, "Rename ravager egg item", DataFixesManager.rename(EntityRavagerRenameFix.field_219829_a)));
        ...
        builder.addFixer(new RecipeRenamer(schema95, false, "Rename sugar recipe", DataFixesManager.rename("minecraft:sugar", "sugar_from_sugar_cane")));
        builder.addFixer(new AdvancementRenamer(schema95, false, "Rename sugar recipe advancement", DataFixesManager.rename("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
        ...
        builder.addFixer(ItemRename.create(schema97, "Rename bee_hive item to beehive", DataFixesManager.rename("minecraft:bee_hive", "minecraft:beehive")));
        builder.addFixer(new RenameBeehivePointOfInterest(schema97));
        builder.addFixer(BlockRename.create(schema97, "Rename bee_hive block to beehive", DataFixesManager.rename("minecraft:bee_hive", "minecraft:beehive")));
        ...
        builder.addFixer(new AdvancementRenamer(schema102, false, "Composter category change", DataFixesManager.rename("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
        ...
        builder.addFixer(ItemRename.create(schema104, "Renamed fungi items to fungus", DataFixesManager.rename(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        builder.addFixer(BlockRename.create(schema104, "Renamed fungi blocks to fungus", DataFixesManager.rename(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        Schema schema105 = builder.addSchema(2509, V2509::new);
        builder.addFixer(new ZombifiedPiglinRename(schema105));
        builder.addFixer(ItemRename.create(schema105, "Rename zombie pigman egg item", DataFixesManager.rename(ZombifiedPiglinRename.field_233242_a_)));
        ...
        builder.addFixer(ItemRename.create(schema114, "Rename soul fire torch and soul fire lantern", DataFixesManager.rename(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        builder.addFixer(BlockRename.create(schema114, "Rename soul fire torch and soul fire lantern", DataFixesManager.rename(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
    ...
    private static UnaryOperator<String> rename(Map<String, String> renameMap) {
        return name -> renameMap.getOrDefault(name, (String)name);
    }

    private static UnaryOperator<String> rename(String oldName, String newName) {
        return name -> Objects.equals(name, oldName) ? newName : name;
    }
}
