...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped(this.field_230066_a_, this.getInputSchema().getType(TypeReferences.ADVANCEMENTS), p_230071_1_ -> p_230071_1_.update(DSL.remainderFinder(), p_230068_1_ -> p_230068_1_.updateMapValues(p_233068_2_ -> {
            String s = ((Dynamic)p_233068_2_.getFirst()).asString("");
            return p_233068_2_.mapFirst(p_233069_3_ -> p_230068_1_.createString(this.field_230067_b_.apply(s)));
        })));
    }
}
