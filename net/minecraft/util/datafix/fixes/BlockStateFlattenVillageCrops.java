...
extends DataFix {
    ...
    private static Stream<? extends Dynamic<?>> updateChildren(Stream<? extends Dynamic<?>> p_210586_0_) {
        return p_210586_0_.map(p_210587_0_ -> {
            ...
            if ("ViF".equals(s)) {
                return BlockStateFlattenVillageCrops.updateSingleField(p_210587_0_);
            }
            return "ViDF".equals(s) ? BlockStateFlattenVillageCrops.updateDoubleField(p_210587_0_) : p_210587_0_;
        });
    }

    private static <T> Dynamic<T> updateSingleField(Dynamic<T> p_210588_0_) {
        p_210588_0_ = BlockStateFlattenVillageCrops.updateCrop(p_210588_0_, "CA");
        return BlockStateFlattenVillageCrops.updateCrop(p_210588_0_, "CB");
    }

    private static <T> Dynamic<T> updateDoubleField(Dynamic<T> p_210589_0_) {
        p_210589_0_ = BlockStateFlattenVillageCrops.updateCrop(p_210589_0_, "CA");
        p_210589_0_ = BlockStateFlattenVillageCrops.updateCrop(p_210589_0_, "CB");
        p_210589_0_ = BlockStateFlattenVillageCrops.updateCrop(p_210589_0_, "CC");
        return BlockStateFlattenVillageCrops.updateCrop(p_210589_0_, "CD");
    }
