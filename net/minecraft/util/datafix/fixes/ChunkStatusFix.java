...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ChunkStatusFix", type, this.getOutputSchema().getType(TypeReferences.CHUNK), (Typed<?> p_219826_1_) -> p_219826_1_.updateTyped(opticfinder, p_219827_0_ -> {
