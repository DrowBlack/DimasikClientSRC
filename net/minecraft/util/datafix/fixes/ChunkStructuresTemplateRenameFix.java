...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", type, p_207911_2_ -> p_207911_2_.updateTyped(opticfinder, p_207908_2_ -> p_207908_2_.update(DSL.remainderFinder(), p_207909_2_ -> this.func_233153_a_(p_207911_2_.get(DSL.remainderFinder()), (Dynamic<?>)p_207909_2_))));
    }
    ...
    private Dynamic<?> func_233153_a_(Dynamic<?> p_233153_1_, Dynamic<?> p_233153_2_) {
        ...
        if (field_207912_a.containsKey(s) && (pair = field_207912_a.get(s)).getFirst().equals(p_233153_2_.get("id").asString(""))) {
