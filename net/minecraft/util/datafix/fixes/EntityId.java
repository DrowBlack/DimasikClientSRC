...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", type, type1), this.fixTypeEverywhere("EntityIdFix", taggedchoicetype, taggedchoicetype1, p_209744_0_ -> p_206326_0_ -> p_206326_0_.mapFirst(p_206327_0_ -> OLD_TO_NEW_ID_MAP.getOrDefault(p_206327_0_, (String)p_206327_0_))));
    }
}
