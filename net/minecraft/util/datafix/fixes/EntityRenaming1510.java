...
extends TypedEntityRenameHelper {
    ...
    protected String rename(String name) {
        ...
        return ENTITY_RENAME_MAP.getOrDefault(name, (String)name);
    }
}
