...
extends AbstractUUIDFix {
    ...
    protected TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.reference), p_233210_1_ -> {
            ...
            for (String s : field_233204_c_) {
                p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, s, EntityUUID::func_233226_l_);
            }
            for (String s1 : field_233205_d_) {
                p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, s1, EntityUUID::func_233226_l_);
            }
            for (String s2 : field_233206_e_) {
                p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, s2, EntityUUID::func_233227_m_);
            }
            for (String s3 : field_233207_f_) {
                p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, s3, EntityUUID::func_233228_n_);
            }
            for (String s4 : field_233208_g_) {
                p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, s4, EntityUUID::func_233212_b_);
            }
            for (String s5 : field_233209_h_) {
                p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, s5, EntityUUID::func_233229_o_);
            }
            p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, "minecraft:bee", EntityUUID::func_233225_k_);
            p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, "minecraft:zombified_piglin", EntityUUID::func_233225_k_);
            p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, "minecraft:fox", EntityUUID::func_233224_j_);
            p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, "minecraft:item", EntityUUID::func_233223_i_);
            p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, "minecraft:shulker_bullet", EntityUUID::func_233222_h_);
            p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, "minecraft:area_effect_cloud", EntityUUID::func_233221_g_);
            p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, "minecraft:zombie_villager", EntityUUID::func_233220_f_);
            p_233210_1_ = this.func_233053_a_((Typed<?>)p_233210_1_, "minecraft:evoker_fangs", EntityUUID::func_233218_e_);
            return this.func_233053_a_((Typed<?>)p_233210_1_, "minecraft:piglin", EntityUUID::func_233216_d_);
        });
    }

    private static Dynamic<?> func_233216_d_(Dynamic<?> p_233216_0_) {
        return p_233216_0_.update("Brain", p_233235_0_ -> p_233235_0_.update("memories", p_233236_0_ -> p_233236_0_.update("minecraft:angry_at", p_233237_0_ -> EntityUUID.func_233058_a_(p_233237_0_, "value", "value").orElseGet(() -> {
    ...
    private static Dynamic<?> func_233218_e_(Dynamic<?> p_233218_0_) {
        return EntityUUID.func_233064_c_(p_233218_0_, "OwnerUUID", "Owner").orElse(p_233218_0_);
    }

    private static Dynamic<?> func_233220_f_(Dynamic<?> p_233220_0_) {
        return EntityUUID.func_233064_c_(p_233220_0_, "ConversionPlayer", "ConversionPlayer").orElse(p_233220_0_);
    }

    private static Dynamic<?> func_233221_g_(Dynamic<?> p_233221_0_) {
        return EntityUUID.func_233064_c_(p_233221_0_, "OwnerUUID", "Owner").orElse(p_233221_0_);
    }

    private static Dynamic<?> func_233222_h_(Dynamic<?> p_233222_0_) {
        p_233222_0_ = EntityUUID.func_233062_b_(p_233222_0_, "Owner", "Owner").orElse(p_233222_0_);
        return EntityUUID.func_233062_b_(p_233222_0_, "Target", "Target").orElse(p_233222_0_);
    }

    private static Dynamic<?> func_233223_i_(Dynamic<?> p_233223_0_) {
        p_233223_0_ = EntityUUID.func_233062_b_(p_233223_0_, "Owner", "Owner").orElse(p_233223_0_);
        return EntityUUID.func_233062_b_(p_233223_0_, "Thrower", "Thrower").orElse(p_233223_0_);
    }

    private static Dynamic<?> func_233224_j_(Dynamic<?> p_233224_0_) {
        Optional<Dynamic> optional = p_233224_0_.get("TrustedUUIDs").result().map(p_233219_1_ -> p_233224_0_.createList(p_233219_1_.asStream().map(p_233233_0_ -> EntityUUID.func_233054_a_(p_233233_0_).orElseGet(() -> {
            LOGGER.warn("Trusted contained invalid data.");
            return p_233233_0_;
        }))));
        return DataFixUtils.orElse(optional.map(p_233217_1_ -> p_233224_0_.remove("TrustedUUIDs").set("Trusted", (Dynamic<?>)p_233217_1_)), p_233224_0_);
    }

    private static Dynamic<?> func_233225_k_(Dynamic<?> p_233225_0_) {
        return EntityUUID.func_233058_a_(p_233225_0_, "HurtBy", "HurtBy").orElse(p_233225_0_);
    }

    private static Dynamic<?> func_233226_l_(Dynamic<?> p_233226_0_) {
        Dynamic<?> dynamic = EntityUUID.func_233227_m_(p_233226_0_);
        return EntityUUID.func_233058_a_(dynamic, "OwnerUUID", "Owner").orElse(dynamic);
    }

    private static Dynamic<?> func_233227_m_(Dynamic<?> p_233227_0_) {
        Dynamic<?> dynamic = EntityUUID.func_233228_n_(p_233227_0_);
        return EntityUUID.func_233064_c_(dynamic, "LoveCause", "LoveCause").orElse(dynamic);
    }

    private static Dynamic<?> func_233228_n_(Dynamic<?> p_233228_0_) {
        return EntityUUID.func_233212_b_(p_233228_0_).update("Leash", p_233232_0_ -> EntityUUID.func_233064_c_(p_233232_0_, "UUID", "UUID").orElse((Dynamic<?>)p_233232_0_));
    }

    public static Dynamic<?> func_233212_b_(Dynamic<?> p_233212_0_) {
        return p_233212_0_.update("Attributes", p_233213_1_ -> p_233212_0_.createList(p_233213_1_.asStream().map(p_233230_0_ -> p_233230_0_.update("Modifiers", p_233215_1_ -> p_233230_0_.createList(p_233215_1_.asStream().map(p_233231_0_ -> EntityUUID.func_233064_c_(p_233231_0_, "UUID", "UUID").orElse((Dynamic<?>)p_233231_0_)))))));
    }

    private static Dynamic<?> func_233229_o_(Dynamic<?> p_233229_0_) {
        return DataFixUtils.orElse(p_233229_0_.get("OwnerUUID").result().map(p_233211_1_ -> p_233229_0_.remove("OwnerUUID").set("Owner", (Dynamic<?>)p_233211_1_)), p_233229_0_);
    }

    public static Dynamic<?> func_233214_c_(Dynamic<?> p_233214_0_) {
        return EntityUUID.func_233064_c_(p_233214_0_, "UUID", "UUID").orElse(p_233214_0_);
    }
