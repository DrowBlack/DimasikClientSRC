...
extends DataFix {
    ...
    public static String getItem(int p_199173_0_) {
        return (String)ID_MAP.get(p_199173_0_);
    }
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(TypeReferences.ITEM_STACK), this.getOutputSchema().getType(TypeReferences.ITEM_STACK), (Typed<?> p_206349_2_) -> p_206349_2_.update(opticfinder, type1, p_206350_0_ -> p_206350_0_.map(p_207473_0_ -> Pair.of(TypeReferences.ITEM_NAME.typeName(), ItemIntIDToString.getItem(p_207473_0_)), p_207472_0_ -> p_207472_0_)));
    }
}
