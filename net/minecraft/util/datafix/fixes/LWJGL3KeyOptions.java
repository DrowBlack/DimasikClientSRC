...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("OptionsKeyLwjgl3Fix", this.getInputSchema().getType(TypeReferences.OPTIONS), p_207423_0_ -> p_207423_0_.update(DSL.remainderFinder(), p_207424_0_ -> p_207424_0_.getMapValues().map(p_209663_1_ -> p_207424_0_.createMap(p_209663_1_.entrySet().stream().map(p_209661_0_ -> {
            if (((Dynamic)p_209661_0_.getKey()).asString("").startsWith("key_")) {
                ...
                if (i < 0) {
                    ...
                    return Pair.of((Dynamic)p_209661_0_.getKey(), ((Dynamic)p_209661_0_.getValue()).createString((String)s1));
                }
                String s = field_199186_a.getOrDefault(i, "key.unknown");
                return Pair.of((Dynamic)p_209661_0_.getKey(), ((Dynamic)p_209661_0_.getValue()).createString(s));
            }
            return Pair.of((Dynamic)p_209661_0_.getKey(), (Dynamic)p_209661_0_.getValue());
        }).collect(Collectors.toMap(Pair::getFirst, Pair::getSecond)))).result().orElse((Dynamic)p_207424_0_)));
    }
}
