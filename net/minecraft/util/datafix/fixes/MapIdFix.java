...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("Map id fix", type, p_219839_1_ -> {
            ...
            return optional.isPresent() ? p_219839_1_ : p_219839_1_.update(DSL.remainderFinder(), p_219838_0_ -> p_219838_0_.createMap(ImmutableMap.of(p_219838_0_.createString("data"), p_219838_0_)));
        });
    }
}
