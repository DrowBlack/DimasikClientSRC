...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("OptionsAddTextBackgroundFix", this.getInputSchema().getType(TypeReferences.OPTIONS), p_219858_1_ -> p_219858_1_.update(DSL.remainderFinder(), p_219855_1_ -> DataFixUtils.orElse(p_219855_1_.get("chatOpacity").asString().map(p_219857_2_ -> p_219855_1_.set("textBackgroundOpacity", p_219855_1_.createDouble(this.func_219856_a((String)p_219857_2_)))).result(), p_219855_1_)));
    }
