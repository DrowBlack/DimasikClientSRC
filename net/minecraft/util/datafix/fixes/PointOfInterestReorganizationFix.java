...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhere("POI reorganization", type, p_219871_0_ -> p_219872_0_ -> p_219872_0_.mapSecond(PointOfInterestReorganizationFix::func_219870_a));
    }
    ...
    private static <T> Dynamic<T> func_219870_a(Dynamic<T> p_219870_0_) {
        ...
        for (int i = 0; i < 16; ++i) {
            ...
            Dynamic dynamic1 = p_219870_0_.createMap(ImmutableMap.of(p_219870_0_.createString("Records"), dynamic));
