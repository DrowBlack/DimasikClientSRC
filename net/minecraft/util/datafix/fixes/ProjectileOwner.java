...
extends DataFix {
    ...
    private Dynamic<?> func_233186_a_(Dynamic<?> p_233186_1_, long p_233186_2_, long p_233186_4_) {
        String s = "OwnerUUID";
        return p_233186_2_ != 0L && p_233186_4_ != 0L ? p_233186_1_.set("OwnerUUID", p_233186_1_.createIntList(Arrays.stream(ProjectileOwner.func_233182_a_(p_233186_2_, p_233186_4_)))) : p_233186_1_;
    }
    ...
    private Typed<?> func_233184_a_(Typed<?> p_233184_1_, String p_233184_2_, Function<Dynamic<?>, Dynamic<?>> p_233184_3_) {
        ...
        return p_233184_1_.updateTyped(DSL.namedChoice(p_233184_2_, type), type1, p_233187_1_ -> p_233187_1_.update(DSL.remainderFinder(), p_233184_3_));
    }
}
