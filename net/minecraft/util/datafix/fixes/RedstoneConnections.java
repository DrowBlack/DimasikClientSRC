...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("RedstoneConnectionsFix", schema.getType(TypeReferences.BLOCK_STATE), p_233367_1_ -> p_233367_1_.update(DSL.remainderFinder(), this::func_233368_a_));
    }
    ...
    private <T> Dynamic<T> func_233368_a_(Dynamic<T> p_233368_1_) {
        ...
        return !flag ? p_233368_1_ : p_233368_1_.update("Properties", p_233371_0_ -> {
            ...
            boolean flag1 = RedstoneConnections.func_233369_a_(s) || RedstoneConnections.func_233369_a_(s1);
            boolean flag2 = RedstoneConnections.func_233369_a_(s2) || RedstoneConnections.func_233369_a_(s3);
            String s4 = !RedstoneConnections.func_233369_a_(s) && !flag2 ? "side" : s;
            String s5 = !RedstoneConnections.func_233369_a_(s1) && !flag2 ? "side" : s1;
            String s6 = !RedstoneConnections.func_233369_a_(s2) && !flag1 ? "side" : s2;
            String s7 = !RedstoneConnections.func_233369_a_(s3) && !flag1 ? "side" : s3;
