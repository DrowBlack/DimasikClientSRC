...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemShulkerBoxColorFix", type, p_206358_3_ -> {
            ...
            if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:shulker_box") && (optional1 = p_206358_3_.getOptionalTyped(opticfinder1)).isPresent() && (optional2 = (typed = optional1.get()).getOptionalTyped(opticfinder2)).isPresent()) {
