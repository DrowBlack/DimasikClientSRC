...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped(this.field_241315_a_, this.getInputSchema().getType(TypeReferences.OPTIONS), p_241318_1_ -> p_241318_1_.update(DSL.remainderFinder(), p_241319_1_ -> DataFixUtils.orElse(p_241319_1_.get(this.field_241316_b_).result().map(p_241320_2_ -> p_241319_1_.set(this.field_241317_c_, (Dynamic<?>)p_241320_2_).remove(this.field_241316_b_)), p_241319_1_)));
    }
}
