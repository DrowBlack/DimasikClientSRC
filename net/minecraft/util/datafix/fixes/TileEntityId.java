...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        TaggedChoice.TaggedChoiceType<?> taggedchoicetype1 = this.getOutputSchema().findChoiceType(TypeReferences.BLOCK_ENTITY);
        return TypeRewriteRule.seq(this.convertUnchecked("item stack block entity name hook converter", type, type1), this.fixTypeEverywhere("BlockEntityIdFix", taggedchoicetype, taggedchoicetype1, p_209700_0_ -> p_206301_0_ -> p_206301_0_.mapFirst(p_206302_0_ -> OLD_TO_NEW_ID_MAP.getOrDefault(p_206302_0_, (String)p_206302_0_))));
    }
}
