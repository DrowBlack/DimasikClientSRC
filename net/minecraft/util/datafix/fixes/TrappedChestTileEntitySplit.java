...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(new AddNewChoices(this.getOutputSchema(), "AddTrappedChestFix", TypeReferences.BLOCK_ENTITY).makeRule(), this.fixTypeEverywhereTyped("Trapped Chest fix", type3, p_212533_5_ -> p_212533_5_.updateTyped(opticfinder1, p_212531_4_ -> {
            Optional optional = p_212531_4_.getOptionalTyped(opticfinder2);
            if (!optional.isPresent()) {
                return p_212531_4_;
            }
            List list = optional.get().getAllTyped(opticfinder3);
            IntOpenHashSet intset = new IntOpenHashSet();
            for (Typed typed : list) {
                Section trappedchesttileentitysplit$section = new Section(typed, this.getInputSchema());
                if (trappedchesttileentitysplit$section.isSkippable()) continue;
            ...
            return p_212531_4_.updateTyped(opticfinder, p_212532_4_ -> p_212532_4_.updateTyped(taggedchoicetype.finder(), p_212530_4_ -> {
                int k1;
                int j1;
                Dynamic<?> dynamic1 = p_212530_4_.getOrCreate(DSL.remainderFinder());
                int i1 = dynamic1.get("x").asInt(0) - (k << 4);
                return intset.contains(LeavesFix.getIndex(i1, j1 = dynamic1.get("y").asInt(0), k1 = dynamic1.get("z").asInt(0) - (l << 4))) ? p_212530_4_.update(taggedchoicetype.finder(), p_212534_0_ -> p_212534_0_.mapFirst(p_212535_0_ -> {
