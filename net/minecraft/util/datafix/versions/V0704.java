...
extends Schema {
    ...
    protected static final Hook.HookFunction field_206648_c = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> p_apply_1_, T p_apply_2_) {
            return V0099.func_209869_a(new Dynamic<T>(p_apply_1_, p_apply_2_), field_206647_b, "ArmorStand");
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_registerBlockEntities_1_) {
        ...
        V0704.registerInventory(p_registerBlockEntities_1_, map, "minecraft:furnace");
        V0704.registerInventory(p_registerBlockEntities_1_, map, "minecraft:chest");
        p_registerBlockEntities_1_.registerSimple(map, "minecraft:ender_chest");
        p_registerBlockEntities_1_.register(map, "minecraft:jukebox", (String p_206641_1_) -> DSL.optionalFields("RecordItem", TypeReferences.ITEM_STACK.in(p_registerBlockEntities_1_)));
        V0704.registerInventory(p_registerBlockEntities_1_, map, "minecraft:dispenser");
        V0704.registerInventory(p_registerBlockEntities_1_, map, "minecraft:dropper");
        p_registerBlockEntities_1_.registerSimple(map, "minecraft:sign");
        p_registerBlockEntities_1_.register(map, "minecraft:mob_spawner", (String p_206646_1_) -> TypeReferences.UNTAGGED_SPAWNER.in(p_registerBlockEntities_1_));
        ...
        V0704.registerInventory(p_registerBlockEntities_1_, map, "minecraft:brewing_stand");
        ...
        V0704.registerInventory(p_registerBlockEntities_1_, map, "minecraft:hopper");
        p_registerBlockEntities_1_.registerSimple(map, "minecraft:comparator");
        p_registerBlockEntities_1_.register(map, "minecraft:flower_pot", (String p_206640_1_) -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), TypeReferences.ITEM_NAME.in(p_registerBlockEntities_1_))));
    ...
    public void registerTypes(Schema p_registerTypes_1_, Map<String, Supplier<TypeTemplate>> p_registerTypes_2_, Map<String, Supplier<TypeTemplate>> p_registerTypes_3_) {
        ...
        p_registerTypes_1_.registerType(false, TypeReferences.BLOCK_ENTITY, () -> DSL.taggedChoiceLazy("id", NamespacedSchema.func_233457_a_(), p_registerTypes_3_));
        p_registerTypes_1_.registerType(true, TypeReferences.ITEM_STACK, () -> DSL.hook(DSL.optionalFields("id", TypeReferences.ITEM_NAME.in(p_registerTypes_1_), "tag", DSL.optionalFields("EntityTag", TypeReferences.ENTITY_TYPE.in(p_registerTypes_1_), "BlockEntityTag", TypeReferences.BLOCK_ENTITY.in(p_registerTypes_1_), "CanDestroy", DSL.list(TypeReferences.BLOCK_NAME.in(p_registerTypes_1_)), "CanPlaceOn", DSL.list(TypeReferences.BLOCK_NAME.in(p_registerTypes_1_)))), field_206648_c, Hook.HookFunction.IDENTITY));
    }
}
