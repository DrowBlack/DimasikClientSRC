...
extends NamespacedSchema {
    ...
    public void registerTypes(Schema p_registerTypes_1_, Map<String, Supplier<TypeTemplate>> p_registerTypes_2_, Map<String, Supplier<TypeTemplate>> p_registerTypes_3_) {
        ...
        p_registerTypes_1_.registerType(false, TypeReferences.BIOME, () -> DSL.constType(V1125.func_233457_a_()));
        p_registerTypes_1_.registerType(false, TypeReferences.ENTITY_NAME, () -> DSL.constType(V1125.func_233457_a_()));
    }
}
