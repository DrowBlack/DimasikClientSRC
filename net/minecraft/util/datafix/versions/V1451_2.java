...
extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_registerBlockEntities_1_) {
        ...
        p_registerBlockEntities_1_.register(map, "minecraft:piston", (String p_206510_1_) -> DSL.optionalFields("blockState", TypeReferences.BLOCK_STATE.in(p_registerBlockEntities_1_)));
        return map;
    }
}
