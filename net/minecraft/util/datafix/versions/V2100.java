...
extends NamespacedSchema {
    ...
    protected static void func_226217_a_(Schema p_226217_0_, Map<String, Supplier<TypeTemplate>> p_226217_1_, String p_226217_2_) {
        p_226217_0_.register(p_226217_1_, p_226217_2_, () -> V0100.equipment(p_226217_0_));
    }

    @Override
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
        Map<String, Supplier<TypeTemplate>> map = super.registerEntities(p_registerEntities_1_);
        V2100.func_226217_a_(p_registerEntities_1_, map, "minecraft:bee");
        V2100.func_226217_a_(p_registerEntities_1_, map, "minecraft:bee_stinger");
        return map;
    }
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_registerBlockEntities_1_) {
        ...
        p_registerBlockEntities_1_.register(map, "minecraft:beehive", () -> DSL.optionalFields("Items", DSL.list(TypeReferences.ITEM_STACK.in(p_registerBlockEntities_1_)), "Bees", DSL.list(DSL.optionalFields("EntityData", TypeReferences.ENTITY_TYPE.in(p_registerBlockEntities_1_)))));
        return map;
    }
}
