...
implements IDoubleListMerger {
    ...
    public boolean forMergedIndexes(IDoubleListMerger.IConsumer consumer) {
        return this.field_199640_c ? this.func_199637_b((p_199636_1_, p_199636_2_, p_199636_3_) -> consumer.merge(p_199636_2_, p_199636_1_, p_199636_3_)) : this.func_199637_b(consumer);
    }
