...
implements IPosition {
    ...
    public static Vector3d fromPitchYaw(Vector2f vec) {
        return Vector3d.fromPitchYaw(vec.x, vec.y);
    }
    ...
    public Vector3d lerp(Vector3d vec, float factor) {
        return new Vector3d(MathUtils.lerp(this.getX(), vec.getX(), (double)factor), MathUtils.lerp(this.getY(), vec.getY(), (double)factor), MathUtils.lerp(this.getZ(), vec.getZ(), (double)factor));
    }
}
