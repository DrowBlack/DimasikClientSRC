...
extends TextComponent {
    ...
    public boolean equals(Object p_equals_1_) {
        ...
        if (!(p_equals_1_ instanceof StringTextComponent)) {
            return false;
        }
    ...
    public String toString() {
        return "TextComponent{text='" + this.text + "', siblings=" + String.valueOf(this.siblings) + ", style=" + String.valueOf(this.getStyle()) + "}";
    }
}
