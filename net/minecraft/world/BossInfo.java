...
public abstract class BossInfo {
    ...
    public static enum Color {
        ...
        public static Color byName(String name) {
            for (Color bossinfo$color : Color.values()) {
                if (!bossinfo$color.name.equals(name)) continue;
    ...
    public static enum Overlay {
        ...
        public static Overlay byName(String name) {
            for (Overlay bossinfo$overlay : Overlay.values()) {
                if (!bossinfo$overlay.name.equals(name)) continue;
