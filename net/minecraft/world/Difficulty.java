...
public enum Difficulty {
    ...
    public static Difficulty byName(String nameIn) {
        for (Difficulty difficulty : Difficulty.values()) {
            if (!difficulty.translationKey.equals(nameIn)) continue;
            return difficulty;
        }
        return null;
    }
    ...
    static {
        ID_MAPPING = (Difficulty[])Arrays.stream(Difficulty.values()).sorted(Comparator.comparingInt(Difficulty::getId)).toArray(Difficulty[]::new);
    }
}
