...
IDayTimeReader {
    ...
    @Override
    default public boolean chunkExists(int chunkX, int chunkZ) {
        return this.getChunkProvider().chunkExists(chunkX, chunkZ);
    }

    public Random getRandom();

    default public void func_230547_a_(BlockPos p_230547_1_, Block p_230547_2_) {
    }
    ...
    default public void playEvent(int type, BlockPos pos, int data) {
