...
public final class Biome {
    ...
    public static final Codec<Biome> CODEC = RecordCodecBuilder.create(builder -> builder.group(Climate.CODEC.forGetter(biome -> biome.climate), ((MapCodec)Category.CODEC.fieldOf("category")).forGetter(biome -> biome.category), ((MapCodec)Codec.FLOAT.fieldOf("depth")).forGetter(biome -> Float.valueOf(biome.depth)), ((MapCodec)Codec.FLOAT.fieldOf("scale")).forGetter(biome -> Float.valueOf(biome.scale)), ((MapCodec)BiomeAmbience.CODEC.fieldOf("effects")).forGetter(biome -> biome.effects), BiomeGenerationSettings.CODEC.forGetter(biome -> biome.biomeGenerationSettings), MobSpawnInfo.CODEC.forGetter(biome -> biome.mobSpawnInfo)).apply((Applicative<Biome, ?>)builder, Biome::new));
    public static final Codec<Biome> PACKET_CODEC = RecordCodecBuilder.create(builder -> builder.group(Climate.CODEC.forGetter(biome -> biome.climate), ((MapCodec)Category.CODEC.fieldOf("category")).forGetter(biome -> biome.category), ((MapCodec)Codec.FLOAT.fieldOf("depth")).forGetter(biome -> Float.valueOf(biome.depth)), ((MapCodec)Codec.FLOAT.fieldOf("scale")).forGetter(biome -> Float.valueOf(biome.scale)), ((MapCodec)BiomeAmbience.CODEC.fieldOf("effects")).forGetter(biome -> biome.effects)).apply((Applicative<Biome, ?>)builder, (climate, category, depth, scale, ambience) -> new Biome((Climate)climate, (Category)category, depth.floatValue(), scale.floatValue(), (BiomeAmbience)ambience, BiomeGenerationSettings.DEFAULT_SETTINGS, MobSpawnInfo.EMPTY)));
    ...
    private static final PerlinNoiseGenerator TEMPERATURE_NOISE = new PerlinNoiseGenerator(new SharedSeedRandom(1234L), ImmutableList.of(Integer.valueOf(0)));
    private static final PerlinNoiseGenerator FROZEN_TEMPERATURE_NOISE = new PerlinNoiseGenerator(new SharedSeedRandom(3456L), ImmutableList.of(Integer.valueOf(-2), Integer.valueOf(-1), Integer.valueOf(0)));
    public static final PerlinNoiseGenerator INFO_NOISE = new PerlinNoiseGenerator(new SharedSeedRandom(2345L), ImmutableList.of(Integer.valueOf(0)));
    ...
    static class Climate {
        public static final MapCodec<Climate> CODEC = RecordCodecBuilder.mapCodec(builder -> builder.group(((MapCodec)RainType.CODEC.fieldOf("precipitation")).forGetter(precipitation -> precipitation.precipitation), ((MapCodec)Codec.FLOAT.fieldOf("temperature")).forGetter(climate -> Float.valueOf(climate.temperature)), TemperatureModifier.CODEC.optionalFieldOf("temperature_modifier", TemperatureModifier.NONE).forGetter(climate -> climate.temperatureModifier), ((MapCodec)Codec.FLOAT.fieldOf("downfall")).forGetter(climate -> Float.valueOf(climate.downfall))).apply((Applicative<Climate, ?>)builder, Climate::new));
    ...
    public static class Attributes {
        public static final Codec<Attributes> CODEC = RecordCodecBuilder.create(builder -> builder.group(((MapCodec)Codec.floatRange(-2.0f, 2.0f).fieldOf("temperature")).forGetter(attributes -> Float.valueOf(attributes.temperature)), ((MapCodec)Codec.floatRange(-2.0f, 2.0f).fieldOf("humidity")).forGetter(attributes -> Float.valueOf(attributes.humidity)), ((MapCodec)Codec.floatRange(-2.0f, 2.0f).fieldOf("altitude")).forGetter(attributes -> Float.valueOf(attributes.altitude)), ((MapCodec)Codec.floatRange(-2.0f, 2.0f).fieldOf("weirdness")).forGetter(attributes -> Float.valueOf(attributes.weirdness)), ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("offset")).forGetter(attributes -> Float.valueOf(attributes.offset))).apply((Applicative<Attributes, ?>)builder, Attributes::new));
        private final float temperature;
