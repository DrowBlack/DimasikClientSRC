...
public class BiomeAmbience {
    public static final Codec<BiomeAmbience> CODEC = RecordCodecBuilder.create(builder -> builder.group(((MapCodec)Codec.INT.fieldOf("fog_color")).forGetter(ambience -> ambience.fogColor), ((MapCodec)Codec.INT.fieldOf("water_color")).forGetter(ambience -> ambience.waterColor), ((MapCodec)Codec.INT.fieldOf("water_fog_color")).forGetter(ambience -> ambience.waterFogColor), ((MapCodec)Codec.INT.fieldOf("sky_color")).forGetter(ambience -> ambience.skyColor), Codec.INT.optionalFieldOf("foliage_color").forGetter(ambience -> ambience.foliageColor), Codec.INT.optionalFieldOf("grass_color").forGetter(p_244426_0_ -> p_244426_0_.grassColor), GrassColorModifier.CODEC.optionalFieldOf("grass_color_modifier", GrassColorModifier.NONE).forGetter(ambience -> ambience.grassColorModifier), ParticleEffectAmbience.CODEC.optionalFieldOf("particle").forGetter(ambience -> ambience.particle), SoundEvent.CODEC.optionalFieldOf("ambient_sound").forGetter(ambience -> ambience.ambientSound), MoodSoundAmbience.CODEC.optionalFieldOf("mood_sound").forGetter(ambience -> ambience.moodSound), SoundAdditionsAmbience.CODEC.optionalFieldOf("additions_sound").forGetter(ambience -> ambience.additionsSound), BackgroundMusicSelector.CODEC.optionalFieldOf("music").forGetter(ambience -> ambience.music)).apply((Applicative<BiomeAmbience, ?>)builder, BiomeAmbience::new));
