...
ChunkHolder.IListener {
    ...
    public ChunkTaskPriorityQueueSorter(List<ITaskExecutor<?>> p_i50713_1_, Executor p_i50713_2_, int p_i50713_3_) {
        this.queues = p_i50713_1_.stream().collect(Collectors.toMap(Function.identity(), p_219084_1_ -> new ChunkTaskPriorityQueue(p_219084_1_.getName() + "_queue", p_i50713_3_)));
        this.field_219095_c = Sets.newHashSet(p_i50713_1_);
        this.sorter = new DelegatedTaskExecutor<ITaskQueue.RunnableWithPriority>(new ITaskQueue.Priority(4), p_i50713_2_, "sorter");
    }

    public static FunctionEntry<Runnable> func_219069_a(Runnable p_219069_0_, long pos, IntSupplier p_219069_3_) {
        return new FunctionEntry<Runnable>(p_219072_1_ -> () -> {
            p_219069_0_.run();
            p_219072_1_.enqueue(Unit.INSTANCE);
        }, pos, p_219069_3_);
    }

    public static FunctionEntry<Runnable> func_219081_a(ChunkHolder p_219081_0_, Runnable p_219081_1_) {
        return ChunkTaskPriorityQueueSorter.func_219069_a(p_219081_1_, p_219081_0_.getPosition().asLong(), p_219081_0_::func_219281_j);
    }

    public static RunnableEntry func_219073_a(Runnable p_219073_0_, long p_219073_1_, boolean p_219073_3_) {
        return new RunnableEntry(p_219073_0_, p_219073_1_, p_219073_3_);
    }

    public <T> ITaskExecutor<FunctionEntry<T>> func_219087_a(ITaskExecutor<T> p_219087_1_, boolean p_219087_2_) {
        return (ITaskExecutor)this.sorter.func_213141_a(p_219086_3_ -> new ITaskQueue.RunnableWithPriority(0, () -> {
            this.getQueue(p_219087_1_);
            p_219086_3_.enqueue(ITaskExecutor.inline("chunk priority sorter around " + p_219087_1_.getName(), p_219071_3_ -> this.func_219067_a(p_219087_1_, p_219071_3_.task, p_219071_3_.chunkPos, p_219071_3_.field_219430_c, p_219087_2_)));
        })).join();
    }

    public ITaskExecutor<RunnableEntry> func_219091_a(ITaskExecutor<Runnable> p_219091_1_) {
        return (ITaskExecutor)this.sorter.func_213141_a(p_219080_2_ -> new ITaskQueue.RunnableWithPriority(0, () -> p_219080_2_.enqueue(ITaskExecutor.inline("chunk priority sorter around " + p_219091_1_.getName(), p_219075_2_ -> this.func_219074_a(p_219091_1_, p_219075_2_.field_219435_b, p_219075_2_.field_219434_a, p_219075_2_.field_219436_c))))).join();
    }
    ...
    public void func_219066_a(ChunkPos pos, IntSupplier p_219066_2_, int p_219066_3_, IntConsumer p_219066_4_) {
        this.sorter.enqueue(new ITaskQueue.RunnableWithPriority(0, () -> {
            ...
            this.queues.values().forEach(p_219076_3_ -> p_219076_3_.func_219407_a(i, pos, p_219066_3_));
    ...
    private <T> void func_219074_a(ITaskExecutor<T> p_219074_1_, long p_219074_2_, Runnable p_219074_4_, boolean p_219074_5_) {
        this.sorter.enqueue(new ITaskQueue.RunnableWithPriority(1, () -> {
            ChunkTaskPriorityQueue chunktaskpriorityqueue = this.getQueue(p_219074_1_);
    ...
    private <T> void func_219067_a(ITaskExecutor<T> p_219067_1_, Function<ITaskExecutor<Unit>, T> p_219067_2_, long p_219067_3_, IntSupplier p_219067_5_, boolean p_219067_6_) {
        this.sorter.enqueue(new ITaskQueue.RunnableWithPriority(2, () -> {
            ChunkTaskPriorityQueue chunktaskpriorityqueue = this.getQueue(p_219067_1_);
    ...
    private <T> void func_219078_a(ChunkTaskPriorityQueue<Function<ITaskExecutor<Unit>, T>> p_219078_1_, ITaskExecutor<T> p_219078_2_) {
        this.sorter.enqueue(new ITaskQueue.RunnableWithPriority(3, () -> {
            Stream<Object> stream = p_219078_1_.func_219417_a();
            if (stream == null) {
                ...
                })).collect(Collectors.toList())).thenAccept(p_219088_3_ -> this.func_219078_a(p_219078_1_, p_219078_2_));
            }
        }));
    }

    private <T> ChunkTaskPriorityQueue<Function<ITaskExecutor<Unit>, T>> getQueue(ITaskExecutor<T> p_219068_1_) {
        ChunkTaskPriorityQueue<Function<ITaskExecutor<Unit>, T>> chunktaskpriorityqueue = this.queues.get(p_219068_1_);
        if (chunktaskpriorityqueue == null) {
            throw Util.pauseDevMode(new IllegalArgumentException("No queue for: " + String.valueOf(p_219068_1_)));
        }
    ...
    public String func_225396_a() {
        return this.queues.entrySet().stream().map(p_225397_0_ -> ((ITaskExecutor)p_225397_0_.getKey()).getName() + "=[" + ((ChunkTaskPriorityQueue)p_225397_0_.getValue()).getLoadedChunks().stream().map(p_225398_0_ -> p_225398_0_ + ":" + String.valueOf(new ChunkPos((long)p_225398_0_))).collect(Collectors.joining(",")) + "]").collect(Collectors.joining(",")) + ", s=" + this.field_219095_c.size();
    }
