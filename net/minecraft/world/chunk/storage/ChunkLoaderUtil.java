...
public class ChunkLoaderUtil {
    public static AnvilConverterData load(CompoundNBT nbt) {
        int i = nbt.getInt("xPos");
        int j = nbt.getInt("zPos");
        AnvilConverterData chunkloaderutil$anvilconverterdata = new AnvilConverterData(i, j);
    ...
    public static void func_242708_a(DynamicRegistries.Impl p_242708_0_, AnvilConverterData p_242708_1_, CompoundNBT p_242708_2_, BiomeProvider p_242708_3_) {
        ...
        for (int j = 0; j < 8; ++j) {
            ...
            compoundnbt.putByte("Y", (byte)(j & 0xFF));
