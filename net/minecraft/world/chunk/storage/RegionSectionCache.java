...
implements AutoCloseable {
    ...
    protected R func_235995_e_(long p_235995_1_) {
        ...
        R r = this.field_219124_f.apply(() -> this.markDirty(p_235995_1_));
    ...
    private CompoundNBT func_223138_c(ChunkPos p_223138_1_) {
        try {
            ...
            LOGGER.error("Error reading chunk {} data from disk", (Object)p_223138_1_, (Object)ioexception);
            return null;
        }
    }
    ...
    private <T> void func_235992_a_(ChunkPos p_235992_1_, DynamicOps<T> p_235992_2_, @Nullable T p_235992_3_) {
        if (p_235992_3_ == null) {
            for (int i = 0; i < 16; ++i) {
                this.data.put(SectionPos.from(p_235992_1_, i).asLong(), (Optional<R>)Optional.empty());
            }
        } else {
            int k;
            Dynamic<T> dynamic1 = new Dynamic<T>(p_235992_2_, p_235992_3_);
            int j = RegionSectionCache.func_235993_a_(dynamic1);
            boolean flag = j != (k = SharedConstants.getVersion().getWorldVersion());
            ...
            for (int l = 0; l < 16; ++l) {
                ...
                Optional optional = optionaldynamic.get(Integer.toString(l)).result().flatMap(p_235989_3_ -> this.field_235988_e_.apply(() -> this.markDirty(i1)).parse(p_235989_3_).resultOrPartial(LOGGER::error));
                this.data.put(i1, (Optional<R>)optional);
    ...
    private <T> Dynamic<T> func_235991_a_(ChunkPos p_235991_1_, DynamicOps<T> p_235991_2_) {
        ...
        for (int i = 0; i < 16; ++i) {
            ...
            Optional optional = (Optional)this.data.get(j);
            if (optional == null || !optional.isPresent()) continue;
            DataResult<T> dataresult = this.field_235988_e_.apply(() -> this.markDirty(j)).encodeStart(p_235991_2_, optional.get());
            String s = Integer.toString(i);
            dataresult.resultOrPartial(LOGGER::error).ifPresent(p_235994_3_ -> map.put(p_235991_2_.createString(s), p_235994_3_));
        }
        return new Dynamic<T>(p_235991_2_, p_235991_2_.createMap(ImmutableMap.of(p_235991_2_.createString("Sections"), p_235991_2_.createMap(map), p_235991_2_.createString("DataVersion"), p_235991_2_.createInt(SharedConstants.getVersion().getWorldVersion()))));
    }
    ...
    protected void markDirty(long sectionPosIn) {
        Optional optional = (Optional)this.data.get(sectionPosIn);
    ...
    public void saveIfDirty(ChunkPos p_219112_1_) {
        if (!this.dirtySections.isEmpty()) {
            for (int i = 0; i < 16; ++i) {
                ...
                if (!this.dirtySections.contains(j)) continue;
