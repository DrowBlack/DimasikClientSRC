...
public class FlatGenerationSettings {
    ...
    public static final Codec<FlatGenerationSettings> field_236932_a_ = RecordCodecBuilder.create(p_236938_0_ -> p_236938_0_.group(RegistryLookupCodec.getLookUpCodec(Registry.BIOME_KEY).forGetter(p_242874_0_ -> p_242874_0_.field_242867_d), ((MapCodec)DimensionStructuresSettings.field_236190_a_.fieldOf("structures")).forGetter(FlatGenerationSettings::func_236943_d_), ((MapCodec)FlatLayerInfo.field_236929_a_.listOf().fieldOf("layers")).forGetter(FlatGenerationSettings::getFlatLayers), ((MapCodec)Codec.BOOL.fieldOf("lakes")).orElse(false).forGetter(p_241528_0_ -> p_241528_0_.field_236935_l_), ((MapCodec)Codec.BOOL.fieldOf("features")).orElse(false).forGetter(p_242871_0_ -> p_242871_0_.field_236934_k_), Biome.BIOME_CODEC.optionalFieldOf("biome").orElseGet(Optional::empty).forGetter(p_242868_0_ -> Optional.of(p_242868_0_.biomeToUse))).apply((Applicative<FlatGenerationSettings, ?>)p_236938_0_, FlatGenerationSettings::new)).stable();
    ...
    public FlatGenerationSettings(Registry<Biome> p_i242012_1_, DimensionStructuresSettings p_i242012_2_, List<FlatLayerInfo> p_i242012_3_, boolean p_i242012_4_, boolean p_i242012_5_, Optional<Supplier<Biome>> p_i242012_6_) {
        ...
        if (!p_i242012_6_.isPresent()) {
            ...
            this.biomeToUse = () -> p_i242012_1_.getOrThrow(Biomes.PLAINS);
        } else {
    ...
    public FlatGenerationSettings(DimensionStructuresSettings p_i242011_1_, Registry<Biome> p_i242011_2_) {
        ...
        this.biomeToUse = () -> p_i242011_2_.getOrThrow(Biomes.PLAINS);
    }
    ...
    public Biome func_236942_c_() {
        ...
        boolean bl = flag = (!this.allAir || this.field_242867_d.getOptionalKey(biome).equals(Optional.of(Biomes.THE_VOID))) && this.field_236934_k_;
        if (flag) {
    ...
    public static FlatGenerationSettings func_242869_a(Registry<Biome> p_242869_0_) {
        ...
        flatgenerationsettings.biomeToUse = () -> p_242869_0_.getOrThrow(Biomes.PLAINS);
