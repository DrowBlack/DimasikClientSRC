...
public class SimplexNoiseGenerator {
    ...
    private double getContrib(int gradIndex, double x, double y, double z, double offset) {
        ...
        if (d1 < 0.0) {
            ...
            d1 *= d1;
            d0 = d1 * d1 * SimplexNoiseGenerator.processGrad(GRADS[gradIndex], x, y, z);
        }
        return d0;
    }
    ...
    public double getValue(double x, double y) {
        ...
        double d10 = this.getContrib(k1, d4, d5, 0.0, 0.5);
        double d11 = this.getContrib(l1, d6, d7, 0.0, 0.5);
        double d12 = this.getContrib(i2, d8, d9, 0.0, 0.5);
    ...
    public double func_227464_a_(double p_227464_1_, double p_227464_3_, double p_227464_5_) {
        ...
        double d19 = this.getContrib(i3, d7, d8, d9, 0.6);
        double d20 = this.getContrib(j3, d10, d11, d12, 0.6);
        double d21 = this.getContrib(k3, d13, d14, d15, 0.6);
        double d22 = this.getContrib(l3, d16, d17, d18, 0.6);
