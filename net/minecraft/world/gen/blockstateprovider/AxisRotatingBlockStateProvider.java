...
extends BlockStateProvider {
    public static final Codec<AxisRotatingBlockStateProvider> CODEC = ((MapCodec)BlockState.CODEC.fieldOf("state")).xmap(AbstractBlock.AbstractBlockState::getBlock, Block::getDefaultState).xmap(AxisRotatingBlockStateProvider::new, provider -> provider.block).codec();
    ...
    public BlockState getBlockState(Random randomIn, BlockPos blockPosIn) {
        ...
        return (BlockState)this.block.getDefaultState().with(RotatedPillarBlock.AXIS, direction$axis);
    }
}
