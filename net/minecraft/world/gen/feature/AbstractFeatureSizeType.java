...
public abstract class AbstractFeatureSizeType {
    ...
    protected static <S extends AbstractFeatureSizeType> RecordCodecBuilder<S, OptionalInt> func_236706_a_() {
        return Codec.intRange(0, 80).optionalFieldOf("min_clipped_height").xmap(p_236708_0_ -> p_236708_0_.map(OptionalInt::of).orElse(OptionalInt.empty()), p_236709_0_ -> p_236709_0_.isPresent() ? Optional.of(p_236709_0_.getAsInt()) : Optional.empty()).forGetter(p_236707_0_ -> p_236707_0_.field_236705_b_);
    }
