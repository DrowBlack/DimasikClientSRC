...
implements IFeatureConfig {
    public static final Codec<BasaltDeltasFeature> field_236495_a_ = RecordCodecBuilder.create(p_242803_0_ -> p_242803_0_.group(((MapCodec)BlockState.CODEC.fieldOf("contents")).forGetter(p_236506_0_ -> p_236506_0_.field_236496_b_), ((MapCodec)BlockState.CODEC.fieldOf("rim")).forGetter(p_236505_0_ -> p_236505_0_.field_236497_c_), ((MapCodec)FeatureSpread.func_242254_a(0, 8, 8).fieldOf("size")).forGetter(p_242805_0_ -> p_242805_0_.field_242800_d), ((MapCodec)FeatureSpread.func_242254_a(0, 8, 8).fieldOf("rim_size")).forGetter(p_242802_0_ -> p_242802_0_.field_242801_e)).apply((Applicative<BasaltDeltasFeature, ?>)p_242803_0_, BasaltDeltasFeature::new));
