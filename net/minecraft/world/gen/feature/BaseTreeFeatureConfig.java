...
implements IFeatureConfig {
    public static final Codec<BaseTreeFeatureConfig> CODEC = RecordCodecBuilder.create(p_236683_0_ -> p_236683_0_.group(((MapCodec)BlockStateProvider.CODEC.fieldOf("trunk_provider")).forGetter(p_236693_0_ -> p_236693_0_.trunkProvider), ((MapCodec)BlockStateProvider.CODEC.fieldOf("leaves_provider")).forGetter(p_236692_0_ -> p_236692_0_.leavesProvider), ((MapCodec)FoliagePlacer.field_236749_d_.fieldOf("foliage_placer")).forGetter(p_236691_0_ -> p_236691_0_.field_236677_f_), ((MapCodec)AbstractTrunkPlacer.field_236905_c_.fieldOf("trunk_placer")).forGetter(p_236690_0_ -> p_236690_0_.field_236678_g_), ((MapCodec)AbstractFeatureSizeType.field_236704_a_.fieldOf("minimum_size")).forGetter(p_236689_0_ -> p_236689_0_.field_236679_h_), ((MapCodec)TreeDecorator.field_236874_c_.listOf().fieldOf("decorators")).forGetter(p_236688_0_ -> p_236688_0_.decorators), ((MapCodec)Codec.INT.fieldOf("max_water_depth")).orElse(0).forGetter(p_236687_0_ -> p_236687_0_.field_236680_i_), ((MapCodec)Codec.BOOL.fieldOf("ignore_vines")).orElse(false).forGetter(p_236686_0_ -> p_236686_0_.field_236681_j_), ((MapCodec)Heightmap.Type.field_236078_g_.fieldOf("heightmap")).forGetter(p_236684_0_ -> p_236684_0_.field_236682_l_)).apply((Applicative<BaseTreeFeatureConfig, ?>)p_236683_0_, BaseTreeFeatureConfig::new));
    ...
    public static class Builder {
        ...
        public Builder func_236701_a_(int p_236701_1_) {
