    ...
    protected void func_225564_a_(IWorld p_225564_1_, Random p_225564_2_, BlockPos p_225564_3_, int p_225564_4_, BlockPos.Mutable p_225564_5_, BigMushroomFeatureConfig p_225564_6_) {
        ...
        for (int j = -i; j <= i; ++j) {
            for (int k = -i; k <= i; ++k) {
                ...
                this.setBlockState(p_225564_1_, p_225564_5_, (BlockState)((BlockState)((BlockState)((BlockState)p_225564_6_.field_227272_a_.getBlockState(p_225564_2_, p_225564_3_).with(HugeMushroomBlock.WEST, flag6)).with(HugeMushroomBlock.EAST, flag7)).with(HugeMushroomBlock.NORTH, flag8)).with(HugeMushroomBlock.SOUTH, flag9));
            }
        }
    }
