        ...
        for (int i = p_225564_4_ - 3; i <= p_225564_4_; ++i) {
            ...
            for (int l = -j; l <= j; ++l) {
                for (int i1 = -j; i1 <= j; ++i1) {
                    ...
                    if (p_225564_1_.getBlockState(p_225564_5_).isOpaqueCube(p_225564_1_, p_225564_5_)) continue;
                    this.setBlockState(p_225564_1_, p_225564_5_, (BlockState)((BlockState)((BlockState)((BlockState)((BlockState)p_225564_6_.field_227272_a_.getBlockState(p_225564_2_, p_225564_3_).with(HugeMushroomBlock.UP, i >= p_225564_4_ - 1)).with(HugeMushroomBlock.WEST, l < -k)).with(HugeMushroomBlock.EAST, l > k)).with(HugeMushroomBlock.NORTH, i1 < -k)).with(HugeMushroomBlock.SOUTH, i1 > k));
                }
            }
        }
    }
