    ...
    public boolean func_241855_a(ISeedReader p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_, BlockPos p_241855_4_, NoFeatureConfig p_241855_5_) {
        ...
        for (Integer integer : list) {
            for (Integer integer1 : list1) {
                ...
                if (!p_241855_1_.isAirBlock(blockpos) && !p_241855_1_.getBlockState(blockpos).getCollisionShape(p_241855_1_, blockpos).isEmpty()) continue;
                ...
                for (Direction direction : Direction.Plane.HORIZONTAL) {
                    ...
                    if (!blockstate.isValidPosition(p_241855_1_, blockpos1)) continue;
