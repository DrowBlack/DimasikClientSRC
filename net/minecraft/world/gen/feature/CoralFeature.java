...
extends Feature<NoFeatureConfig> {
    ...
    public boolean func_241855_a(ISeedReader p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_, BlockPos p_241855_4_, NoFeatureConfig p_241855_5_) {
        BlockState blockstate = ((Block)BlockTags.CORAL_BLOCKS.getRandomElement(p_241855_3_)).getDefaultState();
    ...
    protected boolean func_204624_b(IWorld p_204624_1_, Random p_204624_2_, BlockPos p_204624_3_, BlockState p_204624_4_) {
        ...
        if ((blockstate.isIn(Blocks.WATER) || blockstate.isIn(BlockTags.CORALS)) && p_204624_1_.getBlockState(blockpos).isIn(Blocks.WATER)) {
            ...
            if (p_204624_2_.nextFloat() < 0.25f) {
                p_204624_1_.setBlockState(blockpos, ((Block)BlockTags.CORALS.getRandomElement(p_204624_2_)).getDefaultState(), 2);
            } else if (p_204624_2_.nextFloat() < 0.05f) {
                p_204624_1_.setBlockState(blockpos, (BlockState)Blocks.SEA_PICKLE.getDefaultState().with(SeaPickleBlock.PICKLES, p_204624_2_.nextInt(4) + 1), 2);
            }
            for (Direction direction : Direction.Plane.HORIZONTAL) {
                BlockPos blockpos1;
                if (!(p_204624_2_.nextFloat() < 0.2f) || !p_204624_1_.getBlockState(blockpos1 = p_204624_3_.offset(direction)).isIn(Blocks.WATER)) continue;
                BlockState blockstate1 = (BlockState)((Block)BlockTags.WALL_CORALS.getRandomElement(p_204624_2_)).getDefaultState().with(DeadCoralWallFanBlock.FACING, direction);
