        ...
        for (int k2 = k; k2 <= l; ++k2) {
            for (int l2 = -1; l2 <= 4; ++l2) {
                for (int i3 = l1; i3 <= i2; ++i3) {
                    ...
                    if (k2 != k && k2 != l && i3 != l1 && i3 != i2 || l2 != 0 || !p_241855_1_.isAirBlock(blockpos) || !p_241855_1_.isAirBlock(blockpos.up())) continue;
                    ++j2;
                }
            }
        }
        if (j2 >= 1 && j2 <= 5) {
                ...
                for (int i4 = 3; i4 >= -1; --i4) {
                    for (int k4 = l1; k4 <= i2; ++k4) {
                        ...
                        if (k3 != k && i4 != -1 && k4 != l1 && k3 != l && i4 != 4 && k4 != i2) {
                            if (blockstate.isIn(Blocks.CHEST) || blockstate.isIn(Blocks.SPAWNER)) continue;
                            p_241855_1_.setBlockState(blockpos1, CAVE_AIR, 2);
                            continue;
                        }
                        if (blockpos1.getY() >= 0 && !p_241855_1_.getBlockState(blockpos1.down()).getMaterial().isSolid()) {
                            p_241855_1_.setBlockState(blockpos1, CAVE_AIR, 2);
                            continue;
                        }
                        if (!blockstate.getMaterial().isSolid() || blockstate.isIn(Blocks.CHEST)) continue;
            ...
            block6: for (int l3 = 0; l3 < 2; ++l3) {
                for (int j4 = 0; j4 < 3; ++j4) {
                    ...
                    BlockPos blockpos2 = new BlockPos(l4, i5 = p_241855_4_.getY(), j5 = p_241855_4_.getZ() + p_241855_3_.nextInt(k1 * 2 + 1) - k1);
                    if (!p_241855_1_.isAirBlock(blockpos2)) continue;
                    int j3 = 0;
                    for (Direction direction : Direction.Plane.HORIZONTAL) {
                        if (!p_241855_1_.getBlockState(blockpos2.offset(direction)).getMaterial().isSolid()) continue;
                        ++j3;
                    }
                    if (j3 != true) continue;
            ...
            if (tileentity instanceof MobSpawnerTileEntity) {
                ...
                LOGGER.error("Failed to fetch mob spawner entity at ({}, {}, {})", (Object)p_241855_4_.getX(), (Object)p_241855_4_.getY(), (Object)p_241855_4_.getZ());
            }
            return true;
        }
        return false;
