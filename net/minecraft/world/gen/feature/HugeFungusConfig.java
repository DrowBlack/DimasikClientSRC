...
implements IFeatureConfig {
    public static final Codec<HugeFungusConfig> field_236298_a_ = RecordCodecBuilder.create(p_236309_0_ -> p_236309_0_.group(((MapCodec)BlockState.CODEC.fieldOf("valid_base_block")).forGetter(p_236313_0_ -> p_236313_0_.field_236303_f_), ((MapCodec)BlockState.CODEC.fieldOf("stem_state")).forGetter(p_236312_0_ -> p_236312_0_.field_236304_g_), ((MapCodec)BlockState.CODEC.fieldOf("hat_state")).forGetter(p_236311_0_ -> p_236311_0_.field_236305_h_), ((MapCodec)BlockState.CODEC.fieldOf("decor_state")).forGetter(p_236310_0_ -> p_236310_0_.field_236306_i_), ((MapCodec)Codec.BOOL.fieldOf("planted")).orElse(false).forGetter(p_236308_0_ -> p_236308_0_.field_236307_j_)).apply((Applicative<HugeFungusConfig, ?>)p_236309_0_, HugeFungusConfig::new));
