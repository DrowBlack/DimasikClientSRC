    ...
    public boolean func_241855_a(ISeedReader p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_, BlockPos p_241855_4_, NoFeatureConfig p_241855_5_) {
        ...
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                ...
                if (!biome.doesSnowGenerate(p_241855_1_, blockpos$mutable)) continue;
                ...
                p_241855_1_.setBlockState(blockpos$mutable1, (BlockState)blockstate.with(SnowyDirtBlock.SNOWY, true), 2);
            }
        }
        return true;
    }
