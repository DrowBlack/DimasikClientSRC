        ...
        if (p_241855_1_.getBlockState(blockpos).isIn(Blocks.WATER)) {
            ...
            for (int l = 0; l <= k; ++l) {
                if (p_241855_1_.getBlockState(blockpos).isIn(Blocks.WATER) && p_241855_1_.getBlockState(blockpos.up()).isIn(Blocks.WATER) && blockstate1.isValidPosition(p_241855_1_, blockpos)) {
                    if (l == k) {
                        p_241855_1_.setBlockState(blockpos, (BlockState)blockstate.with(KelpTopBlock.AGE, p_241855_3_.nextInt(4) + 20), 2);
                        ++i;
                    } else {
                    ...
                    if (!blockstate.isValidPosition(p_241855_1_, blockpos1) || p_241855_1_.getBlockState(blockpos1.down()).isIn(Blocks.KELP)) break;
                    p_241855_1_.setBlockState(blockpos1, (BlockState)blockstate.with(KelpTopBlock.AGE, p_241855_3_.nextInt(4) + 20), 2);
                    ++i;
                    break;
                }
