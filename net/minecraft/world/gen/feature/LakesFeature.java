...
extends Feature<BlockStateFeatureConfig> {
    ...
    public boolean func_241855_a(ISeedReader p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_, BlockPos p_241855_4_, BlockStateFeatureConfig p_241855_5_) {
        ...
        if (p_241855_1_.func_241827_a(SectionPos.from(p_241855_4_ = p_241855_4_.down(4)), Structure.field_236381_q_).findAny().isPresent()) {
            return false;
        }
        ...
        for (int k1 = 0; k1 < 16; ++k1) {
            for (int l2 = 0; l2 < 16; ++l2) {
                for (int k = 0; k < 8; ++k) {
                    ...
                    if (k >= 4 || material.isSolid() || p_241855_1_.getBlockState(p_241855_4_.add(k1, k, l2)) == p_241855_5_.state) continue;
                    return false;
                }
            }
        }
        ...
        for (int i2 = 0; i2 < 16; ++i2) {
            for (int j3 = 0; j3 < 16; ++j3) {
                for (int j4 = 4; j4 < 8; ++j4) {
                    BlockPos blockpos;
                    if (!aboolean[(i2 * 16 + j3) * 8 + j4] || !LakesFeature.isDirt(p_241855_1_.getBlockState(blockpos = p_241855_4_.add(i2, j4 - 1, j3)).getBlock()) || p_241855_1_.getLightFor(LightType.SKY, p_241855_4_.add(i2, j4, j3)) <= 0) continue;
            ...
            for (int j2 = 0; j2 < 16; ++j2) {
                for (int k3 = 0; k3 < 16; ++k3) {
                    for (int k4 = 0; k4 < 8; ++k4) {
                        ...
                        if (!flag1 || k4 >= 4 && p_241855_3_.nextInt(2) == 0 || !p_241855_1_.getBlockState(p_241855_4_.add(j2, k4, k3)).getMaterial().isSolid()) continue;
        ...
        if (p_241855_5_.state.getMaterial() == Material.WATER) {
            for (int k2 = 0; k2 < 16; ++k2) {
                for (int l3 = 0; l3 < 16; ++l3) {
                    ...
                    if (!p_241855_1_.getBiome(blockpos1).doesWaterFreeze(p_241855_1_, blockpos1, false)) continue;
