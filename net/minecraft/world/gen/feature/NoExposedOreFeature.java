...
extends Feature<OreFeatureConfig> {
    ...
    public boolean func_241855_a(ISeedReader p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_, BlockPos p_241855_4_, OreFeatureConfig p_241855_5_) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            if (!p_241855_5_.target.test(p_241855_1_.getBlockState(blockpos$mutable), p_241855_3_) || this.func_236326_a_(p_241855_1_, blockpos$mutable)) continue;
    ...
    private boolean func_236326_a_(IWorld p_236326_1_, BlockPos p_236326_2_) {
        ...
        for (Direction direction : Direction.values()) {
            ...
            if (!p_236326_1_.getBlockState(blockpos$mutable).isAir()) continue;
            return true;
        }
        return false;
    }
