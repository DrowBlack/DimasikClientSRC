...
extends Feature<FeatureSpreadConfig> {
    ...
    public boolean func_241855_a(ISeedReader p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_, BlockPos p_241855_4_, FeatureSpreadConfig p_241855_5_) {
        ...
        for (int k = 0; k < j; ++k) {
            ...
            BlockState blockstate = (BlockState)Blocks.SEA_PICKLE.getDefaultState().with(SeaPickleBlock.PICKLES, p_241855_3_.nextInt(4) + 1);
            if (!p_241855_1_.getBlockState(blockpos).isIn(Blocks.WATER) || !blockstate.isValidPosition(p_241855_1_, blockpos)) continue;
