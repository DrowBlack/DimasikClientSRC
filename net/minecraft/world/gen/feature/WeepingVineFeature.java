...
extends Feature<NoFeatureConfig> {
    ...
    private void func_236428_a_(IWorld p_236428_1_, Random p_236428_2_, BlockPos p_236428_3_) {
        ...
        for (int i = 0; i < 200; ++i) {
            ...
            if (!p_236428_1_.isAirBlock(blockpos$mutable)) continue;
            int j = 0;
    ...
    private void func_236429_b_(IWorld p_236429_1_, Random p_236429_2_, BlockPos p_236429_3_) {
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            if (!p_236429_1_.isAirBlock(blockpos$mutable) || !(blockstate = p_236429_1_.getBlockState((BlockPos)blockpos$mutable.up())).isIn(Blocks.NETHERRACK) && !blockstate.isIn(Blocks.NETHER_WART_BLOCK)) continue;
            ...
            int k = 17;
            int l = 25;
            WeepingVineFeature.func_236427_a_(p_236429_1_, p_236429_2_, blockpos$mutable, j, 17, 25);
        }
    }
    ...
    public static void func_236427_a_(IWorld p_236427_0_, Random p_236427_1_, BlockPos.Mutable p_236427_2_, int p_236427_3_, int p_236427_4_, int p_236427_5_) {
        for (int i = 0; i <= p_236427_3_; ++i) {
            if (p_236427_0_.isAirBlock(p_236427_2_)) {
                if (i == p_236427_3_ || !p_236427_0_.isAirBlock((BlockPos)p_236427_2_.down())) {
                    p_236427_0_.setBlockState(p_236427_2_, (BlockState)Blocks.WEEPING_VINES.getDefaultState().with(AbstractTopPlantBlock.AGE, MathHelper.nextInt(p_236427_1_, p_236427_4_, p_236427_5_)), 2);
                    break;
                }
