...
public class IglooPieces {
    ...
    public static void func_236991_a_(TemplateManager p_236991_0_, BlockPos p_236991_1_, Rotation p_236991_2_, List<StructurePiece> p_236991_3_, Random p_236991_4_) {
        if (p_236991_4_.nextDouble() < 0.5) {
            ...
            p_236991_3_.add(new Piece(p_236991_0_, field_202594_g, p_236991_1_, p_236991_2_, i * 3));
            for (int j = 0; j < i - 1; ++j) {
                p_236991_3_.add(new Piece(p_236991_0_, field_202593_f, p_236991_1_, p_236991_2_, j * 3));
            }
        }
        p_236991_3_.add(new Piece(p_236991_0_, field_202592_e, p_236991_1_, p_236991_2_, 0));
    }
    ...
    extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager p_i49313_1_, ResourceLocation p_i49313_2_, BlockPos p_i49313_3_, Rotation p_i49313_4_, int p_i49313_5_) {
            ...
            BlockPos blockpos = field_207622_e.get(p_i49313_2_);
        ...
        public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_) {
            ...
            PlacementSettings placementsettings = new PlacementSettings().setRotation(this.field_207616_e).setMirror(Mirror.NONE).setCenterOffset(field_207621_d.get(this.field_207615_d)).addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK);
            BlockPos blockpos = field_207622_e.get(this.field_207615_d);
            ...
            if (this.field_207615_d.equals(field_202592_e) && !(blockstate = p_230383_1_.getBlockState((blockpos3 = this.templatePosition.add(Template.transformedBlockPos(placementsettings, new BlockPos(3, 0, 5)))).down())).isAir() && !blockstate.isIn(Blocks.LADDER)) {
