...
extends Structure<NoFeatureConfig> {
    ...
    extends MarginedStructureStart<NoFeatureConfig> {
        ...
        public void func_230364_a_(DynamicRegistries p_230364_1_, ChunkGenerator p_230364_2_, TemplateManager p_230364_3_, int p_230364_4_, int p_230364_5_, Biome p_230364_6_, NoFeatureConfig p_230364_7_) {
            ...
            BlockPos.Mutable blockpos$mutable = new BlockPos.Mutable(i, l, j);
            for (l = k + this.rand.nextInt(p_230364_2_.func_230355_e_() - 2 - k); l > k; --l) {
                ...
                if (blockstate.isAir() && (blockstate1.isIn(Blocks.SOUL_SAND) || blockstate1.isSolidSide(iblockreader, blockpos$mutable, Direction.UP))) break;
            }
            if (l > k) {
