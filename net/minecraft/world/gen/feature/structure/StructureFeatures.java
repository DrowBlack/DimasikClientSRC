...
public class StructureFeatures {
    public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> field_244135_a = StructureFeatures.func_244162_a("pillager_outpost", Structure.field_236366_b_.func_236391_a_(new VillageConfig(() -> PillagerOutpostPools.field_244088_a, 7)));
    ...
    public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> field_244153_s = StructureFeatures.func_244162_a("bastion_remnant", Structure.field_236383_s_.func_236391_a_(new VillageConfig(() -> BastionRemnantsPieces.field_243686_a, 6)));
    public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> field_244154_t = StructureFeatures.func_244162_a("village_plains", Structure.field_236381_q_.func_236391_a_(new VillageConfig(() -> PlainsVillagePools.field_244090_a, 6)));
    public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> field_244155_u = StructureFeatures.func_244162_a("village_desert", Structure.field_236381_q_.func_236391_a_(new VillageConfig(() -> DesertVillagePools.field_243774_a, 6)));
    public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> field_244156_v = StructureFeatures.func_244162_a("village_savanna", Structure.field_236381_q_.func_236391_a_(new VillageConfig(() -> SavannaVillagePools.field_244128_a, 6)));
    public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> field_244157_w = StructureFeatures.func_244162_a("village_snowy", Structure.field_236381_q_.func_236391_a_(new VillageConfig(() -> SnowyVillagePools.field_244129_a, 6)));
    public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> field_244158_x = StructureFeatures.func_244162_a("village_taiga", Structure.field_236381_q_.func_236391_a_(new VillageConfig(() -> TaigaVillagePools.field_244193_a, 6)));
