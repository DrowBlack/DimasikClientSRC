...
extends PosRuleTest {
    public static final Codec<LinearPosTest> field_237087_a_ = RecordCodecBuilder.create(p_237092_0_ -> p_237092_0_.group(((MapCodec)Codec.FLOAT.fieldOf("min_chance")).orElse(Float.valueOf(0.0f)).forGetter(p_237096_0_ -> Float.valueOf(p_237096_0_.field_237088_b_)), ((MapCodec)Codec.FLOAT.fieldOf("max_chance")).orElse(Float.valueOf(0.0f)).forGetter(p_237095_0_ -> Float.valueOf(p_237095_0_.field_237089_d_)), ((MapCodec)Codec.INT.fieldOf("min_dist")).orElse(0).forGetter(p_237094_0_ -> p_237094_0_.field_237090_e_), ((MapCodec)Codec.INT.fieldOf("max_dist")).orElse(0).forGetter(p_237093_0_ -> p_237093_0_.field_237091_f_)).apply((Applicative<LinearPosTest, ?>)p_237092_0_, LinearPosTest::new));
    ...
    public boolean func_230385_a_(BlockPos p_230385_1_, BlockPos p_230385_2_, BlockPos p_230385_3_, Random p_230385_4_) {
        ...
        return (double)f <= MathHelper.clampedLerp(this.field_237088_b_, this.field_237089_d_, MathHelper.func_233020_c_(i, this.field_237090_e_, this.field_237091_f_));
    }
