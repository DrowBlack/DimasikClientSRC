...
public class RuleEntry {
    public static final Codec<RuleEntry> field_237108_a_ = RecordCodecBuilder.create(p_237111_0_ -> p_237111_0_.group(((MapCodec)RuleTest.field_237127_c_.fieldOf("input_predicate")).forGetter(p_237116_0_ -> p_237116_0_.inputPredicate), ((MapCodec)RuleTest.field_237127_c_.fieldOf("location_predicate")).forGetter(p_237115_0_ -> p_237115_0_.locationPredicate), PosRuleTest.field_237102_c_.optionalFieldOf("position_predicate", AlwaysTrueTest.field_237100_b_).forGetter(p_237114_0_ -> p_237114_0_.field_237109_d_), ((MapCodec)BlockState.CODEC.fieldOf("output_state")).forGetter(p_237113_0_ -> p_237113_0_.outputState), CompoundNBT.CODEC.optionalFieldOf("output_nbt").forGetter(p_237112_0_ -> Optional.ofNullable(p_237112_0_.outputNbt))).apply((Applicative<RuleEntry, ?>)p_237111_0_, RuleEntry::new));
    ...
    public RuleEntry(RuleTest p_i232118_1_, RuleTest p_i232118_2_, PosRuleTest p_i232118_3_, BlockState p_i232118_4_, Optional<CompoundNBT> p_i232118_5_) {
        ...
        this.outputNbt = p_i232118_5_.orElse(null);
    }
