...
public class Template {
    ...
    public boolean func_237146_a_(IServerWorld p_237146_1_, BlockPos p_237146_2_, BlockPos p_237146_3_, PlacementSettings p_237146_4_, Random p_237146_5_, int p_237146_6_) {
        ...
        if (!(list.isEmpty() && (p_237146_4_.getIgnoreEntities() || this.entities.isEmpty()) || this.size.getX() < 1 || this.size.getY() < 1 || this.size.getZ() < 1)) {
            ...
            ArrayList<BlockPos> list1 = Lists.newArrayListWithCapacity(p_237146_4_.func_204763_l() ? list.size() : 0);
            ArrayList<Pair<BlockPos, CompoundNBT>> list2 = Lists.newArrayListWithCapacity(list.size());
            ...
            while (flag && !list1.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    FluidState fluidstate2 = p_237146_1_.getFluidState(blockPos);
                    for (int k1 = 0; k1 < adirection.length && !fluidstate2.isSource(); ++k1) {
                        BlockPos blockPos2 = blockpos3.offset(adirection[k1]);
                        FluidState fluidstate1 = p_237146_1_.getFluidState(blockPos2);
                        if (!(fluidstate1.getActualHeight(p_237146_1_, blockPos2) > fluidstate2.getActualHeight(p_237146_1_, blockpos3)) && (!fluidstate1.isSource() || fluidstate2.isSource())) continue;
                        fluidstate2 = fluidstate1;
                        blockpos3 = blockPos2;
                    }
                    if (!fluidstate2.isSource() || !((block = (blockstate2 = p_237146_1_.getBlockState(blockPos)).getBlock()) instanceof ILiquidContainer)) continue;
                    ((ILiquidContainer)((Object)block)).receiveFluid(p_237146_1_, blockPos, blockstate2, fluidstate2);
                    flag = true;
                    iterator.remove();
                }
            }
            if (i <= l) {
                if (!p_237146_4_.func_215218_i()) {
                    ...
                    for (Pair pair : list2) {
                        ...
                        ((VoxelShapePart)voxelshapepart).setFilled(blockpos5.getX() - n, blockpos5.getY() - i2, blockpos5.getZ() - j2, true, true);
                    }
                    Template.func_222857_a(p_237146_1_, p_237146_6_, voxelshapepart, n, i2, j2);
                }
                for (Pair pair : list2) {
    ...
    public CompoundNBT writeToNBT(CompoundNBT nbt) {
        if (this.blocks.isEmpty()) {
            ...
            ArrayList<BasicPalette> list = Lists.newArrayList();
