...
public abstract class FoliagePlacer {
    ...
    protected static <P extends FoliagePlacer> Products.P2<RecordCodecBuilder.Mu<P>, FeatureSpread, FeatureSpread> func_242830_b(RecordCodecBuilder.Instance<P> p_242830_0_) {
        return p_242830_0_.group(((MapCodec)FeatureSpread.func_242254_a(0, 8, 8).fieldOf("radius")).forGetter(p_242829_0_ -> p_242829_0_.field_227381_a_), ((MapCodec)FeatureSpread.func_242254_a(0, 8, 8).fieldOf("offset")).forGetter(p_242828_0_ -> p_242828_0_.field_236750_g_));
    }
    ...
    protected void func_236753_a_(IWorldGenerationReader p_236753_1_, Random p_236753_2_, BaseTreeFeatureConfig p_236753_3_, BlockPos p_236753_4_, int p_236753_5_, Set<BlockPos> p_236753_6_, int p_236753_7_, boolean p_236753_8_, MutableBoundingBox p_236753_9_) {
        ...
        for (int j = -p_236753_5_; j <= p_236753_5_ + i; ++j) {
            for (int k = -p_236753_5_; k <= p_236753_5_ + i; ++k) {
                if (this.func_230375_b_(p_236753_2_, j, p_236753_7_, k, p_236753_5_, p_236753_8_)) continue;
                blockpos$mutable.setAndOffset(p_236753_4_, j, p_236753_7_, k);
                if (!TreeFeature.isReplaceableAt(p_236753_1_, blockpos$mutable)) continue;
