...
extends FoliagePlacer {
    public static final Codec<JungleFoliagePlacer> field_236774_a_ = RecordCodecBuilder.create(p_236776_0_ -> JungleFoliagePlacer.func_242830_b(p_236776_0_).and(((MapCodec)Codec.intRange(0, 16).fieldOf("height")).forGetter(p_236777_0_ -> p_236777_0_.field_236775_b_)).apply((Applicative<JungleFoliagePlacer, ?>)p_236776_0_, JungleFoliagePlacer::new));
