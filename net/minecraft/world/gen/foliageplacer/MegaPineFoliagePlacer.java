...
extends FoliagePlacer {
    public static final Codec<MegaPineFoliagePlacer> field_236778_a_ = RecordCodecBuilder.create(p_242832_0_ -> MegaPineFoliagePlacer.func_242830_b(p_242832_0_).and(((MapCodec)FeatureSpread.func_242254_a(0, 16, 8).fieldOf("crown_height")).forGetter(p_242831_0_ -> p_242831_0_.field_236780_c_)).apply((Applicative<MegaPineFoliagePlacer, ?>)p_242832_0_, MegaPineFoliagePlacer::new));
