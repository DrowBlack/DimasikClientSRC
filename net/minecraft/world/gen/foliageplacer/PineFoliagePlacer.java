...
extends FoliagePlacer {
    public static final Codec<PineFoliagePlacer> field_236784_a_ = RecordCodecBuilder.create(p_242834_0_ -> PineFoliagePlacer.func_242830_b(p_242834_0_).and(((MapCodec)FeatureSpread.func_242254_a(0, 16, 8).fieldOf("height")).forGetter(p_242833_0_ -> p_242833_0_.field_236785_b_)).apply((Applicative<PineFoliagePlacer, ?>)p_242834_0_, PineFoliagePlacer::new));
    ...
    protected void func_230372_a_(IWorldGenerationReader p_230372_1_, Random p_230372_2_, BaseTreeFeatureConfig p_230372_3_, int p_230372_4_, FoliagePlacer.Foliage p_230372_5_, int p_230372_6_, int p_230372_7_, Set<BlockPos> p_230372_8_, int p_230372_9_, MutableBoundingBox p_230372_10_) {
        ...
        for (int j = p_230372_9_; j >= p_230372_9_ - p_230372_6_; --j) {
            ...
            if (i >= p_230372_7_ + p_230372_5_.func_236764_b_()) continue;
            ++i;
        }
    }
