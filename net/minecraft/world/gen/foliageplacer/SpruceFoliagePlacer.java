...
extends FoliagePlacer {
    public static final Codec<SpruceFoliagePlacer> field_236790_a_ = RecordCodecBuilder.create(p_242836_0_ -> SpruceFoliagePlacer.func_242830_b(p_242836_0_).and(((MapCodec)FeatureSpread.func_242254_a(0, 16, 8).fieldOf("trunk_height")).forGetter(p_242835_0_ -> p_242835_0_.field_236791_b_)).apply((Applicative<SpruceFoliagePlacer, ?>)p_242836_0_, SpruceFoliagePlacer::new));
