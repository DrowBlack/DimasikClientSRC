...
implements IDecoratable<ConfiguredPlacement<?>> {
    public static final Codec<ConfiguredPlacement<?>> field_236952_a_ = Registry.DECORATOR.dispatch("type", p_236954_0_ -> p_236954_0_.decorator, Placement::getCodec);
    ...
    public ConfiguredPlacement<?> withPlacement(ConfiguredPlacement<?> p_227228_1_) {
        return new ConfiguredPlacement<DecoratedPlacementConfig>(Placement.field_242896_B, new DecoratedPlacementConfig(p_227228_1_, this));
    }
