...
public class DimensionStructuresSettings {
    public static final Codec<DimensionStructuresSettings> field_236190_a_ = RecordCodecBuilder.create(p_236198_0_ -> p_236198_0_.group(StructureSpreadSettings.field_236656_a_.optionalFieldOf("stronghold").forGetter(p_236200_0_ -> Optional.ofNullable(p_236200_0_.field_236194_e_)), Codec.simpleMap(Registry.STRUCTURE_FEATURE, StructureSeparationSettings.field_236664_a_, Registry.STRUCTURE_FEATURE).fieldOf("structures").forGetter(p_236196_0_ -> p_236196_0_.field_236193_d_)).apply((Applicative<DimensionStructuresSettings, ?>)p_236198_0_, DimensionStructuresSettings::new));
    ...
    public DimensionStructuresSettings(Optional<StructureSpreadSettings> p_i231912_1_, Map<Structure<?>, StructureSeparationSettings> p_i231912_2_) {
        this.field_236194_e_ = p_i231912_1_.orElse(null);
    ...
    static {
        for (Structure structure : Registry.STRUCTURE_FEATURE) {
            ...
            throw new IllegalStateException("Structure feature without default settings: " + String.valueOf(Registry.STRUCTURE_FEATURE.getKey(structure)));
        }
