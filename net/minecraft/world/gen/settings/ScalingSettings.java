...
public class ScalingSettings {
    ...
    public static final Codec<ScalingSettings> field_236145_a_ = RecordCodecBuilder.create(p_236152_0_ -> p_236152_0_.group(((MapCodec)field_236146_b_.fieldOf("xz_scale")).forGetter(ScalingSettings::func_236151_a_), ((MapCodec)field_236146_b_.fieldOf("y_scale")).forGetter(ScalingSettings::func_236153_b_), ((MapCodec)field_236146_b_.fieldOf("xz_factor")).forGetter(ScalingSettings::func_236154_c_), ((MapCodec)field_236146_b_.fieldOf("y_factor")).forGetter(ScalingSettings::func_236155_d_)).apply((Applicative<ScalingSettings, ?>)p_236152_0_, ScalingSettings::new));
