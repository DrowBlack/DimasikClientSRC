...
public class SlideSettings {
    public static final Codec<SlideSettings> field_236182_a_ = RecordCodecBuilder.create(p_236187_0_ -> p_236187_0_.group(((MapCodec)Codec.INT.fieldOf("target")).forGetter(SlideSettings::func_236186_a_), ((MapCodec)Codec.intRange(0, 256).fieldOf("size")).forGetter(SlideSettings::func_236188_b_), ((MapCodec)Codec.INT.fieldOf("offset")).forGetter(SlideSettings::func_236189_c_)).apply((Applicative<SlideSettings, ?>)p_236187_0_, SlideSettings::new));
