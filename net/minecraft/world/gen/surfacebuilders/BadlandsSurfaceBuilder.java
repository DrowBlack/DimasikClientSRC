...
extends SurfaceBuilder<SurfaceBuilderConfig> {
    ...
    public void setSeed(long seed) {
        ...
        if (this.field_215433_b != seed || this.field_215435_c == null || this.field_215437_d == null) {
            ...
            this.field_215437_d = new PerlinNoiseGenerator(sharedseedrandom, ImmutableList.of(Integer.valueOf(0)));
        }
    ...
    protected void func_215430_b(long p_215430_1_) {
        ...
        this.field_215439_e = new PerlinNoiseGenerator(sharedseedrandom, ImmutableList.of(Integer.valueOf(0)));
    ...
    protected BlockState func_215431_a(int p_215431_1_, int p_215431_2_, int p_215431_3_) {
        int i = (int)Math.round(this.field_215439_e.noiseAt((double)p_215431_1_ / 512.0, (double)p_215431_3_ / 512.0, false) * 2.0);
