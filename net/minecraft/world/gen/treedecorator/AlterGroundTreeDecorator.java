...
extends TreeDecorator {
    public static final Codec<AlterGroundTreeDecorator> field_236859_a_ = ((MapCodec)BlockStateProvider.CODEC.fieldOf("provider")).xmap(AlterGroundTreeDecorator::new, p_236862_0_ -> p_236862_0_.field_227410_b_).codec();
    ...
    private void func_227414_b_(IWorldGenerationReader p_227414_1_, Random p_227414_2_, BlockPos p_227414_3_) {
        for (int i = 2; i >= -3; --i) {
            ...
            if (!Feature.isAirAt(p_227414_1_, blockpos) && i < 0) break;
        }
    }
}
