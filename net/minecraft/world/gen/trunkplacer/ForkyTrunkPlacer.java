...
extends AbstractTrunkPlacer {
    public static final Codec<ForkyTrunkPlacer> field_236896_a_ = RecordCodecBuilder.create(p_236897_0_ -> ForkyTrunkPlacer.func_236915_a_(p_236897_0_).apply(p_236897_0_, ForkyTrunkPlacer::new));
    ...
    public List<FoliagePlacer.Foliage> func_230382_a_(IWorldGenerationReader p_230382_1_, Random p_230382_2_, int p_230382_3_, BlockPos p_230382_4_, Set<BlockPos> p_230382_5_, MutableBoundingBox p_230382_6_, BaseTreeFeatureConfig p_230382_7_) {
        ForkyTrunkPlacer.func_236909_a_(p_230382_1_, p_230382_4_.down());
        ...
        for (int j1 = 0; j1 < p_230382_3_; ++j1) {
            ...
            if (!ForkyTrunkPlacer.func_236911_a_(p_230382_1_, p_230382_2_, blockpos$mutable.setPos(k, k1, l), p_230382_5_, p_230382_6_, p_230382_7_)) continue;
            i1 = k1 + 1;
        }
        ...
        if (direction1 != direction) {
            ...
            for (int i2 = k2; i2 < p_230382_3_ && l1 > 0; ++i2, --l1) {
                ...
                if (!ForkyTrunkPlacer.func_236911_a_(p_230382_1_, p_230382_2_, blockpos$mutable.setPos(k += direction1.getXOffset(), j2, l += direction1.getZOffset()), p_230382_5_, p_230382_6_, p_230382_7_)) continue;
                i1 = j2 + 1;
            }
            if (i1 > 1) {
