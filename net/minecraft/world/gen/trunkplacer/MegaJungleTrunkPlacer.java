...
extends GiantTrunkPlacer {
    public static final Codec<MegaJungleTrunkPlacer> field_236901_b_ = RecordCodecBuilder.create(p_236902_0_ -> MegaJungleTrunkPlacer.func_236915_a_(p_236902_0_).apply(p_236902_0_, MegaJungleTrunkPlacer::new));
    ...
    public List<FoliagePlacer.Foliage> func_230382_a_(IWorldGenerationReader p_230382_1_, Random p_230382_2_, int p_230382_3_, BlockPos p_230382_4_, Set<BlockPos> p_230382_5_, MutableBoundingBox p_230382_6_, BaseTreeFeatureConfig p_230382_7_) {
        ...
        for (int i = p_230382_3_ - 2 - p_230382_2_.nextInt(4); i > p_230382_3_ / 2; i -= 2 + p_230382_2_.nextInt(4)) {
            ...
            for (int l = 0; l < 5; ++l) {
                ...
                MegaJungleTrunkPlacer.func_236911_a_(p_230382_1_, p_230382_2_, blockpos, p_230382_5_, p_230382_6_, p_230382_7_);
            }
