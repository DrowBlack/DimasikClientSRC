...
extends AbstractTrunkPlacer {
    public static final Codec<StraightTrunkPlacer> field_236903_a_ = RecordCodecBuilder.create(p_236904_0_ -> StraightTrunkPlacer.func_236915_a_(p_236904_0_).apply(p_236904_0_, StraightTrunkPlacer::new));
    ...
    public List<FoliagePlacer.Foliage> func_230382_a_(IWorldGenerationReader p_230382_1_, Random p_230382_2_, int p_230382_3_, BlockPos p_230382_4_, Set<BlockPos> p_230382_5_, MutableBoundingBox p_230382_6_, BaseTreeFeatureConfig p_230382_7_) {
        StraightTrunkPlacer.func_236909_a_(p_230382_1_, p_230382_4_.down());
        for (int i = 0; i < p_230382_3_; ++i) {
            StraightTrunkPlacer.func_236911_a_(p_230382_1_, p_230382_2_, p_230382_4_.up(i), p_230382_5_, p_230382_6_, p_230382_7_);
        }
