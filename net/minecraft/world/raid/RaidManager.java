...
extends WorldSavedData {
    ...
    public RaidManager(ServerWorld p_i50142_1_) {
        super(RaidManager.func_234620_a_(p_i50142_1_.getDimensionType()));
    ...
    public Raid badOmenTick(ServerPlayerEntity p_215170_1_) {
        ...
        if (i > 0) {
            vector3d = vector3d.scale(1.0 / (double)i);
        ...
        if (!raid.isStarted()) {
            ...
            p_215170_1_.connection.sendPacket(new SEntityStatusPacket(p_215170_1_, 43));
        }
        if (flag) {
