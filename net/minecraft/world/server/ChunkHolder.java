...
public class ChunkHolder {
    ...
    public CompletableFuture<Either<IChunk, IChunkLoadingError>> func_219276_a(ChunkStatus p_219276_1_, ChunkManager p_219276_2_) {
        ...
        if (ChunkHolder.getChunkStatusFromLevel(this.chunkLevel).isAtLeast(p_219276_1_)) {
    ...
    private void chain(CompletableFuture<? extends Either<? extends IChunk, IChunkLoadingError>> eitherChunk) {
        this.field_219315_j = this.field_219315_j.thenCombine(eitherChunk, (p_219295_0_, p_219295_1_) -> p_219295_1_.map(p_219283_0_ -> p_219283_0_, p_219288_1_ -> p_219295_0_));
    }
