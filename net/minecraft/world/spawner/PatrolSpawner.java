...
implements ISpecialSpawner {
    ...
    public int func_230253_a_(ServerWorld p_230253_1_, boolean p_230253_2_, boolean p_230253_3_) {
        ...
        if (!p_230253_1_.getGameRules().getBoolean(GameRules.DO_PATROL_SPAWNING)) {
            return 0;
        }
        ...
        if (i >= 5L && p_230253_1_.isDaytime()) {
            ...
            if (p_230253_1_.func_241119_a_(playerentity.getPosition(), 2)) {
                return 0;
            }
            ...
            int i1 = 0;
            int j1 = (int)Math.ceil(p_230253_1_.getDifficultyForLocation(blockpos$mutable).getAdditionalDifficulty()) + 1;
    ...
    private boolean spawnPatroller(ServerWorld worldIn, BlockPos p_222695_2_, Random random, boolean p_222695_4_) {
        ...
        if (patrollerentity != null) {
            ...
            patrollerentity.setPosition(p_222695_2_.getX(), p_222695_2_.getY(), p_222695_2_.getZ());
            patrollerentity.onInitialSpawn(worldIn, worldIn.getDifficultyForLocation(p_222695_2_), SpawnReason.PATROL, null, null);
