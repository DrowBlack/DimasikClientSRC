...
implements ISpecialSpawner {
    ...
    public int func_230253_a_(ServerWorld p_230253_1_, boolean p_230253_2_, boolean p_230253_3_) {
        ...
        if (!p_230253_1_.getGameRules().getBoolean(GameRules.DO_INSOMNIA)) {
            return 0;
        }
        ...
        for (PlayerEntity playerEntity : p_230253_1_.getPlayers()) {
            ...
            if (p_230253_1_.getDimensionType().hasSkyLight() && (blockpos.getY() < p_230253_1_.getSeaLevel() || !p_230253_1_.canSeeSky(blockpos)) || !(difficultyinstance = p_230253_1_.getDifficultyForLocation(blockpos)).isHarderThan(random.nextFloat() * 3.0f)) continue;
            ...
            int k = 24000;
            if (random.nextInt(j) < 72000 || !WorldEntitySpawner.func_234968_a_(p_230253_1_, blockpos1 = blockpos.up(20 + random.nextInt(15)).east(-10 + random.nextInt(21)).south(-10 + random.nextInt(21)), blockstate = p_230253_1_.getBlockState(blockpos1), fluidstate = p_230253_1_.getFluidState(blockpos1), EntityType.PHANTOM)) continue;
            ...
            for (int i1 = 0; i1 < l; ++i1) {
                ...
                ilivingentitydata = phantomentity.onInitialSpawn(p_230253_1_, difficultyinstance, SpawnReason.NATURAL, ilivingentitydata, null);
