...
public final class WorldEntitySpawner {
    ...
    public static void func_234979_a_(ServerWorld p_234979_0_, Chunk p_234979_1_, EntityDensityManager p_234979_2_, boolean p_234979_3_, boolean p_234979_4_, boolean p_234979_5_) {
        ...
        for (EntityClassification entityclassification : field_234961_c_) {
            if (!p_234979_3_ && entityclassification.getPeacefulCreature() || !p_234979_4_ && !entityclassification.getPeacefulCreature() || !p_234979_5_ && entityclassification.getAnimal() || !p_234979_2_.func_234991_a_(entityclassification)) continue;
        ...
        if (!blockstate.isNormalCube(p_234966_2_, p_234966_3_)) {
            ...
            block0: for (int k = 0; k < 3; ++k) {
                ...
                for (int i2 = 0; i2 < k1; ++i2) {
                    double d2;
                    blockpos$mutable.setPos(l += p_234966_1_.rand.nextInt(6) - p_234966_1_.rand.nextInt(6), i, i1 += p_234966_1_.rand.nextInt(6) - p_234966_1_.rand.nextInt(6));
                    double d0 = (double)l + 0.5;
                    double d1 = (double)i1 + 0.5;
                    PlayerEntity playerentity = p_234966_1_.getClosestPlayer(d0, (double)i, d1, -1.0, false);
                    if (playerentity == null || !WorldEntitySpawner.func_234978_a_(p_234966_1_, p_234966_2_, blockpos$mutable, d2 = playerentity.getDistanceSq(d0, i, d1))) continue;
                    if (mobspawninfo$spawners == null) {
                        mobspawninfo$spawners = WorldEntitySpawner.func_234977_a_(p_234966_1_, structuremanager, chunkgenerator, p_234966_0_, p_234966_1_.rand, blockpos$mutable);
                    ...
                    if (!WorldEntitySpawner.func_234975_a_(p_234966_1_, p_234966_0_, structuremanager, chunkgenerator, mobspawninfo$spawners, blockpos$mutable, d2) || !p_234966_4_.test(mobspawninfo$spawners.type, blockpos$mutable, p_234966_2_)) continue;
                    MobEntity mobentity = WorldEntitySpawner.func_234973_a_(p_234966_1_, mobspawninfo$spawners.type);
                    if (mobentity == null) {
                        return;
                    }
                    mobentity.setLocationAndAngles(d0, i, d1, p_234966_1_.rand.nextFloat() * 360.0f, 0.0f);
                    if (!WorldEntitySpawner.func_234974_a_(p_234966_1_, mobentity, d2)) continue;
                    ilivingentitydata = mobentity.onInitialSpawn(p_234966_1_, p_234966_1_.getDifficultyForLocation(mobentity.getPosition()), SpawnReason.NATURAL, ilivingentitydata, null);
                    ++l1;
    ...
    private static MobEntity func_234973_a_(ServerWorld p_234973_0_, EntityType<?> p_234973_1_) {
        try {
            ...
            if (!(entity instanceof MobEntity)) {
                throw new IllegalStateException("Trying to spawn a non-mob: " + String.valueOf(Registry.ENTITY_TYPE.getKey(p_234973_1_)));
            }
