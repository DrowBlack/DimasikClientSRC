...
public class RandomEntityRule {
    ...
    public boolean matches(IRandomEntity randomEntity) {
        ...
        if (this.professions != null && randomEntity instanceof RandomEntity && (entity = (randomentity = (RandomEntity)randomEntity).getEntity()) instanceof VillagerEntity && !MatchProfession.matchesOne(villagerprofession = (villagerdata = (villagerentity = (VillagerEntity)entity).getVillagerData()).getProfession(), j = villagerdata.getLevel(), this.professions)) {
            return false;
        }
        ...
        if (this.baby != null && randomEntity instanceof RandomEntity && (entity2 = (randomentity2 = (RandomEntity)randomEntity).getEntity()) instanceof LivingEntity && (livingentity = (LivingEntity)entity2).isChild() != this.baby.booleanValue()) {
            return false;
        }
        if (this.moonPhases != null && (world = Config.getMinecraft().world) != null && !this.moonPhases.isInRange(l = world.getMoonPhase())) {
            return false;
        }
        if (this.dayTimes != null && (world1 = Config.getMinecraft().world) != null && !this.dayTimes.isInRange(i1 = (int)world1.getDayTime())) {
            return false;
        }
        return this.weatherList == null || (world2 = Config.getMinecraft().world) == null || ArrayUtils.contains((Object[])this.weatherList, (Object)(weather = Weather.getWeather(world2, 0.0f)));
    }
