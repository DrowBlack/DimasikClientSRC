...
public class CustomEntityModels {
    ...
    public static void update() {
        ...
        Map<TileEntityType, TileEntityRenderer> map1 = CustomEntityModels.getTileEntityRenderMap();
        Map<SkullBlock.ISkullType, Model> map2 = CustomEntityModels.getSkullModelMap();
        if (map == null) {
            ...
            if (Config.isCustomEntityModels()) {
                ...
                for (int i = 0; i < aresourcelocation.length; ++i) {
                    ...
                    if (ientityrenderer instanceof EntityRenderer) {
                        ...
                        if (ientityrenderer instanceof TridentRenderer && (tridentmodel = (TridentModel)Reflector.getFieldValue(tridentrenderer = (TridentRenderer)ientityrenderer, Reflector.RenderTrident_modelTrident)) != null) {
    ...
    private static Map<SkullBlock.ISkullType, Model> getSkullModelMap() {
        ...
        if (originalSkullModelMap == null) {
            originalSkullModelMap = new HashMap<SkullBlock.ISkullType, Model>(map);
        }
        return map;
    }
    ...
    private static boolean modifyModel(ModelAdapter modelAdapter, Model model, CustomModelRenderer customModelRenderer, ModelResolver modelResolver) {
        ...
        if (!customModelRenderer.isAttach()) {
            ...
            if (modelrenderer.childModels != null) {
                ...
                ObjectList<ModelRenderer> list = modelrenderer.childModels;
