...
public enum FunctionType {
    ...
    public float evalFloat(IExpression[] args) {
        switch (this) {
            ...
            case CLAMP: {
                return MathHelper.clamp(FunctionType.evalFloat(args, 0), FunctionType.evalFloat(args, 1), FunctionType.evalFloat(args, 2));
            }
            case ABS: {
            ...
            case FLOOR: {
                return MathHelper.floor(FunctionType.evalFloat(args, 0));
            }
            case CEIL: {
                return MathHelper.ceil(FunctionType.evalFloat(args, 0));
            }
            case FRAC: {
                return MathHelper.frac(FunctionType.evalFloat(args, 0));
            }
            case LOG: {
            ...
            case SQRT: {
                return MathHelper.sqrt(FunctionType.evalFloat(args, 0));
            }
            case FMOD: {
        ...
        Config.warn("Unknown function type: " + String.valueOf((Object)this));
        return 0.0f;
    }
