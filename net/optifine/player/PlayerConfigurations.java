...
public class PlayerConfigurations {
    ...
    public static synchronized PlayerConfiguration getPlayerConfiguration(AbstractClientPlayerEntity player) {
        ...
        if (reloadPlayerItems && System.currentTimeMillis() > timeReloadPlayerItemsMs + 5000L && (abstractclientplayerentity = Minecraft.getInstance().player) != null) {
            PlayerConfigurations.setPlayerConfiguration(abstractclientplayerentity.getNameClear(), null);
