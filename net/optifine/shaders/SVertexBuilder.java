...
public class SVertexBuilder {
    ...
    public static void endAddVertex(BufferBuilder wrr) {
        ...
        if (svertexbuilder.vertexSize == 18) {
            ...
            wrr.getIntBuffer().put(j += wrr.getIntStartPosition(), (int)i);
    ...
    public void calcNormal(BufferBuilder wrr, int baseIndex) {
        ...
        float f = floatbuffer.get((baseIndex += wrr.getIntStartPosition()) + 0 * this.vertexSize);
    ...
    public static boolean preDrawArrays(VertexFormat vf, ByteBuffer bb) {
        ...
        GL20.glVertexAttribPointer(Shaders.midTexCoordAttrib, 2, 5126, false, i, bb);
        ((Buffer)bb).position(44);
        GL20.glVertexAttribPointer(Shaders.tangentAttrib, 4, 5122, false, i, bb);
        ((Buffer)bb).position(52);
        GL20.glVertexAttribPointer(Shaders.entityAttrib, 3, 5122, false, i, bb);
        ((Buffer)bb).position(60);
        GL20.glVertexAttribPointer(Shaders.velocityAttrib, 3, 5126, false, i, bb);
