...
public class ShadersRender {
    ...
    public static void renderShadowMap(GameRenderer entityRenderer, ActiveRenderInfo activeRenderInfo, int pass, float partialTicks, long finishTimeNano) {
        if (Shaders.hasShadowMap) {
            ...
            Iterator<WorldRenderer.LocalRenderInformationContainer> iterator = (Shaders.isRenderShadowEntities() ? worldrenderer1.getRenderInfosEntities() : Collections.EMPTY_LIST).iterator();
            while (iterator.hasNext()) {
                WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer0;
                WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer = worldrenderer$localrenderinformationcontainer0 = iterator.next();
            ...
            Iterator<WorldRenderer.LocalRenderInformationContainer> iterator2 = (Shaders.isRenderShadowBlockEntities() ? worldrenderer1.getRenderInfosTileEntities() : Collections.EMPTY_LIST).iterator();
            while (iterator2.hasNext()) {
                WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer10;
                WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer1 = worldrenderer$localrenderinformationcontainer10 = iterator2.next();
                ...
                for (TileEntity tileentity : list) {
                    ...
                    if (flag1 && (axisalignedbb = (AxisAlignedBB)Reflector.call(tileentity, Reflector.IForgeTileEntity_getRenderBoundingBox, new Object[0])) != null && !((ClippingHelper)clippinghelper1).isBoundingBoxInFrustum(axisalignedbb)) continue;
