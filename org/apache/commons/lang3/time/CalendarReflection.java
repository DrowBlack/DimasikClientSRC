...
class CalendarReflection {
    ...
    static boolean isWeekDateSupported(Calendar calendar) {
        try {
            return IS_WEEK_DATE_SUPPORTED != null && (Boolean)IS_WEEK_DATE_SUPPORTED.invoke((Object)calendar, new Object[0]) != false;
        }
        catch (Exception e) {
    ...
    public static int getWeekYear(Calendar calendar) {
        try {
            if (CalendarReflection.isWeekDateSupported(calendar)) {
                return (Integer)GET_WEEK_YEAR.invoke((Object)calendar, new Object[0]);
            }
        }
        catch (Exception e) {
