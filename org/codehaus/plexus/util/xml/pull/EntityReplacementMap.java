...
public class EntityReplacementMap {
    ...
    public EntityReplacementMap(String[][] replacements) {
        ...
        for (String[] replacement : replacements) {
            this.defineEntityReplacementText(replacement[0], replacement[1]);
        }
    }
    ...
    private void defineEntityReplacementText(String entityName, String replacementText) {
        ...
        this.entityNameHash[this.entityEnd] = EntityReplacementMap.fastHash(this.entityNameBuf[this.entityEnd], 0, this.entityNameBuf[this.entityEnd].length);
        ++this.entityEnd;
    }
