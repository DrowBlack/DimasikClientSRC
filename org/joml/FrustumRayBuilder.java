...
public class FrustumRayBuilder {
    ...
    public Vector3fc dir(float x, float y, Vector3f dir) {
        float y1x = this.nxnyX + (this.nxpyX - this.nxnyX) * y;
        float y1y = this.nxnyY + (this.nxpyY - this.nxnyY) * y;
        float y1z = this.nxnyZ + (this.nxpyZ - this.nxnyZ) * y;
        float y2x = this.pxnyX + (this.pxpyX - this.pxnyX) * y;
        float y2y = this.pxnyY + (this.pxpyY - this.pxnyY) * y;
        float y2z = this.pxnyZ + (this.pxpyZ - this.pxnyZ) * y;
