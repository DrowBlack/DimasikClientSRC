...
Matrix4dc {
    ...
    public Vector4d project(double x, double y, double z, int[] viewport, Vector4d winCoordsDest) {
        ...
        return winCoordsDest.set(Math.fma(Math.fma(nx, 0.5, 0.5), (double)viewport[2], (double)viewport[0]), Math.fma(Math.fma(ny, 0.5, 0.5), (double)viewport[3], (double)viewport[1]), Math.fma(0.5, nz, 0.5), 1.0);
    }
    ...
    public Vector3d project(double x, double y, double z, int[] viewport, Vector3d winCoordsDest) {
        ...
        double ny = Math.fma(this.m01, x, Math.fma(this.m11, y, Math.fma(this.m21, z, this.m31))) * invW;
        double nz = Math.fma(this.m02, x, Math.fma(this.m12, y, Math.fma(this.m22, z, this.m32))) * invW;
        winCoordsDest.x = Math.fma(Math.fma(nx, 0.5, 0.5), (double)viewport[2], (double)viewport[0]);
        winCoordsDest.y = Math.fma(Math.fma(ny, 0.5, 0.5), (double)viewport[3], (double)viewport[1]);
    ...
    public Matrix4d tile(int x, int y, int w, int h, Matrix4d dest) {
        float tx = w - 1 - (x << 1);
        float ty = h - 1 - (y << 1);
        return dest._m30(Math.fma(this.m00, (double)tx, Math.fma(this.m10, (double)ty, this.m30)))._m31(Math.fma(this.m01, (double)tx, Math.fma(this.m11, (double)ty, this.m31)))._m32(Math.fma(this.m02, (double)tx, Math.fma(this.m12, (double)ty, this.m32)))._m33(Math.fma(this.m03, (double)tx, Math.fma(this.m13, (double)ty, this.m33)))._m00(this.m00 * (double)w)._m01(this.m01 * (double)w)._m02(this.m02 * (double)w)._m03(this.m03 * (double)w)._m10(this.m10 * (double)h)._m11(this.m11 * (double)h)._m12(this.m12 * (double)h)._m13(this.m13 * (double)h)._m20(this.m20)._m21(this.m21)._m22(this.m22)._m23(this.m23)._properties(this.properties & 0xFFFFFFE2);
    }
    ...
    public static void perspectiveOffCenterViewFromRectangle(Vector3d eye, Vector3d p, Vector3d x, Vector3d y, double nearFarDist, boolean zeroToOne, Matrix4d projDest, Matrix4d viewDest) {
        double far;
