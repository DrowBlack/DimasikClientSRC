...
Matrix4fc {
    ...
    public Matrix4f set(Matrix4x3fc m) {
        return this._m00(m.m00())._m01(m.m01())._m02(m.m02())._m03(0.0f)._m10(m.m10())._m11(m.m11())._m12(m.m12())._m13(0.0f)._m20(m.m20())._m21(m.m21())._m22(m.m22())._m23(0.0f)._m30(m.m30())._m31(m.m31())._m32(m.m32())._m33(1.0f)._properties(m.properties() | 2);
    }
    ...
    public Matrix4f set(AxisAngle4d axisAngle) {
        ...
        double omc = 1.0 - c;
        this._m00((float)(c + (x *= n) * x * omc))._m11((float)(c + (y *= n) * y * omc))._m22((float)(c + (z *= n) * z * omc));
        double tmp1 = x * y * omc;
        double tmp2 = z * s;
    ...
    public Matrix4f invertAffine(Matrix4f dest) {
        ...
        return dest._m00((m11m22 - m12m21) * s)._m01((m21m02 - m22m01) * s)._m02((m12m01 - m11m02) * s)._m03(0.0f)._m10((m12m20 - m10m22) * s)._m11((m22m00 - m20m02) * s)._m12((m10m02 - m12m00) * s)._m13(0.0f)._m20((m10m21 - m11m20) * s)._m21((m20m01 - m21m00) * s)._m22((m11m00 - m10m01) * s)._m23(0.0f)._m30((m10m22 * this.m31() - m10m21 * this.m32() + m11m20 * this.m32() - m11m22 * this.m30() + m12m21 * this.m30() - m12m20 * this.m31()) * s)._m31(nm31)._m32(nm32)._m33(1.0f)._properties(2);
    }
    ...
    public Matrix4f translationRotateScale(float tx, float ty, float tz, float qx, float qy, float qz, float qw, float sx, float sy, float sz) {
        ...
        return this._m00(sx - (q11 + q22) * sx)._m01((q01 + q23) * sx)._m02((q02 - q13) * sx)._m03(0.0f)._m10((q01 - q23) * sy)._m11(sy - (q22 + q00) * sy)._m12((q12 + q03) * sy)._m13(0.0f)._m20((q02 + q13) * sz)._m21((q12 - q03) * sz)._m22(sz - (q11 + q00) * sz)._m23(0.0f)._m30(tx)._m31(ty)._m32(tz)._m33(1.0f)._properties(2 | (one ? 16 : 0));
    }
    ...
    public Matrix4f translationRotateScaleInvert(float tx, float ty, float tz, float qx, float qy, float qz, float qw, float sx, float sy, float sz) {
        ...
        float isy = 1.0f / sy;
        float isz = 1.0f / sz;
        return this._m00(isx * (1.0f - q11 - q22))._m01(isy * (q01 + q23))._m02(isz * (q02 - q13))._m03(0.0f)._m10(isx * (q01 - q23))._m11(isy * (1.0f - q22 - q00))._m12(isz * (q12 + q03))._m13(0.0f)._m20(isx * (q02 + q13))._m21(isy * (q12 - q03))._m22(isz * (1.0f - q11 - q00))._m23(0.0f)._m30(-this.m00() * tx - this.m10() * ty - this.m20() * tz)._m31(-this.m01() * tx - this.m11() * ty - this.m21() * tz)._m32(-this.m02() * tx - this.m12() * ty - this.m22() * tz)._m33(1.0f)._properties(2);
    }
    ...
    public Matrix4f translationRotateScaleMulAffine(float tx, float ty, float tz, float qx, float qy, float qz, float qw, float sx, float sy, float sz, Matrix4f m) {
        ...
        boolean one = Math.absEqualsOne(sx) && Math.absEqualsOne(sy) && Math.absEqualsOne(sz);
        return this._properties(2 | (one && (m.properties & 0x10) != 0 ? 16 : 0));
    }
    ...
    public Matrix4f translationRotateInvert(float tx, float ty, float tz, float qx, float qy, float qz, float qw) {
        ...
        float q13 = dqy * qw;
        float q23 = dqz * qw;
        return this._m00(1.0f - q11 - q22)._m01(q01 + q23)._m02(q02 - q13)._m03(0.0f)._m10(q01 - q23)._m11(1.0f - q22 - q00)._m12(q12 + q03)._m13(0.0f)._m20(q02 + q13)._m21(q12 - q03)._m22(1.0f - q11 - q00)._m23(0.0f)._m30(-this.m00() * tx - this.m10() * ty - this.m20() * tz)._m31(-this.m01() * tx - this.m11() * ty - this.m21() * tz)._m32(-this.m02() * tx - this.m12() * ty - this.m22() * tz)._m33(1.0f)._properties(18);
    }
    ...
    public Vector4f transformProject(Vector4fc v, Vector4f dest) {
        return v.mulProject((Matrix4fc)this, dest);
    }
    ...
    public Matrix4f tile(int x, int y, int w, int h, Matrix4f dest) {
        float tx = w - 1 - (x << 1);
        float ty = h - 1 - (y << 1);
        return dest._m30(Math.fma(this.m00(), tx, Math.fma(this.m10(), ty, this.m30())))._m31(Math.fma(this.m01(), tx, Math.fma(this.m11(), ty, this.m31())))._m32(Math.fma(this.m02(), tx, Math.fma(this.m12(), ty, this.m32())))._m33(Math.fma(this.m03(), tx, Math.fma(this.m13(), ty, this.m33())))._m00(this.m00() * (float)w)._m01(this.m01() * (float)w)._m02(this.m02() * (float)w)._m03(this.m03() * (float)w)._m10(this.m10() * (float)h)._m11(this.m11() * (float)h)._m12(this.m12() * (float)h)._m13(this.m13() * (float)h)._m20(this.m20())._m21(this.m21())._m22(this.m22())._m23(this.m23())._properties(this.properties & 0xFFFFFFE2);
    }
    ...
    public Matrix4f setFromIntrinsic(float alphaX, float alphaY, float gamma, float u0, float v0, int imgWidth, int imgHeight, float near, float far) {
        ...
        return this._m00(l00 * alphaX)._m01(0.0f)._m02(0.0f)._m03(0.0f)._m10(l00 * gamma)._m11(l11 * alphaY)._m12(0.0f)._m13(0.0f)._m20(l00 * u0 - 1.0f)._m21(l11 * v0 - 1.0f)._m22(l22 * -(near + far) + (far + near) / (near - far))._m23(-1.0f)._m30(0.0f)._m31(0.0f)._m32(l22 * -near * far)._m33(0.0f)._properties(1);
    }
    ...
    public Vector4f project(float x, float y, float z, int[] viewport, Vector4f winCoordsDest) {
        ...
        return winCoordsDest.set(Math.fma(Math.fma(nx, 0.5f, 0.5f), viewport[2], viewport[0]), Math.fma(Math.fma(ny, 0.5f, 0.5f), viewport[3], viewport[1]), Math.fma(0.5f, nz, 0.5f), 1.0f);
    }
    ...
    public Matrix4f billboardCylindrical(Vector3fc objPos, Vector3fc targetPos, Vector3fc up) {
        ...
        this._m00(leftX)._m01(leftY)._m02(leftZ)._m03(0.0f)._m10(up.x())._m11(up.y())._m12(up.z())._m13(0.0f)._m20(dirX *= invDirLen)._m21(dirY *= invDirLen)._m22(dirZ *= invDirLen)._m23(0.0f)._m30(objPos.x())._m31(objPos.y())._m32(objPos.z())._m33(1.0f)._properties(18);
        return this;
    }
    ...
    public Matrix4f trapezoidCrop(float p0x, float p0y, float p1x, float p1y, float p2x, float p2y, float p3x, float p3y) {
        ...
        float s = -c3x / c3y;
        float d1x = (nm00 += s * nm01) * p1x + (nm10 += s * nm11) * p1y + (nm30 += s * nm31);
    ...
    public Matrix4f affineSpan(Vector3f corner, Vector3f xDir, Vector3f yDir, Vector3f zDir) {
        ...
        float s = 1.0f / (this.m00() * this.m11() - this.m01() * this.m10()) * this.m22() + (this.m02() * this.m10() - this.m00() * this.m12()) * this.m21() + (this.m01() * this.m12() - this.m02() * this.m11()) * this.m20();
        float nm00 = (e - i) * s;
        float nm01 = (o - q) * s;
        float nm02 = (k - g) * s;
        float nm10 = (j - a) * s;
    ...
    public boolean testAab(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
        ...
        float pzZ = this.m23() - this.m22();
        float pzW = this.m33() - this.m32();
        float f = nxX * (nxX < 0.0f ? minX : maxX) + nxY * (nxY < 0.0f ? minY : maxY);
        float f2 = nxZ < 0.0f ? minZ : maxZ;
        if (!(f + nxZ * f2 >= -nxW)) return false;
        float f3 = pxX * (pxX < 0.0f ? minX : maxX) + pxY * (pxY < 0.0f ? minY : maxY);
        float f4 = pxZ < 0.0f ? minZ : maxZ;
        if (!(f3 + pxZ * f4 >= -pxW)) return false;
        float f5 = nyX * (nyX < 0.0f ? minX : maxX) + nyY * (nyY < 0.0f ? minY : maxY);
        float f6 = nyZ < 0.0f ? minZ : maxZ;
        if (!(f5 + nyZ * f6 >= -nyW)) return false;
        float f7 = pyX * (pyX < 0.0f ? minX : maxX) + pyY * (pyY < 0.0f ? minY : maxY);
        float f8 = pyZ < 0.0f ? minZ : maxZ;
        if (!(f7 + pyZ * f8 >= -pyW)) return false;
        float f9 = nzX * (nzX < 0.0f ? minX : maxX) + nzY * (nzY < 0.0f ? minY : maxY);
        float f10 = nzZ < 0.0f ? minZ : maxZ;
        if (!(f9 + nzZ * f10 >= -nzW)) return false;
        float f11 = pzX * (pzX < 0.0f ? minX : maxX) + pzY * (pzY < 0.0f ? minY : maxY);
        float f12 = pzZ < 0.0f ? minZ : maxZ;
        if (!(f11 + pzZ * f12 >= -pzW)) return false;
        return true;
    }
