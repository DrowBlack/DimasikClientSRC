...
@FunctionalInterface
@NativeType(value="FT_List_Iterator")
public interface FT_List_IteratorI
extends CallbackI {
    ...
    public int invoke(@NativeType(value="FT_ListNode") long var1, @NativeType(value="void *") long var3);
}
