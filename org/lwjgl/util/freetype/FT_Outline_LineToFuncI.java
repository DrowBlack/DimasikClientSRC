...
@FunctionalInterface
@NativeType(value="FT_Outline_LineToFunc")
public interface FT_Outline_LineToFuncI
extends CallbackI {
    ...
    public int invoke(@NativeType(value="FT_Vector const *") long var1, @NativeType(value="void *") long var3);
}
