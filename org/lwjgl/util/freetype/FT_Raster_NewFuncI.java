...
@FunctionalInterface
@NativeType(value="FT_Raster_NewFunc")
public interface FT_Raster_NewFuncI
extends CallbackI {
    ...
    public int invoke(@NativeType(value="void *") long var1, @NativeType(value="FT_Raster *") long var3);
}
