...
@FunctionalInterface
@NativeType(value="FT_Raster_RenderFunc")
public interface FT_Raster_RenderFuncI
extends CallbackI {
    ...
    public int invoke(@NativeType(value="FT_Raster") long var1, @NativeType(value="FT_Raster_Params const *") long var3);
}
