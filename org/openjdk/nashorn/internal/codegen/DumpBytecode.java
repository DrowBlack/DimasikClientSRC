            ...
            try {
                if (env._print_code) {
                    ...
                    if (env._print_code_dir != null) {
                        ...
                        int uniqueId = 0;
                        do {
                            String fileName = name + (String)(uniqueId == 0 ? "" : "_" + uniqueId) + ".bytecode";
                ...
                if (env._dest_dir == null) break block19;
                ...
                logger.warning("Skipping class dump for ", className, ": ", ECMAErrors.getMessage("io.error.cant.write", String.valueOf(dir)));
            }
        }
    }
}
