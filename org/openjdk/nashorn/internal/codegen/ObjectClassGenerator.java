...
implements Loggable {
    ...
    public static String getClassName(int fieldCount, boolean dualFields) {
        ...
        return fieldCount != 0 ? "org/openjdk/nashorn/internal/scripts/" + prefix + fieldCount : "org/openjdk/nashorn/internal/scripts/" + prefix;
    }

    public static String getClassName(int fieldCount, int paramCount, boolean dualFields) {
        return "org/openjdk/nashorn/internal/scripts/" + ObjectClassGenerator.getPrefixName(dualFields) + fieldCount + SCOPE_MARKER + paramCount;
    }
