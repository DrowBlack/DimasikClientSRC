...
Flags<Block> {
    ...
    public List<Symbol> getSymbols() {
        return this.symbols.isEmpty() ? List.of() : List.copyOf(this.symbols.values());
    }
    ...
    public boolean isTerminal() {
        return this.getFlag(4) && !this.getFlag(256);
    }
    ...
    public boolean providesScopeCreator() {
        return this.needsScope() && this.isSynthetic() && this.getLastStatement() instanceof ForNode && ((ForNode)this.getLastStatement()).needsScopeCreator();
    }
