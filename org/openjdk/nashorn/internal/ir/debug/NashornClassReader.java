...
extends ClassReader {
    ...
    private static final String[] TYPE = new String[]{"<error>", "UTF8", "<error>", "Integer", "Float", "Long", "Double", "Class", "String", "Fieldref", "Methodref", "InterfaceMethodRef", "NameAndType", "<error>", "<error>", "MethodHandle", "MethodType", "<error>", "Invokedynamic"};
    ...
    private static abstract class Constant {
        ...
        final String getType() {
            Object str = TYPE[this.tag];
            while (((String)str).length() < 16) {
                str = (String)str + " ";
            }
            return str;
        }
