...
extends NodeVisitor<T> {
    ...
    public boolean enterUnaryNode(UnaryNode unaryNode) {
        switch (unaryNode.tokenType()) {
            case POS: {
                return this.enterPOS(unaryNode);
            }
            case BIT_NOT: {
            ...
            case NEG: {
                return this.enterNEG(unaryNode);
            }
            case TYPEOF: {
    ...
    public final Node leaveUnaryNode(UnaryNode unaryNode) {
        switch (unaryNode.tokenType()) {
            case POS: {
                return this.leavePOS(unaryNode);
            }
            case BIT_NOT: {
            ...
            case NEG: {
                return this.leaveNEG(unaryNode);
            }
            case TYPEOF: {
    ...
    public final boolean enterBinaryNode(BinaryNode binaryNode) {
        switch (binaryNode.tokenType()) {
            ...
            case ARROW: {
                return this.enterARROW(binaryNode);
            }
            case BIT_AND: {
    ...
    public final Node leaveBinaryNode(BinaryNode binaryNode) {
        switch (binaryNode.tokenType()) {
            ...
            case ARROW: {
                return this.leaveARROW(binaryNode);
            }
            case BIT_AND: {
