...
import org.openjdk.nashorn.internal.objects.GenericPropertyDescriptor;
...
extends Scope {
    ...
    public static void setSymbol(Object self, Object value) {
        Global.instanceFrom((Object)self).symbol = value;
    }
    ...
    public static void setMap(Object self, Object value) {
        Global.instanceFrom((Object)self).map = value;
    }
    ...
    public static void setWeakMap(Object self, Object value) {
        Global.instanceFrom((Object)self).weakMap = value;
    }
    ...
    public static void setSet(Object self, Object value) {
        Global.instanceFrom((Object)self).set = value;
    }
    ...
    public static void setWeakSet(Object self, Object value) {
        Global.instanceFrom((Object)self).weakSet = value;
    }
    ...
    public Global(Context context) {
        ...
        this.lexicalScope = this.isES6() ? new LexicalScope(this) : null;
    }
    ...
    public Object getDefaultValue(ScriptObject sobj, Class<?> typeHint) {
        ...
        try {
            if (hint == String.class) {
                ...
                if (Bootstrap.isCallable(toString) && JSType.isPrimitive(value2 = this.TO_STRING.getInvoker().invokeExact(toString, sobj))) {
                    return value2;
                }
            ...
            if (hint == Number.class) {
                ...
                Object toString = this.TO_STRING.getGetter().invokeExact(sobj);
                if (Bootstrap.isCallable(toString) && JSType.isPrimitive(value = this.TO_STRING.getInvoker().invokeExact(toString, sobj))) {
                    return value;
                }
    ...
    private <T> T getLazilyCreatedValue(Object key, Supplier<T> creator, Map<Object, T> map) {
        ...
        try {
            ...
            T t = (existingObj = map.putIfAbsent(key, newObj = creator.get())) != null ? existingObj : newObj;
            return t;
        }
        finally {
            if (differentGlobal) {
    ...
    public InvokeByName getInvokeByName(Object key, Supplier<InvokeByName> creator) {
        return this.getLazilyCreatedValue(key, creator, this.namedInvokers);
    }

    public MethodHandle getDynamicInvoker(Object key, Supplier<MethodHandle> creator) {
        return this.getLazilyCreatedValue(key, creator, this.dynamicInvokers);
    }
    ...
    public static Object loadWithNewGlobal(Object self, Object ... args) throws IOException {
        ...
        Undefined from = hasArgs ? args[0] : ScriptRuntime.UNDEFINED;
    ...
    ScriptObject getSymbolPrototype() {
        return ScriptFunction.getPrototype(this.getBuiltinSymbol());
    }

    ScriptObject getMapPrototype() {
        return ScriptFunction.getPrototype(this.getBuiltinMap());
    }

    ScriptObject getWeakMapPrototype() {
        return ScriptFunction.getPrototype(this.getBuiltinWeakMap());
    }

    ScriptObject getSetPrototype() {
        return ScriptFunction.getPrototype(this.getBuiltinSet());
    }

    ScriptObject getWeakSetPrototype() {
        return ScriptFunction.getPrototype(this.getBuiltinWeakSet());
    }

    ScriptObject getIteratorPrototype() {
        if (this.builtinIteratorPrototype == null) {
            this.builtinIteratorPrototype = this.initPrototype("AbstractIterator", this.getObjectPrototype());
        }
    ...
    ScriptObject getMapIteratorPrototype() {
        if (this.builtinMapIteratorPrototype == null) {
            this.builtinMapIteratorPrototype = this.initPrototype("MapIterator", this.getIteratorPrototype());
        }
    ...
    ScriptObject getSetIteratorPrototype() {
        if (this.builtinSetIteratorPrototype == null) {
            this.builtinSetIteratorPrototype = this.initPrototype("SetIterator", this.getIteratorPrototype());
        }
    ...
    ScriptObject getArrayIteratorPrototype() {
        if (this.builtinArrayIteratorPrototype == null) {
            this.builtinArrayIteratorPrototype = this.initPrototype("ArrayIterator", this.getIteratorPrototype());
        }
    ...
    ScriptObject getStringIteratorPrototype() {
        if (this.builtinStringIteratorPrototype == null) {
            this.builtinStringIteratorPrototype = this.initPrototype("StringIterator", this.getIteratorPrototype());
        }
    ...
    private synchronized ScriptFunction getBuiltinSymbol() {
        if (this.builtinSymbol == null) {
            this.builtinSymbol = this.initConstructorAndSwitchPoint("Symbol", ScriptFunction.class);
        }
    ...
    private synchronized ScriptFunction getBuiltinMap() {
        if (this.builtinMap == null) {
            this.builtinMap = this.initConstructorAndSwitchPoint("Map", ScriptFunction.class);
        }
    ...
    private synchronized ScriptFunction getBuiltinWeakMap() {
        if (this.builtinWeakMap == null) {
            this.builtinWeakMap = this.initConstructorAndSwitchPoint("WeakMap", ScriptFunction.class);
        }
    ...
    private synchronized ScriptFunction getBuiltinSet() {
        if (this.builtinSet == null) {
            this.builtinSet = this.initConstructorAndSwitchPoint("Set", ScriptFunction.class);
        }
    ...
    private synchronized ScriptFunction getBuiltinWeakSet() {
        if (this.builtinWeakSet == null) {
            this.builtinWeakSet = this.initConstructorAndSwitchPoint("WeakSet", ScriptFunction.class);
        }
    ...
    public GuardedInvocation findGetMethod(CallSiteDescriptor desc, LinkRequest request) {
        ...
        if (isScope && this.isES6() && (invocation.getSwitchPoints() == null || !this.hasOwnProperty(name))) {
    ...
    protected FindProperty findProperty(Object key, boolean deep, boolean isScope, ScriptObject start) {
        FindProperty find;
        if (this.lexicalScope != null && isScope && (find = this.lexicalScope.findProperty(key, false)) != null) {
            return find;
        }
    ...
    public GuardedInvocation findSetMethod(CallSiteDescriptor desc, LinkRequest request) {
        String name;
        boolean isScope = NashornCallSiteDescriptor.isScope(desc);
        if (this.lexicalScope != null && isScope && this.lexicalScope.hasOwnProperty(name = NashornCallSiteDescriptor.getOperand(desc))) {
            return this.lexicalScope.findSetMethod(desc, request);
        }
        GuardedInvocation invocation = super.findSetMethod(desc, request);
        if (isScope && this.isES6()) {
            return invocation.addSwitchPoint(this.getLexicalScopeSwitchPoint());
        }
        return invocation;
    }
    ...
    private <T extends ScriptObject> T initConstructor(String name, Class<T> clazz) {
        try {
            ...
            ScriptObject res = (ScriptObject)clazz.cast(funcClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
    ...
    private ScriptObject initPrototype(String name, ScriptObject prototype) {
        try {
            String className = PACKAGE_PREFIX + name + "$Prototype";
            Class<?> funcClass = Class.forName(className);
            ScriptObject res = (ScriptObject)funcClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
            res.setIsBuiltin();
    ...
    public static void $clinit$() {
        ArrayList<Property> arrayList = new ArrayList<Property>(66);
        ...
        arrayList.add(AccessorProperty.create("Symbol", 2, cfr_ldc_112(), cfr_ldc_113()));
        arrayList.add(AccessorProperty.create("Map", 2, cfr_ldc_114(), cfr_ldc_115()));
        arrayList.add(AccessorProperty.create("WeakMap", 2, cfr_ldc_116(), cfr_ldc_117()));
        arrayList.add(AccessorProperty.create("Set", 2, cfr_ldc_118(), cfr_ldc_119()));
        arrayList.add(AccessorProperty.create("WeakSet", 2, cfr_ldc_120(), cfr_ldc_121()));
        arrayList.add(AccessorProperty.create("JavaImporter", 2, cfr_ldc_122(), cfr_ldc_123()));
        arrayList.add(AccessorProperty.create("Java", 2, cfr_ldc_124(), cfr_ldc_125()));
    ...
    static MethodHandle cfr_ldc_112() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "getSymbol", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_113() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "setSymbol", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;Ljava/lang/Object;)V", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_114() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "getMap", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_115() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "setMap", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;Ljava/lang/Object;)V", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_116() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "getWeakMap", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_117() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "setWeakMap", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;Ljava/lang/Object;)V", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_118() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "getSet", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_119() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "setSet", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;Ljava/lang/Object;)V", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_120() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "getWeakSet", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_121() {
        try {
            return MethodHandles.lookup().findStatic(Global.class, "setWeakSet", MethodType.fromMethodDescriptorString("(Ljava/lang/Object;Ljava/lang/Object;)V", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    extends ScriptObject {
        ...
        protected GuardedInvocation findGetMethod(CallSiteDescriptor desc, LinkRequest request) {
            return LexicalScope.filterInvocation(super.findGetMethod(desc, request));
        }
