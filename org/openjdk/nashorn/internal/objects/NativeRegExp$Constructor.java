...
import org.openjdk.nashorn.internal.objects.NativeRegExp$Prototype;
...
extends ScriptFunction {
    ...
    NativeRegExp$Constructor() {
        super("RegExp", cfr_ldc_15(), $nasgenmap$, new Specialization[]{new Specialization(cfr_ldc_16(), false, false), new Specialization(cfr_ldc_17(), false, false), new Specialization(cfr_ldc_18(), false, false)});
        ...
        this.setArity(2);
        this.setDocumentationKey("RegExp");
    }
    ...
    static MethodHandle cfr_ldc_15() {
        try {
            return MethodHandles.lookup().findStatic(NativeRegExp.class, "constructor", MethodType.fromMethodDescriptorString("(ZLjava/lang/Object;[Ljava/lang/Object;)Lorg/openjdk/nashorn/internal/objects/NativeRegExp;", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_16() {
        try {
            return MethodHandles.lookup().findStatic(NativeRegExp.class, "constructor", MethodType.fromMethodDescriptorString("(ZLjava/lang/Object;)Lorg/openjdk/nashorn/internal/objects/NativeRegExp;", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
    ...
    static MethodHandle cfr_ldc_18() {
        try {
            return MethodHandles.lookup().findStatic(NativeRegExp.class, "constructor", MethodType.fromMethodDescriptorString("(ZLjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lorg/openjdk/nashorn/internal/objects/NativeRegExp;", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
