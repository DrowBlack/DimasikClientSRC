...
extends Enum<TokenType> {
    ...
    public static final /* enum */ TokenType POS = new TokenType(TokenKind.UNARY, "+", 14, false);
    ...
    public static final /* enum */ TokenType NEG = new TokenType(TokenKind.UNARY, "-", 14, false);
    ...
    static {
        $VALUES = new TokenType[]{ERROR, EOF, EOL, COMMENT, DIRECTIVE_COMMENT, NOT, NE, NE_STRICT, MOD, ASSIGN_MOD, BIT_AND, AND, ASSIGN_BIT_AND, LPAREN, RPAREN, MUL, ASSIGN_MUL, POS, ADD, INCPREFIX, ASSIGN_ADD, COMMARIGHT, NEG, SUB, DECPREFIX, ASSIGN_SUB, PERIOD, DIV, ASSIGN_DIV, COLON, SEMICOLON, LT, SHL, ASSIGN_SHL, LE, ASSIGN, EQ, EQ_STRICT, ARROW, GT, GE, SAR, ASSIGN_SAR, SHR, ASSIGN_SHR, TERNARY, LBRACKET, RBRACKET, BIT_XOR, ASSIGN_BIT_XOR, LBRACE, BIT_OR, ASSIGN_BIT_OR, OR, RBRACE, BIT_NOT, ELLIPSIS, BREAK, CASE, CATCH, CLASS, CONST, CONTINUE, DEBUGGER, DEFAULT, DELETE, DO, ELSE, ENUM, EXPORT, EXTENDS, FALSE, FINALLY, FOR, FUNCTION, IF, IMPLEMENTS, IMPORT, IN, INSTANCEOF, INTERFACE, LET, NEW, NULL, PACKAGE, PRIVATE, PROTECTED, PUBLIC, RETURN, STATIC, SUPER, SWITCH, THIS, THROW, TRUE, TRY, TYPEOF, VAR, VOID, WHILE, WITH, YIELD, DECIMAL, HEXADECIMAL, OCTAL_LEGACY, OCTAL, BINARY_NUMBER, FLOATING, STRING, ESCSTRING, EXECSTRING, IDENT, REGEX, XML, OBJECT, ARRAY, TEMPLATE, TEMPLATE_HEAD, TEMPLATE_MIDDLE, TEMPLATE_TAIL, DECPOSTFIX, INCPOSTFIX, SPREAD_ARGUMENT, SPREAD_ARRAY, YIELD_STAR};
