...
final class CompiledFunction {
    ...
    GuardedInvocation createFunctionInvocation(Class<?> callSiteReturnType, int callerProgramPoint) {
        return this.getValidOptimisticInvocation(() -> this.createInvoker(callSiteReturnType, callerProgramPoint)).createInvocation();
    }

    GuardedInvocation createConstructorInvocation() {
        return this.getValidOptimisticInvocation(this::getConstructor).createInvocation();
    }
