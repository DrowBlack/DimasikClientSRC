...
extends Enum<JSType> {
    ...
    public static final /* enum */ JSType SYMBOL = new JSType("symbol");
    ...
    public static boolean isPrimitive(Object obj) {
        return obj == null || obj == ScriptRuntime.UNDEFINED || JSType.isString(obj) || JSType.isNumber(obj) || obj instanceof Boolean || obj instanceof Symbol;
    }
    ...
    public static Object toPrimitive(JSObject jsobj, Class<?> hint) {
        try {
            return JSType.requirePrimitive(jsobj.getDefaultValue(hint));
        }
    ...
    public static Object toPropertyKey(Object obj) {
        return obj instanceof Symbol ? obj : JSType.toStringImpl(obj, false);
    }
    ...
    public static double toNumberForEq(Object obj) {
        return obj == null || obj instanceof Symbol || obj instanceof NativeSymbol ? Double.NaN : JSType.toNumber(obj);
    }
    ...
    public static Number toNarrowestNumber(long l) {
        if (JSType.isRepresentableAsInt(l)) {
            return (int)l;
        }
        return (double)l;
    }
    ...
    public static Object toJavaArrayWithLookup(Object obj, Class<?> componentType, SecureLookupSupplier lookupSupplier) {
        return Bootstrap.getLinkerServices().getWithLookup(() -> JSType.toJavaArray(obj, componentType), lookupSupplier);
    }
    ...
    public static MethodHandle unboxConstant(Object o) {
        if (o != null) {
            if (o.getClass() == Integer.class) {
                return Lookup.MH.constant(Integer.TYPE, o);
            }
            if (o.getClass() == Double.class) {
                return Lookup.MH.constant(Double.TYPE, o);
            }
        }
    ...
    static {
        $VALUES = new JSType[]{UNDEFINED, NULL, BOOLEAN, NUMBER, STRING, OBJECT, FUNCTION, SYMBOL};
        ...
        TO_BOOLEAN_I = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toBoolean", Boolean.TYPE, Integer.TYPE);
        ...
        TO_JAVA_ARRAY_WITH_LOOKUP = CompilerConstants.staticCall(JSTYPE_LOOKUP, JSType.class, "toJavaArrayWithLookup", Object.class, Object.class, Class.class, SecureLookupSupplier.class);
        ...
        CONVERT_OBJECT = List.of(TO_INT32.methodHandle(), TO_NUMBER.methodHandle());
        CONVERT_OBJECT_OPTIMISTIC = List.of(TO_INT32_OPTIMISTIC.methodHandle(), TO_NUMBER_OPTIMISTIC.methodHandle());
        GET_UNDEFINED = List.of(Lookup.MH.constant(Integer.TYPE, 0), Lookup.MH.constant(Double.TYPE, Double.NaN), Lookup.MH.constant(Object.class, Undefined.getUndefined()));
    }
}
