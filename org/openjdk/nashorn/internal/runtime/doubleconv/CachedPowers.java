...
public class CachedPowers {
    ...
    static int getCachedPowerForBinaryExponentRange(int min_exponent, int max_exponent, DiyFp power) {
        int kQ = 64;
        double k = Math.ceil((double)(min_exponent + 64 - 1) * 0.30102999566398114);
